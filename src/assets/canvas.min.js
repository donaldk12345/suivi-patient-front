/*
 CanvasJS Chart - v3.7.17 GA - https://canvasjs.com/
...
(function() {
    ...
    function Da(h) {
        h.roundRect = function(h, E, r, w, U, A, v, B) {
            v && (this.fillStyle = v);
            ...
            this.moveTo(h + U, E);
            this.lineTo(h + r - U, E);
            this.quadraticCurveTo(h + r, E, h + r, E + U);
            this.lineTo(h + r, E + w - U);
            this.quadraticCurveTo(h + r, E + w, h + r - U, E + w);
            this.lineTo(h + U, E + w);
            this.quadraticCurveTo(h, E + w, h, E + w - U);
            this.lineTo(h, E + U);
            this.quadraticCurveTo(h, E, h + U, E);
            this.closePath();
            v && this.fill();
            B && 0 < A && this.stroke()
        }
    ...
    function Ea(h) { h.indexOf || (h.indexOf = eb); return h }

    function fb(h) { if (ta.fSDec) h[W("`eeDwdouMhrudods")](W("e`u`@ohl`uhnoHuds`uhnoDoe"), function() { ta._fTWm && ta._fTWm(h) }) }
    ...
    function K(h, n, E, w, sa) {
        w = w || [];
        sa = r(sa) ? gb ? { passive: !1, capture: !1 } : !1 : sa;
        w.push([h, n, E, sa]);
        return h.addEventListener ? (h.addEventListener(n, E, sa), E) : h.attachEvent ? (w = function(n) {
            n = n || window.event;
    ...
    function hb(h) {
        if (h._menuButton) h.exportEnabled ?
            (S(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }), Ma(h._menuButton), pa(h, h._menuButton, "menu")) : ua(h._menuButton);
            ...
            K(h._menuButton, "touchstart", function(h) { n = !0 }, h.allDOMEventHandlers);
            ...
            K(h._menuButton, "mousemove", function() { n || (S(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColorOnHover, color: h.toolbar.fontColorOnHover }), 0 >= navigator.userAgent.search("MSIE") && S(h._menuButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" })) }, h.allDOMEventHandlers, !0);
        ...
        if (h.exportEnabled && h._dropdownMenu) {
            ...
            for (var E = h._dropdownMenu.childNodes, r = [h._cultureInfo.printText, h._cultureInfo.saveJPGText, h._cultureInfo.savePNGText], sa = 0; sa < E.length; sa++) S(E[sa], {
                backgroundColor: h.toolbar.itemBackgroundColor,
                color: h.toolbar.fontColor
            }), E[sa].innerHTML = r[sa]
        } else !h._dropdownMenu && (h.exportEnabled && w) && (n = !1, h._dropdownMenu = document.createElement("div"), h._dropdownMenu.setAttribute("tabindex", -1), E = -1 !== h.theme.indexOf("dark") ? "black" : "#888888", S(h._dropdownMenu, {
                position: "absolute",
                zIndex: 1,
                userSelect: "none",
                MozUserSeelct: "none",
            ...
            }, h.allDOMEventHandlers, !0), E = document.createElement("div"), S(E, { padding: "12px 8px 12px 8px" }), E.innerHTML = h._cultureInfo.printText, E.style.backgroundColor = h.toolbar.itemBackgroundColor, E.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(E),
            K(E, "touchstart", function(h) { n = !0 }, h.allDOMEventHandlers), K(E, "mousemove", function() { n || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover, this.style.color = h.toolbar.fontColorOnHover) }, h.allDOMEventHandlers, !0), K(E, "mouseout", function() { n || (this.style.backgroundColor = h.toolbar.itemBackgroundColor, this.style.color = h.toolbar.fontColor) }, h.allDOMEventHandlers, !0), K(E, "click", function() {
                h.print();
                ua(h._dropdownMenu)
            }, h.allDOMEventHandlers, !0), E = document.createElement("div"), S(E, { padding: "12px 8px 12px 8px" }),
            E.innerHTML = h._cultureInfo.saveJPGText, E.style.backgroundColor = h.toolbar.itemBackgroundColor, E.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(E), K(E, "touchstart", function(h) { n = !0 }, h.allDOMEventHandlers), K(E, "mousemove", function() { n || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover, this.style.color = h.toolbar.fontColorOnHover) }, h.allDOMEventHandlers, !0), K(E, "mouseout", function() { n || (this.style.backgroundColor = h.toolbar.itemBackgroundColor, this.style.color = h.toolbar.fontColor) },
                h.allDOMEventHandlers, !0), K(E, "click", function() {
                h.exportChart({ format: "jpeg", fileName: h.exportFileName });
                ua(h._dropdownMenu)
            }, h.allDOMEventHandlers, !0), E = document.createElement("div"), S(E, { padding: "12px 8px 12px 8px" }), E.innerHTML = h._cultureInfo.savePNGText, E.style.backgroundColor = h.toolbar.itemBackgroundColor, E.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(E), K(E, "touchstart", function(h) { n = !0 }, h.allDOMEventHandlers), K(E, "mousemove", function() {
                n || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover,
                    this.style.color = h.toolbar.fontColorOnHover)
            }, h.allDOMEventHandlers, !0), K(E, "mouseout", function() { n || (this.style.backgroundColor = h.toolbar.itemBackgroundColor, this.style.color = h.toolbar.fontColor) }, h.allDOMEventHandlers, !0), K(E, "click", function() {
    ...
    function $a(h, n, E) {
        ...
        n = !0;
        for (E = 0; 4 > E; E++)
            if (h[E] !== h[E + 4] | h[E] !== h[E + 8] | h[E] !== h[E + 12]) { n = !1; break }
        return n ?
            h[0] << 16 | h[1] << 8 | h[2] : 0
    }

    function la(h, n, E) { return h in n ? n[h] : E[h] }

    function Na(h, n, E, va) { w && ab ? (va = !r(va) && va ? h.getContext("2d", { willReadFrequently: !0 }) : h.getContext("2d"), Oa = va.webkitBackingStorePixelRatio || va.mozBackingStorePixelRatio || va.msBackingStorePixelRatio || va.oBackingStorePixelRatio || va.backingStorePixelRatio || 1, ia = Sa / Oa, h.width = n * ia, h.height = E * ia, Sa !== Oa && (h.style.width = n + "px", h.style.height = E + "px", va.scale(ia, ia))) : (h.width = n, h.height = E) }
    ...
    function ib(h) {
        if (!jb) {
            var n = !1,
                E = !1;
            "undefined" ===
            typeof oa.Chart.creditHref ? (h.creditHref = W("iuuqr;..b`ow`rkr/bnl."), h.creditText = W("B`ow`rKR/bnl")) : (n = h.updateOption("creditText"), E = h.updateOption("creditHref"));
    ...
    function S(h, n) { for (var E in n) h.style[E] = n[E] }
    ...
    function Ma() {
        for (var h = null,
                n = 0; n < arguments.length; n++) h = arguments[n], h.style && (h.style.display = "inline")
    }

    function ua() { for (var h = null, n = 0; n < arguments.length; n++)(h = arguments[n]) && h.style && (h.style.display = "none") }

    function Ta(h, n, E, r, w) {
        if (null === h || "undefined" === typeof h) return "undefined" === typeof E ? n : E;
    ...
    function X(h, n, E,
        ...
        h = {};
        this.theme && r(this.parent) && r(n) && r(w) ? h = r(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[n]) && (null === w ? h = this.parent.themeOptions[n] : 0 < this.parent.themeOptions[n].length && (w = Math.min(this.parent.themeOptions[n].length - 1, w), h = this.parent.themeOptions[n][w]));
        this.themeOptions = h;
        this.options = E ? E : { _isPlaceholder: !0 };
        this.setOptions(this.options, h)
    }

    function Fa(h, n, r, w, v) {
    ...
    function ya(h, n) {
        ...
        if (r(this.options.margin) && h.options.subtitles)
            for (var E = h.options.subtitles, w = 0; w < E.length; w++)
                if ((r(E[w].horizontalAlign) && "center" === this.horizontalAlign || E[w].horizontalAlign === this.horizontalAlign) && (r(E[w].verticalAlign) && "top" === this.verticalAlign || E[w].verticalAlign ===
                        this.verticalAlign) && !E[w].dockInsidePlotArea === !this.dockInsidePlotArea) { this.margin = 0; break }
    ...
    function Ja(h, n, r) {
        Ja.base.constructor.call(this, "Subtitle", "subtitles", n, r, h);
        this.chart = h;
        this.canvas = h.canvas;
        this.ctx = this.chart.ctx;
    ...
    var da = 20,
        ...
        bb = {
            ...
            subtitles: [{ fontFamily: v, fontSize: B, fontColor: "#3A3A3A", fontWeight: "normal", verticalAlign: "top", margin: 5 }],
            data: [{ indexLabelFontFamily: v, indexLabelFontSize: B, indexLabelFontColor: "#666666", indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }],
            axisX: [{
                titleFontFamily: v,
                titleFontSize: da,
    ...
    var da = 20,
        ...
        I = { numberDuration: 1, yearDuration: 314496E5, monthDuration: 2592E6, weekDuration: 6048E5, dayDuration: 864E5, hourDuration: 36E5, minuteDuration: 6E4, secondDuration: 1E3, millisecondDuration: 1, dayOfWeekFromInt: "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ") };
    (function() {
        ta.fSDec = function(h) { for (var n = "", r = 0; r < h.length; r++) n += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(r)); return n };
    ...
    var gb = function() {
        ...
        mb = function(h, n, r) { n = Math.min(this.width, this.height); return Math.max("theme4" === this.theme ? 0 : 300 <= n ? 12 : 11, Math.round(n * (h / 400))) },
        Aa = function() {
            ...
            return function(B, J, P) {
                ...
                "UTC:" === J.slice(0, 4) && (J = J.slice(4), S = !0);
                P = S ? "getUTC" : "get";
                var X = B[P + "Date"](),
                    N = B[P + "Day"](),
                    $ = B[P + "Month"](),
                ...
                return P = J.replace(h, function(l) {
                    switch (l) {
                        ...
                        case "TT":
                            return 12 > d ? "AM" : "PM";
                        case "K":
                            return S ? "UTC" : (String(B).match(U) || [""]).pop().replace(A, "");
                        case "z":
        ...
        nb = function(h) {
            ...
            if (1 > Math.abs(h)) {
                ...
                r && (h = (n ? -1 * h : h) * Math.pow(10, r - 1), h = "0." + Array(r).join("0") +
                    h.toString().substring(2), h = n ? "-" + h : h)
            } else r = parseInt(h.toString().split("+")[1]), 20 < r && (r -= 20, h /= Math.pow(10, r), h = h.toString() + Array(r + 1).join("0"));
            return String(h)
        },
        fa = function(h, n, r) {
            if (null === h) return "";
            ...
            for (var N = 0; B && N < B.length; N++)
                if (n =
                    ...
                    if ("%" === n) A *= 100;
                    else if ("\u2030" === n) { A *= 1E3; continue } else if ("," === n[0] && "." === n[n.length - 1]) {
                        A /= Math.pow(1E3, n.length - 1);
                        J = N + n.length - 1;
                        continue
                    } else "E" !== n[0] && "e" !== n[0] || "0" !== n[n.length - 1] || (S = !0);
                    0 > J ? (P.push(n), "#" === n || "0" === n ? O++ : "," === n && I++) : (R.push(n), "#" !== n && "0" !== n || K++)
                }
            S && (n = Math.floor(h), B = -Math.floor(Math.log(h) / Math.LN10 + 1), X = 0 === h ? 0 : 0 === n ? -(O + B) : nb(n).length - O, A /= Math.pow(10, X));
            0 > J && (J = N);
            A = (h * A).toFixed(K);
            n = A.split(".");
            A = (n[0] + "").split("");
            h =
                (n[1] + "").split("");
            A && "0" === A[0] && A.shift();
            for (S = B = N = K = J = 0; 0 < P.length;)
                if (n = P.pop(), "#" === n || "0" === n)
                    if (J++, J === O) {
                        var $ = A,
                            A = [];
                        if ("0" === n)
                            for (n = O - K - ($ ? $.length : 0); 0 < n;) $.unshift("0"), n--;
                        for (; 0 < $.length;) r = $.pop() + r, S++, 0 === S % B && (N === I && 0 < $.length) && (r = U + r)
                    } else 0 < A.length ? (r = A.pop() + r, K++, S++) : "0" === n && (r = "0" + r, K++, S++), 0 === S % B && (N === I && 0 < A.length) && (r = U + r);
            else "E" !== n[0] && "e" !== n[0] || "0" !== n[n.length - 1] || !/[eE][+-]*[0]+/.test(n) ? "," === n ? (N++, B = S, S = 0, 0 < A.length && (r = U + r)) : r = 1 < n.length && ('"' ===
                n[0] && '"' === n[n.length - 1] || "'" === n[0] && "'" === n[n.length - 1]) ? n.slice(1, n.length - 1) + r : n + r : (n = 0 > X ? n.replace("+", "").replace("-", "") : n.replace("-", ""), r += n.replace(/[0]+/, function(a) { return Z(X, a.length) }));
            U = "";
            for (P = !1; 0 < R.length;) n = R.shift(), "#" === n || "0" === n ? 0 < h.length && 0 !== Number(h.join("")) ? (U += h.shift(), P = !0) : "0" === n && (U += "0", P = !0) : 1 < n.length && ('"' === n[0] && '"' === n[n.length - 1] || "'" === n[0] && "'" === n[n.length - 1]) ? U += n.slice(1, n.length - 1) : "E" !== n[0] && "e" !== n[0] || "0" !== n[n.length - 1] || !/[eE][+-]*[0]+/.test(n) ?
                U += n : (n = 0 > X ? n.replace("+", "").replace("-", "") : n.replace("-", ""), U += n.replace(/[0]+/, function(a) { return Z(X, a.length) }));
            r += (P ? v : "") + U;
            return w ? "-" + r : r
        },
        Pa = function(h) {
            var n = 0,
                r = 0;
            h = h || window.event;
            h.offsetX || 0 === h.offsetX ? (n = h.offsetX, r = h.offsetY) : h.layerX || 0 == h.layerX ? (n = h.layerX, r = h.layerY) : (n = h.pageX - h.target.offsetLeft, r = h.pageY - h.target.offsetTop);
            return { x: n, y: r }
        },
        ab = !0,
        ...
        Oa = 1,
        ia = ab ? Sa / Oa : 1,
        ba = function(h, n, r, w, v, B, A, J, O, P, R, S, K) {
            "undefined" === typeof K && (K = 1);
            A = A ||
                0;
            J = J || "black";
            var I = 15 < w - n && 15 < v - r ? 8 : 0.35 * Math.min(w - n, v - r);
            h.beginPath();
            h.moveTo(n, r);
            h.save();
            h.fillStyle = B;
            ...
            h.globalAlpha = 1;
            0 < A && (K = 0 === A % 2 ? 0 : 0.5, h.beginPath(), h.lineWidth = A, h.strokeStyle = J, h.moveTo(n, r), h.rect(n - K, r - K, w - n + 2 * K, v - r + 2 * K), h.stroke());
            h.restore();
            !0 === O && (h.save(), h.beginPath(), h.moveTo(n, r), h.lineTo(n + I, r + I), h.lineTo(w - I, r + I), h.lineTo(w, r), h.closePath(), A = h.createLinearGradient((w + n) / 2, r + I, (w + n) / 2, r), A.addColorStop(0, B), A.addColorStop(1, "rgba(255, 255, 255, .4)"),
                h.fillStyle = A, h.fill(), h.restore());
            !0 === P && (h.save(), h.beginPath(), h.moveTo(n, v), h.lineTo(n + I, v - I), h.lineTo(w - I, v - I), h.lineTo(w, v), h.closePath(), A = h.createLinearGradient((w + n) / 2, v - I, (w + n) / 2, v), A.addColorStop(0, B), A.addColorStop(1, "rgba(255, 255, 255, .4)"), h.fillStyle = A, h.fill(), h.restore());
            !0 === R && (h.save(), h.beginPath(), h.moveTo(n, r), h.lineTo(n + I, r + I), h.lineTo(n + I, v - I), h.lineTo(n, v), h.closePath(), A = h.createLinearGradient(n + I, (v + r) / 2, n, (v + r) / 2), A.addColorStop(0, B), A.addColorStop(1, "rgba(255, 255, 255, 0.1)"),
                h.fillStyle = A, h.fill(), h.restore());
            !0 === S && (h.save(), h.beginPath(), h.moveTo(w, r), h.lineTo(w - I, r + I), h.lineTo(w - I, v - I), h.lineTo(w, v), A = h.createLinearGradient(w - I, (v + r) / 2, w, (v + r) / 2), A.addColorStop(0, B), A.addColorStop(1, "rgba(255, 255, 255, 0.1)"), h.fillStyle = A, A.addColorStop(0, B), A.addColorStop(1, "rgba(255, 255, 255, 0.1)"), h.fillStyle = A, h.fill(), h.closePath(), h.restore())
        },
        W = function(h) { for (var n = "", r = 0; r < h.length; r++) n += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(r)); return n },
        jb = window &&
        (window[W("mnb`uhno")] && window[W("mnb`uhno")].href && window[W("mnb`uhno")].href.indexOf && (-1 !== window[W("mnb`uhno")].href.indexOf(W("b`ow`rkr/bnl")) || -1 !== window[W("mnb`uhno")].href.indexOf(W("gdonqhy/bnl")) || -1 !== window[W("mnb`uhno")].href.indexOf(W("gheemd")))) && -1 === window[W("mnb`uhno")].href.indexOf(W("gheemd")),
        kb = {
    ...
    X.prototype.setOptions = function(h, n) {
        if (oa[this._defaultsKey]) {
            var r = oa[this._defaultsKey],
                w;
            for (w in r) "publicProperties" !== w && r.hasOwnProperty(w) && (this[w] = h && w in h ? h[w] : n && w in n ? n[w] : r[w])
    ...
    X.prototype.set = function(h, n, r) {
    ...
    X.prototype.addTo = function(h, n, r, w) {
        w = "undefined" === typeof w ? !0 : w;
        var v = oa[this._defaultsKey];
        ...
        if ("undefined" !== typeof h || this.options._isPlaceholder)
            if (this.parent.options._isPlaceholder &&
                ...
                var n = this.parent.options[this.optionsName],
                    r = n.length;
                this.options._isPlaceholder || (Ea(n), r = n.indexOf(this.options));
                this.options = "undefined" === typeof h ? {} : h;
                n[r] = this.options
            } else this.options = "undefined" === typeof h ? {} : h, h = this.parent.options, this.optionsName ? n = this.optionsName : (n = this._defaultsKey) && 0 !== n.length ? (r = n.charAt(0).toLowerCase(), 1 < n.length && (r = r.concat(n.slice(1))),
                n = r) : n = void 0, h[n] = this.options
    };
    ...
    X.prototype.updateOption = function(h) {
        ...
        var n = oa[this._defaultsKey],
            ...
            U = this._index;
        this.theme && r(this.parent) && r(B) && r(U) ? w = r(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[B]) && (null === U ? w = this.parent.themeOptions[B] : 0 < this.parent.themeOptions[B].length && (w = Math.min(this.parent.themeOptions[B].length - 1, U), w = this.parent.themeOptions[B][w]));
        this.themeOptions = w;
    ...
    X.prototype.isBeingTracked = function(h) { this.options._oldOptions || (this.options._oldOptions = {}); return this.options._oldOptions[h] ? !0 : !1 };
    X.prototype.hasOptionChanged = function(h) { if (!this.sessionVariables) throw "Session Variable Store not set"; return this.sessionVariables[h] !== this.options[h] };
    X.prototype.addEventListener = function(h, n, r) {
        h && n && (this._eventListeners[h] =
            this._eventListeners[h] || [], this._eventListeners[h].push({ context: r || this, eventHandler: n }))
    };
    X.prototype.removeEventListener = function(h, n) {
        if (h && n && this._eventListeners[h])
            for (var r = this._eventListeners[h], w = 0; w < r.length; w++)
                if (r[w].eventHandler === n) { r[w].splice(w, 1); break }
    };
    X.prototype.removeAllEventListeners = function() { this._eventListeners = [] };
    X.prototype.dispatchEvent = function(h, n, r) {
    ...
    Fa.prototype.registerSpace = function(h, n) { "top" === h ? this._topOccupied += n.height : "bottom" === h ? this._bottomOccupied += n.height : "left" === h ? this._leftOccupied += n.width : "right" === h && (this._rightOccupied += n.width) };
    Fa.prototype.unRegisterSpace = function(h, n) { "top" === h ? this._topOccupied -= n.height : "bottom" === h ? this._bottomOccupied -= n.height : "left" === h ? this._leftOccupied -= n.width : "right" === h && (this._rightOccupied -= n.width) };
    ...
    Fa.prototype.reset = function() { this._rightOccupied = this._leftOccupied = this._bottomOccupied = this._topOccupied = this._padding };
    na(ka, X);
    ...
    ka.prototype._getLineWithWidth = function(h, n, r) {
        ...
        r > n && 1 < A.length && (A = A.substr(0, A.length - 1), r = this.ctx.measureText(A).width);
        n = !0;
        if (A.length === h.length || " " === h[A.length]) n = !1;
        n && (h = A.split(" "), 1 < h.length && h.pop(), A = h.join(" "), r = this.ctx.measureText(A).width);
    ...
    ka.prototype._wrapText = function() {
        ...
        if (0 === this.frontSize) v = w = 0;
            ...
            for (; 0 < h.length;) {
                var B = this.maxHeight - (this.topPadding +
                        this.bottomPadding),
    ...
    ya.prototype.setLayout = function() {
        if (this.text) {
            ...
            P = J.measureText();
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (v = n.y1 + 2, K = "top") : "bottom" === this.verticalAlign && (v = n.y2 - 2 - P.height, K = "bottom"), "left" === this.horizontalAlign ? w = n.x1 + 2 : "center" === this.horizontalAlign ? w = n.x1 + n.width / 2 - P.width / 2 : "right" === this.horizontalAlign &&
                (w = n.x2 - 2 - P.width - A), I = this.horizontalAlign, this.width = P.width, this.height = P.height) : "center" === this.verticalAlign && ("left" === this.horizontalAlign ? (w = n.x1 + 2, v = n.y2 - 2 - (this.maxWidth / 2 - P.width / 2), B = -90, K = "left", this.width = P.height, this.height = P.width) : "right" === this.horizontalAlign ? (w = n.x2 - 2, v = n.y1 + 2 + (this.maxWidth / 2 - P.width / 2), B = 90, K = "right", this.width = P.height, this.height = P.width) : "center" === this.horizontalAlign && (v = h.y1 + (h.height / 2 - P.height / 2), w = h.x1 + (h.width / 2 - P.width / 2), K = "center", this.width = P.width,
                this.height = P.height), I = "center");
            J.x = w;
            J.y = v;
            J.angle = B;
            J.horizontalAlign = I;
    ...
    Va.prototype.get = function(h, n) {
        var r = null;
        0 < this.pool.length ? (r = this.pool.pop(), Na(r, h, n)) : r = ra(h, n);
        return r
    };
    Va.prototype.release = function(h) { this.pool.push(h) };
    na(Ka, X);
    var Qa = {
        addTheme: function(h, n) { cb[h] = n },
        addColorSet: function(h, n) { za[h] = n },
        addCultureInfo: function(h, n) { La[h] = n },
        formatNumber: function(h, n, r) { r = r || "en"; if (La[r]) return fa(h, n || "#,##0.##", new Ka(r)); throw "Unknown Culture Name"; },
        formatDate: function(h, r, w) {
            w = w || "en";
            if (La[w]) return Aa(h, r || "DD MMM YYYY", new Ka(w));
            throw "Unknown Culture Name";
        }
    };
    "undefined" !== typeof module && "undefined" !== typeof module.exports ? module.exports = Qa : "function" === typeof define && define.amd ? define([], function() { return Qa }) : (window.CanvasJS && window.console && window.console.log("CanvasJS namespace already exists. If you are loading both chart and stockchart scripts, just load stockchart alone as it includes all chart features."), window.CanvasJS = window.CanvasJS ? window.CanvasJS : Qa);
    v = Qa.Chart = function() {
        ...
        function n(a, d, c) {
            d = d || {};
            r(c) ?
                (this.predefinedThemes = cb, this.optionsName = this.parent = this.index = null) : (this.parent = c.parent, this.index = c.index, this.predefinedThemes = c.predefinedThemes, this.optionsName = c.optionsName, this.stockChart = c.stockChart, this.panel = a, this.isOptionsInArray = c.isOptionsInArray);
            ...
            (this.container.innerHTML = "", d = a = 0, a = this.options.width ? this.width : 0 < this.container.clientWidth ? this.container.clientWidth : this.width, d = this.options.height ? this.height : 0 < this.container.clientHeight ? this.container.clientHeight : this.height, this.width = a, this.height = d, this.x1 = this.y1 = 0, this.x2 = this.width, this.y2 = this.height, this.selectedColorSet = "undefined" !== typeof za[this.colorSet] ? za[this.colorSet] : za.colorSet1, this._canvasJSContainer = document.createElement("div"), this._canvasJSContainer.setAttribute("class",
                ...
                "none", this.canvas.style.userSelect = "none", this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Da(this.ctx), this._preRenderCtx = this._preRenderCanvas.getContext("2d"), this._preRenderCtx.textBaseline = "top", Da(this._preRenderCtx), w ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = ra(a, d), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas),
                    ...
                    this.overlaidCanvasCtx.textBaseline = "top", Da(this.overlaidCanvasCtx)), this._eventManager = new ea(this), this.windowResizeHandler = K(window, "resize", function() { b._updateSize() && b.render() }, this.allDOMEventHandlers), this._toolBar = document.createElement("div"), this._toolBar.setAttribute("class", "canvasjs-chart-toolbar"), S(this._toolBar, { position: "absolute", right: "1px", top: "1px" }), this._canvasJSContainer.appendChild(this._toolBar), this.bounds = { x1: 0, y1: 0, x2: this.width, y2: this.height }, K(this.overlaidCanvas,
                    "click",
                    function(a) { b._mouseEventHandler(a) }, this.allDOMEventHandlers), K(this.overlaidCanvas, "mousemove", function(a) { b._mouseEventHandler(a) }, this.allDOMEventHandlers), K(this.overlaidCanvas, "mouseup", function(a) { b._mouseEventHandler(a) }, this.allDOMEventHandlers), K(this.overlaidCanvas, "mousedown", function(a) {
                    b._mouseEventHandler(a);
                    ua(b._dropdownMenu)
                }, this.allDOMEventHandlers), K(this.overlaidCanvas, "mouseout", function(a) { b._mouseEventHandler(a) }, this.allDOMEventHandlers), K(this.overlaidCanvas, window.navigator.msPointerEnabled ?
        ...
        function v(a, d) {
            for (var c = [], b, e = 0; e < a.length; e++)
                if (0 == e) c.push(a[0]);
                    ...
                    b = Math.abs((a[l].x - a[f].x) / (0 === a[l].x - a[t].x ? 0.01 :
                        a[l].x - a[t].x)) * (d - 1) / 2 + 1;
                    var D = (a[l].x - a[f].x) / b;
                    b = (a[l].y - a[f].y) / b;
        ...
        function B(a, d, c, b, e, f, l, t, D, k) {
            ...
            a.beginPath();
            D && 0 < t.thickness ? (a.moveTo(b - l.thickness / 2, Math.round((c + e) / 2) - p), a.lineTo(d + l.thickness / 2, Math.round((c + e) / 2) - p)) :
            ...
            a.beginPath();
            D && 0 < l.thickness ? (a.moveTo(b - m, c), a.lineTo(b - m, e), a.moveTo(d + m, c), a.lineTo(d + m, e)) : 0 < l.thickness && (a.moveTo(d, c + m), a.lineTo(b, c + m), a.moveTo(d, e - m), a.lineTo(b, e - m));
            a.stroke();
            a.restore()
        }
        ...
        function A(a, d, c, b, e, f) {
            ...
            this.options.crosshair && (this.crosshair = new Y(this.chart, this.options.crosshair, this));
        ...
        function da(a, d, c, b, e, f) {
            da.base.constructor.call(this, "Break", d, c, b, f);
            this.id = e;
            this.chart = a;
            this.ctx = this.chart.ctx;
            this.scaleBreaks = f;
        ...
        function Y(a, d, c) {
            Y.base.constructor.call(this, "Crosshair", "crosshair", d, null, c);
            this.chart = a;
            this.ctx = this.chart.ctx;
            this.axis = c;
        ...
        function ea(a) {
            ...
            this.ghostCanvas = ra(this.chart.width, this.chart.height, !0);
        ...
        n.prototype._updateOptions = function() {
            ...
            this.toolbar =
                new Ua(this, this.options.toolbar);
            if (this.options.zoomEnabled || this.panEnabled) {
                if (this._zoomButton) S(this._zoomButton, { borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor }), pa(this, this._zoomButton, "zoom");
                else {
                    var d = !1;
                    ...
                    K(this._zoomButton, "touchstart", function(a) { d = !0 }, this.allDOMEventHandlers);
                    ...
                    K(this._zoomButton, "mousemove", function() {
                        d ? d = !1 : (S(a._zoomButton, {
                            backgroundColor: a.toolbar.itemBackgroundColorOnHover,
                            color: a.toolbar.fontColorOnHover,
                            transition: "0.4s",
                            WebkitTransition: "0.4s"
                        }), 0 >= navigator.userAgent.search("MSIE") && S(a._zoomButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }))
                    }, this.allDOMEventHandlers);
                    K(this._zoomButton, "mouseout", function() { d || (S(a._zoomButton, { backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }), 0 >= navigator.userAgent.search("MSIE") && S(a._zoomButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" })) }, this.allDOMEventHandlers)
                }
                this._resetButton ?
                    (S(this._resetButton, { borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor }), this._resetButton.title = this._cultureInfo.resetText) : (d = !1, ua(this._resetButton = document.createElement("button")), pa(this, this._resetButton, "reset"), this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.buttonBorderThickness : 0) + "px solid " + this.toolbar.buttonBorderColor, this._toolBar.appendChild(this._resetButton),
                        K(this._resetButton, "touchstart", function(a) { d = !0 }, this.allDOMEventHandlers), K(this._resetButton, "click", function() {
                            a.toolTip.hide();
                            ...
                            0 >= navigator.userAgent.search("MSIE") && S(a._resetButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" });
                            ...
                            d || (S(a._resetButton, {
                                ...
                                transition: "0.4s",
                                WebkitTransition: "0.4s"
                            }), 0 >= navigator.userAgent.search("MSIE") && S(a._resetButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }))
                        }, this.allDOMEventHandlers), K(this._resetButton, "mouseout", function() { d || (S(a._resetButton, { backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }), 0 >= navigator.userAgent.search("MSIE") && S(a._resetButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" })) }, this.allDOMEventHandlers),
        ...
        n.prototype.setLayout = function() {
            ...
            this.legend = new R(this, this.options.legend);
            ...
            for (d = 0; d < this._axes.length; d++)
                if (this._axes[d].scaleBreaks && this._axes[d].scaleBreaks._appliedBreaks.length) { w ? (this._breaksCanvas = ra(this.width, this.height, !0), this._breaksCanvasCtx = this._breaksCanvas.getContext("2d")) : (this._breaksCanvas = this.canvas, this._breaksCanvasCtx = this.ctx); break }
        ...
        n.prototype.renderElements = function() {
            if (this.height) {
                ...
                Ia && (m = this, setTimeout(function() {
                    ...
                    a && (Na(a, m.width, m.height), a.getContext("2d").drawImage(m._eventManager.ghostCanvas,
                        0, 0))
                }, 2E3));
                ...
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    for (D = 0; D < t.dataPoints.length; D++) {
                        ...
                        if (b < q && !k) null !== e && (p = b);
                            ...
                            t.dataPoints[D].label &&
                                (a.axisX.labels[b] = t.dataPoints[D].label);
        ...
        n.prototype._processStackedPlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = [], t = [],
                        D = Infinity, k = -Infinity, m = 0; m < a.dataSeriesIndexes.length; m++) {
                    var p = this.data[a.dataSeriesIndexes[m]],
                        q = 0,
                        g = !1,
                        s = !1,
                        h;
                    if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement) var ca = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : a.axisX.options && a.axisX.options.viewportMinimum ? a.axisX.options.viewportMinimum : a.axisX.options && a.axisX.options.minimum ? a.axisX.options.minimum : -Infinity,
                        u = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum :
                    ...
                    for (q = 0; q < p.dataPoints.length; q++) {
                        ...
                        if (0 < q) {
                            if (a.axisX.logarithmic) {
                                var n = b / p.dataPoints[q - 1].x;
                                1 > n && (n = 1 / n);
                                c.minDiff > n && 1 !== n && (c.minDiff = n)
                            } else n = b - p.dataPoints[q - 1].x, 0 > n && (n *= -1), c.minDiff > n && 0 !== n && (c.minDiff = n);
                            null !== e && null !== p.dataPoints[q - 1].y && (a.axisY.logarithmic ? 0 < e && (n = e / p.dataPoints[q - 1].y, 1 > n && (n = 1 / n), d.minDiff > n && 1 !== n && (d.minDiff = n)) : (n = e - p.dataPoints[q - 1].y, 0 > n && (n *= -1), d.minDiff > n && 0 !== n && (d.minDiff = n)))
                        }
                        if (b < ca && !g) null !== p.dataPoints[q].y && (h = b);
                        else {
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === p.dataPoints[q].y ? c.viewPortMin === b && h < b && (c.viewPortMin = h) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? l[b] ? l[b] += e : (l[b] = e, D = Math.min(e, D)) : t[b] ? t[b] += e : (t[b] = e, k = Math.max(e, k)))
                        }
                    }
                    a.axisY.scaleBreaks && (a.axisY.scaleBreaks.autoCalculate && 1 <= a.axisY.scaleBreaks.maxNumberOfAutoBreaks) &&
                        (d.dataPointYPositiveSums ? (d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums, l), d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums, t)) : (d.dataPointYPositiveSums = l, d.dataPointYNegativeSums = t));
                    p.axisX.valueType = p.xValueType = f ? "dateTime" : "number"
                }
                for (q in l) l.hasOwnProperty(q) && !isNaN(q) && (a = l[q], a < d.min && (d.min = Math.min(a, D)), a > d.max && (d.max = a), q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, D)), a > d.viewPortMax && (d.viewPortMax = a)));
                for (q in t) t.hasOwnProperty(q) &&
                    !isNaN(q) && (a = t[q], a < d.min && (d.min = a), a > d.max && (d.max = Math.max(a, k)), q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = a), a > d.viewPortMax && (d.viewPortMax = Math.max(a, k))))
            }
        };
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = !1, t = !1, D = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
                    ...
                    if ("normal" === m.axisPlacement || "xySwapped" ===
                        m.axisPlacement) var h = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : a.axisX.options && a.axisX.options.viewportMinimum ? a.axisX.options.viewportMinimum : a.axisX.options && a.axisX.options.minimum ? a.axisX.options.minimum : -Infinity,
                        n = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : a.axisX.options && a.axisX.options.viewportMaximum ? a.axisX.options.viewportMaximum : a.axisX.options && a.axisX.options.maximum ? a.axisX.options.maximum :
                        Infinity;
                    ...
                    for (p = 0; p < m.dataPoints.length; p++) {
                        ...
                        if (0 < p) {
                            ...
                            } else u = b - m.dataPoints[p -
                                1].x, 0 > u && (u *= -1), c.minDiff > u && 0 !== u && (c.minDiff = u);
                            r(e) || null === m.dataPoints[p - 1].y || (a.axisY.logarithmic ? 0 < e && (u = e / m.dataPoints[p - 1].y, 1 > u && (u = 1 / u), d.minDiff > u && 1 !== u && (d.minDiff = u)) : (u = e - m.dataPoints[p - 1].y, 0 > u && (u *= -1), d.minDiff > u && 0 !== u && (d.minDiff = u)))
                        }
                        if (b < h && !q) null !== e && (s = b);
                        else {
                            ...
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null ===
                                e ? c.viewPortMin === b && s < b && (c.viewPortMin = s) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? l = !0 : 0 > e && (t = !0), D[b] = D[b] ? D[b] + Math.abs(e) : Math.abs(e))
                        }
                    }
        ...
        n.prototype._processMultiYPlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo,
                        c = a.axisX.dataInfo, b, e, f, l, t = !1, D = 0; D < a.dataSeriesIndexes.length; D++) {
                    var k = this.data[a.dataSeriesIndexes[D]],
                        m = 0,
                        p = !1,
                        q = !1,
                        g, s, h;
                    if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement) var n = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : a.axisX.options && a.axisX.options.viewportMinimum ? a.axisX.options.viewportMinimum : a.axisX.options && a.axisX.options.minimum ? a.axisX.options.minimum : a.axisX.logarithmic ? 0 : -Infinity,
                    ...
                    for (m = 0; m < k.dataPoints.length; m++) {
                        ...
                        f < d.min && (d.min = f);
                        l > d.max && (d.max = l);
                        0 < m && (a.axisX.logarithmic ? (s = b / k.dataPoints[m - 1].x, 1 > s && (s = 1 / s), c.minDiff > s && 1 !== s && (c.minDiff = s)) : (s = b - k.dataPoints[m - 1].x, 0 > s && (s *= -1), c.minDiff > s && 0 !== s && (c.minDiff = s)), e && (null !== e[0] && k.dataPoints[m - 1].y && null !== k.dataPoints[m - 1].y[0]) && (a.axisY.logarithmic ? (s = e[0] / k.dataPoints[m - 1].y[0], 1 >
                            s && (s = 1 / s), d.minDiff > s && 1 !== s && (d.minDiff = s)) : (s = e[0] - k.dataPoints[m - 1].y[0], 0 > s && (s *= -1), d.minDiff > s && 0 !== s && (d.minDiff = s))));
                        if (!(b < n) || p) {
                            if (!p && (p = !0, 0 < m)) {
                                m -= 2;
                                g = h;
                            ...
                            if (c.viewPortMin === b && e)
                                for (r = 0; r < e.length; r++)
                                    if (null === e[r] && g < b) { c.viewPortMin = g; break }
                            null === e ? c.viewPortMin === b && g < b && (c.viewPortMin = g) : (f < d.viewPortMin &&
                                (d.viewPortMin = f), l > d.viewPortMax && (d.viewPortMax = l))
                        }
                    }
        ...
        n.prototype._processSpecificPlotUnit = function(a) {
            if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (t.dataPoints[D].x && t.dataPoints[D].x.getTime ||
                        "dateTime" === t.xValueType) f = !0;
                    for (D = 0; D < t.dataPoints.length; D++) "undefined" !== typeof t.dataPoints[D].isCumulativeSum && !0 === t.dataPoints[D].isCumulativeSum ? (t.dataPointEOs[D].cumulativeSumYStartValue = 0, t.dataPointEOs[D].cumulativeSum = 0 === D ? 0 : t.dataPointEOs[D - 1].cumulativeSum, t.dataPoints[D].y = 0 === D ? 0 : t.dataPointEOs[D - 1].cumulativeSum) : "undefined" !== typeof t.dataPoints[D].isIntermediateSum && !0 === t.dataPoints[D].isIntermediateSum ? (t.dataPointEOs[D].cumulativeSumYStartValue = p, t.dataPointEOs[D].cumulativeSum =
                        0 === D ? 0 : t.dataPointEOs[D - 1].cumulativeSum, t.dataPoints[D].y = 0 === D ? 0 : b, p = 0 === D ? 0 : t.dataPointEOs[D - 1].cumulativeSum, b = 0) : (e = "number" !== typeof t.dataPoints[D].y ? 0 : t.dataPoints[D].y, t.dataPointEOs[D].cumulativeSumYStartValue = 0 === D ? 0 : t.dataPointEOs[D - 1].cumulativeSum, t.dataPointEOs[D].cumulativeSum = 0 === D ? e : t.dataPointEOs[D - 1].cumulativeSum + e, b += e);
                    for (D = 0; D < t.dataPoints.length; D++)
                        if ("undefined" === typeof t.dataPoints[D].x && (t.dataPoints[D].x = D + (a.axisX.logarithmic ? 1 : 0)), t.dataPoints[D].x.getTime ? (f = !0,
                                ...
                                t.dataPointEOs[D].cumulativeSum / t.dataPointEOs[D - 1].cumulativeSum, 1 > e && (e = 1 / e), d.minDiff > e && 1 !== e && (d.minDiff = e)) : (e = t.dataPointEOs[D].cumulativeSum - t.dataPointEOs[D - 1].cumulativeSum, 0 > e && (e *= -1), d.minDiff > e && 0 !== e && (d.minDiff = e)))), !(b < q) || k) {
                            if (!k && (k = !0, 0 < D)) { D -= 2; continue }
                            if (b > g && !m) m = !0;
                            else if (b > g && m) continue;
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            0 < D && (t.dataPointEOs[D - 1].cumulativeSum < d.viewPortMin &&
                                (d.viewPortMin = t.dataPointEOs[D - 1].cumulativeSum), t.dataPointEOs[D - 1].cumulativeSum > d.viewPortMax && (d.viewPortMax = t.dataPointEOs[D - 1].cumulativeSum));
        ...
        n.prototype.calculateAutoBreaks = function() {
            function a(a, b, c, e) {
                if (e) return c = Math.pow(Math.min(c * a / b, b / a),
                    0.2), 1 >= c && (c = Math.pow(1 > a ? 1 / a : Math.min(b / a, a), 0.25)), { startValue: a * c, endValue: b / c };
            ...
            function d(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    ...
                    if (b || c)
                        for (var d = a.axisY.dataInfo,
                                g = a.axisX.dataInfo, f, k = g.min, l = g.max, m = d.min, p = d.max, g = g._dataRanges, d = d._dataRanges, q, t = 0, D = 0; D < a.dataSeriesIndexes.length; D++) {
                            var h = e.data[a.dataSeriesIndexes[D]];
                            if (!(4 > h.dataPoints.length))
                                for (t = 0; t < h.dataPoints.length; t++)
                                    if (b && (q = (l + 1 - k) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, f = h.dataPoints[t].x.getTime ? h.dataPoints[t].x.getTime() : h.dataPoints[t].x, q = Math.floor((f - k) / q), f < g[q].min && (g[q].min = f), f > g[q].max && (g[q].max = f)), c) {
                                        ...
                                        else r(f) || (q = Math.floor((f - m) / n), f < d[q].min && (d[q].min = f), f > d[q].max && (d[q].max = f))
                                    }
                        }
                }
            }
            ...
            function c(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks)
                    for (var b = a.axisX.dataInfo, c =
                            b.min, d = b.max, g = b._dataRanges, f, k = 0, l = 0; l < a.dataSeriesIndexes.length; l++) {
                        var m = e.data[a.dataSeriesIndexes[l]];
                        if (!(4 > m.dataPoints.length))
                            for (k = 0; k < m.dataPoints.length; k++) f = (d + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, b = m.dataPoints[k].x.getTime ? m.dataPoints[k].x.getTime() : m.dataPoints[k].x, f = Math.floor((b - c) / f), b < g[f].min && (g[f].min = b), b > g[f].max && (g[f].max = b)
                    }
            }
            for (var b, e = this, f = !1, l = 0; l < this._axes.length; l++)
                if (this._axes[l].scaleBreaks && this._axes[l].scaleBreaks.autoCalculate &&
            ...
            if (f) {
                for (l = 0; l < this.plotInfo.plotTypes.length; l++)
                    for (f = this.plotInfo.plotTypes[l], t = 0; t < f.plotUnits.length; t++) b = f.plotUnits[t], "line" === b.type || "stepLine" === b.type || "spline" === b.type || "column" === b.type || "area" === b.type || "stepArea" === b.type ||
                ...
                for (l = 0; l < this._axes.length; l++)
                    if (this._axes[l].dataInfo._dataRanges) {
                        ...
                        b = (this._axes[l].dataInfo.max + 1 - D) * Math.max(parseFloat(this._axes[l].scaleBreaks.collapsibleThreshold) ||
                            10, 10) / 100;
                        ...
                        if (this._axes[l].dataInfo.dataPointYNegativeSums) {
                            ...
                            m = k;
                            for (t in q) q.hasOwnProperty(t) && !isNaN(t) &&
                                (p = -1 * q[t], r(p) || (g = Math.floor((p - D) / b), p < m[g].min && (m[g].min = p), p > m[g].max && (m[g].max = p)));
            ...
            if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
                ...
                if (this.panEnabled || this.zoomEnabled) {
                    ...
                    l && (this._ignoreNextEvent = !0, this._dispatchRangeEvent("rangeChanging", "zoom"), this.stockChart && (this.stockChart.navigator && this.stockChart.navigator.enabled) && (this.stockChart._rangeEventParameter || (this.stockChart._rangeEventParameter = { stockChart: this.stockChart, source: "chart", index: this.stockChart.charts.indexOf(this), minimum: this.stockChart.sessionVariables._axisXMin, maximum: this.stockChart.sessionVariables._axisXMax }), this.stockChart._rangeEventParameter.type = "rangeChanging", this.stockChart.dispatchEvent("rangeChanging",
                        this.stockChart._rangeEventParameter, this.stockChart)), this.render(), this._dispatchRangeEvent("rangeChanged", "zoom"), this.stockChart && (this.stockChart.navigator && this.stockChart.navigator.enabled) && (this.stockChart._rangeEventParameter.type = "rangeChanged", this.stockChart.dispatchEvent("rangeChanged", this.stockChart._rangeEventParameter, this.stockChart)), l && (this.zoomEnabled && "none" === this._zoomButton.style.display) && (Ma(this._zoomButton, this._resetButton), pa(this, this._zoomButton, "pan"), pa(this, this._resetButton,
                        "reset")))
                }
            }
            this.isDrag = !1;
        ...
        n.prototype.validateRegion = function(a, d, c, b, e) {
            e = e || !1;
            for (var f = 0 <= this.zoomType.indexOf("x"), l = 0 <= this.zoomType.indexOf("y"), t = !1, D = [], k = [], m = [], p = 0; p < this._axes.length; p++)("axisX" === this._axes[p].type &&
            ...
            for (l = 0; l < k.length; l++) {
                ...
                if (isFinite(p.dataInfo.minDiff))
                    if (s = p.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && p.scaleBreaks && p.scaleBreaks._appliedBreaks.length) &&
                            (p.logarithmic && s < Math.pow(p.dataInfo.minDiff, 3) || !p.logarithmic && s < 3 * Math.abs(p.dataInfo.minDiff)) || q < p.minimum || g > p.maximum)) D.push(p), m.push({ val1: q, val2: g }), t = !0;
                    else if (!e) { t = !1; break }
            }
        ...
        n.prototype.renderIndexLabels = function(a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                var m = this._indexLabels[a],
                    ...
                    s = la("indexLabelFontSize", m.dataPoint, m.dataSeries),
                    t = la("indexLabelFontFamily", m.dataPoint, m.dataSeries),
                    D = la("indexLabelFontStyle", m.dataPoint, m.dataSeries),
                ...
                var n = la("indexLabelLineDashType", m.dataPoint, m.dataSeries),
                    ...
                    y = r(m.dataPoint.indexLabelLineThickness) ? r(m.dataSeries.options.indexLabelLineThickness) ? 0 : m.dataSeries.options.indexLabelLineThickness : m.dataPoint.indexLabelLineThickness,
                ...
                if (0 <= m.dataSeries.type.indexOf("stacked") ||
                    "pie" === m.dataSeries.type || "doughnut" === m.dataSeries.type) x = this.getPercentAndTotal(m.dataSeries, m.dataPoint);
                if (m.dataSeries.indexLabelFormatter || m.dataPoint.indexLabelFormatter) z = { chart: this, dataSeries: m.dataSeries, dataPoint: m.dataPoint, index: m.indexKeyword, total: x.total, percent: x.percent };
                var G = m.dataPoint.indexLabelFormatter ? m.dataPoint.indexLabelFormatter(z) : m.dataPoint.indexLabel ? this.replaceKeywordsWithValue(m.dataPoint.indexLabel, m.dataPoint, m.dataSeries, null, m.indexKeyword) : m.dataSeries.indexLabelFormatter ?
                    m.dataSeries.indexLabelFormatter(z) : m.dataSeries.indexLabel ? this.replaceKeywordsWithValue(m.dataSeries.indexLabel, m.dataPoint, m.dataSeries, null, m.indexKeyword) : null;
                if (null !== G && "" !== G) {
                    var x = la("indexLabelPlacement", m.dataPoint, m.dataSeries),
                        z = la("indexLabelOrientation", m.dataPoint, m.dataSeries),
                        C = la("indexLabelTextAlign", m.dataPoint, m.dataSeries),
                        v = m.direction,
                    ...
                    if ("normal" ===
                        ...
                        "inside" !== x ? (e = c.y1, f = c.y2, 0 < v ? (g = m.point.y + ("horizontal" === z ? s / 2 : 0) - k - t - b, g < e && (g = "auto" === x ? Math.max(m.point.y, e) + s / 2 + t : e + s / 2 + t, A = g + k > m.point.y)) : (g = m.point.y + s / 2 + t + b, g > f - k && (g = "auto" === x ? Math.min(m.point.y, f) + s / 2 - k - t : f + s / 2 - k, A = g < m.point.y))) : (e = Math.max(m.bounds.y1,
                            c.y1), f = Math.min(m.bounds.y2, c.y2 - k + s / 2), b = 0 <= p.indexOf("range") || "error" === p ? 0 < v ? Math.max(m.bounds.y1, c.y1) + s / 2 + t : Math.min(m.bounds.y2, c.y2) + s / 2 - k + t : (Math.max(m.bounds.y1, c.y1) + Math.min(m.bounds.y2, c.y2)) / 2 - k / 2 + s / 2 + ("horizontal" === z ? t : 0), 0 < v ? (g = Math.max(m.point.y, b), g < e && ("bubble" === p || "scatter" === p) && (g = Math.max(m.point.y - k - t, c.y1 + t))) : (g = Math.min(m.point.y, b), g > f - k - t && ("bubble" === p || "scatter" === p) && (g = Math.min(m.point.y + t, c.y2 - k - t))), g = Math.min(g, f))
                        ...
                        0 <= p.indexOf("scatter") ? (x = "auto", l = 4) : 0 <= p.indexOf("stacked") ? "auto" === x && (x = "inside") : "bubble" === p && (x = "inside"), g = m.point.y + s / 2 - k / 2 + t, "inside" !== x ? (e = c.x1, f = c.x2, 0 > v ? (q = m.point.x - ("horizontal" === z ? D : D - s / 2) - l - b, q < e && (q = "auto" === x ? Math.max(m.point.x, e) + l : e + l, A = q + D > m.point.x)) : (q = m.point.x + ("horizontal" === z ? 0 : s / 2) + l + b, q > f - D - l - b && (q = "auto" === x ? Math.min(m.point.x, f) - ("horizontal" === z ? D : D / 2) - l : f - D - l, A = q < m.point.x))) : (e = Math.max(m.bounds.x1, c.x1), Math.min(m.bounds.x2, c.x2), b = 0 <= p.indexOf("range") || "error" ===
                            p ? 0 > v ? Math.max(m.bounds.x1, c.x1) + s / 2 + l : Math.min(m.bounds.x2, c.x2) - D / 2 - l + ("horizontal" === z ? 0 : s / 2) : (Math.max(m.bounds.x1, c.x1) + Math.min(m.bounds.x2, c.x2)) / 2 + ("horizontal" === z ? 0 : s / 2), q = 0 > v ? Math.max(m.point.x, b) - ("horizontal" === z ? D / 2 : 0) : Math.min(m.point.x, b) - D / 2, q = Math.max(q, e));
                    "vertical" === z && (g += k - s / 2);
                    h.x = q;
                    h.y = g;
                    h.render(!0);
                    y && ("inside" !== x && (0 > p.indexOf("bar") && ("error" !== p || !m.axisSwapped) && m.point.x > c.x1 && m.point.x < c.x2 || !A) && (0 > p.indexOf("column") && ("error" !== p || m.axisSwapped) && m.point.y > c.y1 &&
                        m.point.y < c.y2 || !A)) && (d.lineWidth = y, d.strokeStyle = u ? u : "gray", d.setLineDash && d.setLineDash(J(n, y)), d.beginPath(), d.moveTo(m.point.x, m.point.y), 0 <= p.indexOf("bar") || "error" === p && m.axisSwapped ? d.lineTo(q + (0 < m.direction ? -l : D + l) + ("vertical" === z ? -s / 2 : 0), g + ("vertical" === z ? -k / 2 : k / 2 - s / 2) - t) : 0 <= p.indexOf("column") || "error" === p && !m.axisSwapped ? d.lineTo(q + D / 2 - ("horizontal" === z ? 0 : s / 2), g + ("vertical" === z ? (g - k < m.point.y ? 0 : -k) + t : (g - s / 2 < m.point.y ? k : 0) - s / 2)) : d.lineTo(q + D / 2 - ("horizontal" === z ? 0 : s / 2), g + ("vertical" ===
                        z ? g - k < m.point.y ? 0 : -k : (g - s / 2 < m.point.y ? k : 0) - s / 2)), d.stroke())
                }
            }
            ...
            for (a = 0; a < this._indexLabels.length; a++) m = this._indexLabels[a], h = la("indexLabelBackgroundColor", m.dataPoint, m.dataSeries), m.dataSeries.indexLabelBackgroundColor = r(h) ? w ? "transparent" : null : h;
            return d
        };
                ...
                for (var f = [], l, t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    if (0 < m.length) {
                        for (var z = !1, u = 0; u < m.length; u++)
                            if (r = m[u].x.getTime ? m[u].x.getTime() : m[u].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !z)))
                                if ("number" !== typeof m[u].y) 0 < u && !(k.connectNullData || z || n) && (c.stroke(), w && b.stroke()), z = !0;
                                else {
                                    r = a.axisX.convertValueToPixel(r);
                                    x = a.axisY.convertValueToPixel(m[u].y);
                                    var G = k.dataPointIds[u];
                                    this._eventManager.objectMap[G] = { id: G, objectType: "dataPoint", dataSeriesIndex: D, dataPointIndex: u, x1: r, y1: x };
                                    n || z ? (!n && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), p = k.nullDataLineDashType, c.setLineDash(q)), c.lineTo(r, x), w && b.lineTo(r, x)) : (c.beginPath(), c.moveTo(r, x), w && (b.beginPath(),
                                        b.moveTo(r, x))), z = n = !1) : (c.lineTo(r, x), w && b.lineTo(r, x), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(r, x), w && (b.stroke(), b.beginPath(), b.moveTo(r, x))));
                                    l = { x: r, y: x };
                                    u < m.length - 1 && (h !== (m[u].lineColor || s) || p !== (m[u].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(r, x), h = m[u].lineColor || s, c.strokeStyle = h, c.setLineDash && (m[u].lineDashType ? (p = m[u].lineDashType, c.setLineDash(J(p, k.lineThickness))) : (p = k.lineDashType, c.setLineDash(g))));
                                    if (0 !== m[u].markerSize && (0 < m[u].markerSize || 0 < k.markerSize)) {
                                        var C =
                                            k.getMarkerProperties(u, r, x, c);
                                        f.push(C);
                                        G = O(G);
                                        w && f.push({ x: r, y: x, ctx: b, type: C.type, size: C.size, color: G, borderColor: G, borderThickness: C.borderThickness })
                                    }(m[u].indexLabel || k.indexLabel || m[u].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "line", dataPoint: m[u], dataSeries: k, point: { x: r, y: x }, direction: 0 > m[u].y === a.axisY.reversed ? 1 : -1, color: s })
                                }
                        c.stroke();
                        w && b.stroke()
                    }
            ...
            function(a) {
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    for (var f = [], l, t = 0; t < a.dataSeriesIndexes.length; t++) {
                        ...
                        if (0 < m.length) {
                            for (var z = !1, u = 0; u < m.length; u++)
                                if (r = m[u].getTime ? m[u].x.getTime() : m[u].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !z)))
                                    if ("number" !== typeof m[u].y) 0 <
                                        u && !(k.connectNullData || z || n) && (c.stroke(), w && b.stroke()), z = !0;
                                    else {
                                        var G = x;
                                        r = a.axisX.convertValueToPixel(r);
                                        x = a.axisY.convertValueToPixel(m[u].y);
                                        var C = k.dataPointIds[u];
                                        this._eventManager.objectMap[C] = { id: C, objectType: "dataPoint", dataSeriesIndex: D, dataPointIndex: u, x1: r, y1: x };
                                        n || z ? (!n && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), p = k.nullDataLineDashType, c.setLineDash(q)),
                                            c.lineTo(r, G), c.lineTo(r, x), w && (b.lineTo(r, G), b.lineTo(r, x))) : (c.beginPath(), c.moveTo(r, x), w && (b.beginPath(), b.moveTo(r, x))), z = n = !1) : (c.lineTo(r, G), w && b.lineTo(r, G), c.lineTo(r, x), w && b.lineTo(r, x), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(r, x), w && (b.stroke(), b.beginPath(), b.moveTo(r, x))));
                                        l = { x: r, y: x };
                                        u < m.length - 1 && (h !== (m[u].lineColor || s) || p !== (m[u].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(r, x), h = m[u].lineColor || s, c.strokeStyle = h, c.setLineDash && (m[u].lineDashType ? (p = m[u].lineDashType,
                                            c.setLineDash(J(p, k.lineThickness))) : (p = k.lineDashType, c.setLineDash(g))));
                                        0 !== m[u].markerSize && (0 < m[u].markerSize || 0 < k.markerSize) && (G = k.getMarkerProperties(u, r, x, c), f.push(G), C = O(C), w && f.push({ x: r, y: x, ctx: b, type: G.type, size: G.size, color: C, borderColor: C, borderThickness: G.borderThickness }));
                ...
                for (var l = [], t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    if (0 < m.length)
                        for (n = !1, r = 0; r < m.length; r++)
                            if (u = m[r].getTime ? m[r].x.getTime() : m[r].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !n)))
                                if ("number" !== typeof m[r].y) 0 < r && !n && (k.connectNullData ? b.setLineDash && (0 < x.length && (k.options.nullDataLineDashType || !m[r - 1].lineDashType)) && (x[x.length -
                                    ...
                                    this._eventManager.objectMap[z] = { id: z, objectType: "dataPoint", dataSeriesIndex: D, dataPointIndex: r, x1: u, y1: n };
                                    x[x.length] = { x: u, y: n };
                                    r < m.length - 1 && (h !== (m[r].lineColor || s) || p !== (m[r].lineDashType || k.lineDashType)) && (h = m[r].lineColor || s, x[x.length - 1].newStrokeStyle = h, b.setLineDash && (m[r].lineDashType ? (p = m[r].lineDashType, x[x.length - 1].newLineDashArray =
                                        J(p, k.lineThickness)) : (p = k.lineDashType, x[x.length - 1].newLineDashArray = g)));
                                    if (0 !== m[r].markerSize && (0 < m[r].markerSize || 0 < k.markerSize)) {
                                        var G = k.getMarkerProperties(r, u, n, b);
                                        l.push(G);
                                        z = O(z);
                                        w && l.push({ x: u, y: n, ctx: e, type: G.type, size: G.size, color: z, borderColor: z, borderThickness: G.borderThickness })
                                    }(m[r].indexLabel || k.indexLabel || m[r].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                                        chartType: "spline",
                                        dataPoint: m[r],
                                        dataSeries: k,
                                        point: { x: u, y: n },
                                        direction: 0 > m[r].y === a.axisY.reversed ?
                                            1 : -1,
                                        color: s
                                    });
                                    n = !1
        ...
        n.prototype.renderColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    if (0 < s.length)
                        for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++)
                            if (s[f].getTime ? D = s[f].x.getTime() : D = s[f].x, !(D < a.axisX.dataInfo.viewPortMin || D > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[f].y) {
                                ...
                                ba(c, a.axisX.reversed ? r : l, t, a.axisX.reversed ? l : r, u, b, 0, null, h && (a.axisY.reversed ? 0 > s[f].y : 0 <= s[f].y), (a.axisY.reversed ? 0 <= s[f].y : 0 > s[f].y) && h, !1, !1, g.fillOpacity);
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: l, y1: t, x2: r, y2: u };
                                b = O(b);
                                w && ba(this._eventManager.ghostCtx, a.axisX.reversed ? r : l, t, a.axisX.reversed ? l : r, u, b, 0, null, !1, !1, !1, !1);
                                (s[f].indexLabel || g.indexLabel || s[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({ chartType: "column", dataPoint: s[f], dataSeries: g, point: { x: l + (r - l) / 2, y: 0 > s[f].y === a.axisY.reversed ? t : u }, direction: 0 > s[f].y === a.axisY.reversed ? 1 : -1, bounds: { x1: l, y1: Math.min(t, u), x2: r, y2: Math.max(t, u) }, color: b })
                            }
                }
                ...
                c.restore();
                return { source: d, dest: this.plotArea.ctx, animationCallback: N.yScaleAnimation, easingFunction: N.easing.easeOutQuart, animationBase: k < a.axisY.bounds.y1 ? a.axisY.bounds.y1 : k > a.axisY.bounds.y2 ? a.axisY.bounds.y2 : k }
            }
        };
                        ...
                        if (0 < u.length) {
                            ...
                            for (k = 0; k < u.length; k++)
                                if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) &&
                                    ...
                                    m = m - a.plotType.plotUnits.length * s / 2 + a.index * s << 0;
                                    var x = m + s << 0,
                                        z;
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) t[b] = u[k].y + (t[b] ? t[b] : 0), 0 < t[b] && (p = a.axisY.convertValueToPixel(t[b]), z = "undefined" !== typeof f[b] ? f[b] : q, f[b] = p);
                                    else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) D[b] = u[k].y + (D[b] ? D[b] : 0), z = a.axisY.convertValueToPixel(D[b]), p = "undefined" !== typeof l[b] ?
                                        l[b] : q, l[b] = z;
                                        ...
                                        z = q - G;
                                        f[b] = G + (z - p)
                                    } else G = l[b] ? l[b] : 0, z = p + G, p = q + G, l[b] = G + (z - p);
                                    b = u[k].color ? u[k].color : r._colorSet[k % r._colorSet.length];
                                    ba(c, m, a.axisY.reversed ? z : p, x, a.axisY.reversed ? p : z, b, 0, null, n && (a.axisY.reversed ? 0 > u[k].y : 0 <= u[k].y), (a.axisY.reversed ? 0 <= u[k].y : 0 > u[k].y) && n, !1, !1, r.fillOpacity);
                                    b = r.dataPointIds[k];
                                    ...
                                    b = O(b);
                                    w && ba(this._eventManager.ghostCtx, m, p, x, z, b, 0, null, !1, !1, !1, !1);
                                    (u[k].indexLabel || r.indexLabel || u[k].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedColumn", dataPoint: u[k], dataSeries: r, point: { x: m + (x - m) / 2, y: 0 <= u[k].y ? p : z }, direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: m, y1: Math.min(p, z), x2: x, y2: Math.max(p, z) }, color: b })
                                }
                        }
                    }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                    var h = a.dataSeriesIndexes[g],
                        ...
                        u = r.dataPoints;
                    if (0 < u.length)
                        for (var n = 5 < s && r.bevelEnabled ? !0 : !1, k = 0; k < u.length; k++)
                            if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin ||
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) {
                                    ...
                                    0 >= u[k].y) D[b] = p + ("undefined" !== typeof D[b] ? D[b] : 0), z = a.axisY.convertValueToPixel(D[b]), p = l[b] ? l[b] : q, l[b] = z;
                                    ...
                                    f[b] = G + (z - p)
                                } else G = "undefined" !== typeof l[b] ? l[b] : 0, z = p + G, p = q + G, a.dataSeriesIndexes.length - 1 === g && 1 >= Math.abs(e.y2 - z) && (z = e.y2), l[b] = G + (z - p);
                                b = u[k].color ? u[k].color : r._colorSet[k % r._colorSet.length];
                                ba(c, m, a.axisY.reversed ? z :
                                    p, x, a.axisY.reversed ? p : z, b, 0, null, n && (a.axisY.reversed ? 0 > u[k].y : 0 <= u[k].y), (a.axisY.reversed ? 0 <= u[k].y : 0 > u[k].y) && n, !1, !1, r.fillOpacity);
                                b = r.dataPointIds[k];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: m, y1: p, x2: x, y2: z };
                                b = O(b);
                                w && ba(this._eventManager.ghostCtx, m, p, x, z, b, 0, null, !1, !1, !1, !1);
        ...
        n.prototype.renderBar = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    e = this.plotArea,
                    f = 0,
                    l, t, D, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                    ...
                    if (0 < s.length) {
                        ...
                        for (f = 0; f < s.length; f++)
                            if (s[f].getTime ? D = s[f].x.getTime() : D = s[f].x, !(D < a.axisX.dataInfo.viewPortMin || D > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[f].y) {
                                ...
                                0 <= s[f].y ? u = k : (u = l, l = k);
                                b = s[f].color ? s[f].color : g._colorSet[f % g._colorSet.length];
                                ba(c, a.axisY.reversed ? l : u, a.axisX.reversed ? r : t, a.axisY.reversed ? u : l, a.axisX.reversed ? t : r, b, 0, null, h, !1, !1, !1, g.fillOpacity);
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: u, y1: t, x2: l, y2: r };
                                b = O(b);
                                w && ba(this._eventManager.ghostCtx,
                                    u, a.axisX.reversed ? r : t, l, a.axisX.reversed ? t : r, b, 0, null, !1, !1, !1, !1);
                                (s[f].indexLabel || g.indexLabel || s[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({ chartType: "bar", dataPoint: s[f], dataSeries: g, point: { x: 0 <= s[f].y ? l : u, y: t + (r - t) / 2 }, direction: 0 > s[f].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(u, l), y1: t, x2: Math.max(u, l), y2: r }, color: b })
                            }
                    }
                }
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                ...
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) D[b] = u[k].y + (D[b] ? D[b] : 0), m = l[b] ? l[b] :
                                    q, l[b] = z = a.axisY.convertValueToPixel(D[b]);
                                else if (m = a.axisY.convertValueToPixel(u[k].y), 0 <= u[k].y) {
                                    var G = f[b] ? f[b] : 0;
                                    z = q + G;
                                    m += G;
                                    f[b] = G + (m - z)
                                } else G = l[b] ? l[b] : 0, z = m - G, m = q - G, l[b] = G + (m - z);
                                b = u[k].color ? u[k].color : r._colorSet[k % r._colorSet.length];
                                ba(c, a.axisY.reversed ? m : z, p, a.axisY.reversed ? z : m, x, b, 0, null, n, !1, !1, !1, r.fillOpacity);
                                b = r.dataPointIds[k];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: z, y1: p, x2: m, y2: x };
                                b = O(b);
                                w && ba(this._eventManager.ghostCtx,
                                    z, p, m, x, b, 0, null, !1, !1, !1, !1);
                                (u[k].indexLabel || r.indexLabel || u[k].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar", dataPoint: u[k], dataSeries: r, point: { x: 0 <= u[k].y ? m : z, y: p + (x - p) / 2 }, direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(z, m), y1: p, x2: Math.max(z, m), y2: x }, color: b })
                            }
                    }
                }
                        ...
                        if (0 < u.length) {
                            ...
                            for (k = 0; k < u.length; k++)
                                if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin ||
                                    ...
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) {
                                    ...
                                    } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) D[b] =
                                        x + (D[b] ? D[b] : 0), m = l[b] ? l[b] : q, l[b] = x = a.axisY.convertValueToPixel(D[b]);
                                        ...
                                        f[b] = G + (m - x)
                                    } else G = l[b] ? l[b] : 0, x = m - G, m = q - G, a.dataSeriesIndexes.length - 1 === g && 1 >= Math.abs(e.x1 - x) && (x = e.x1), l[b] = G + (m - x);
                                    b = u[k].color ? u[k].color : r._colorSet[k % r._colorSet.length];
                                    ba(c, a.axisY.reversed ? m : x, p, a.axisY.reversed ? x : m, z, b, 0, null, n, !1, !1, !1, r.fillOpacity);
                                    b = r.dataPointIds[k];
                                    this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: x, y1: p, x2: m, y2: z };
                                    b = O(b);
                                    w && ba(this._eventManager.ghostCtx, x, p, m, z, b, 0, null, !1, !1, !1, !1);
                                    (u[k].indexLabel || r.indexLabel || u[k].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar100", dataPoint: u[k], dataSeries: r, point: { x: 0 <= u[k].y ? m : x, y: p + (z - p) / 2 }, direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(x, m), y1: p, x2: Math.max(x, m), y2: z }, color: b })
                                }
                        }
                    }
                    w && (d.drawImage(this._preRenderCanvas,
        ...
        n.prototype.renderArea = function(a) {
            ...
            function b() {
                G && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? z = x : 0 > a.axisY.viewportMaximum ? z = t.y1 : 0 < a.axisY.viewportMinimum && (z = x), f.lineTo(r, z), f.lineTo(G.x, z), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, w && (l.lineTo(r, z), l.lineTo(G.x, z), l.closePath(), l.fill()), f.beginPath(), f.moveTo(r,
                    u), l.beginPath(), l.moveTo(r, u), G = { x: r, y: u })
            }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    d = !0;
                    var h = 0,
                        r, u, n, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                        z, G = null;
                    if (0 < s.length) {
                        ...
                        if (f.setLineDash) {
                            ...
                            c = g.lineDashType;
                            var T = J(c, g.lineThickness);
                            f.setLineDash(T)
                        }
                        for (var ga = !0; h < s.length; h++)
                            if (n = s[h].x.getTime ?
                                s[h].x.getTime() : s[h].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ga)))
                                if ("number" !== typeof s[h].y) g.connectNullData || (ga || d) || b(), ga = !0;
                                else {
                                    r = a.axisX.convertValueToPixel(n);
                                    u = a.axisY.convertValueToPixel(s[h].y);
                                    d || ga ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = r, c = u, r = m.x, u = m.y, b(), f.moveTo(m.x, m.y), r = d, u = c, G = m, c = g.nullDataLineDashType, f.setLineDash(M)), f.lineTo(r,
                                        u), w && l.lineTo(r, u)) : (f.beginPath(), f.moveTo(r, u), w && (l.beginPath(), l.moveTo(r, u)), G = { x: r, y: u }), ga = d = !1) : (f.lineTo(r, u), w && l.lineTo(r, u), 0 == h % 250 && b());
                                    m = { x: r, y: u };
                                    h < s.length - 1 && (A !== (s[h].lineColor || v) || c !== (s[h].lineDashType || g.lineDashType)) && (b(), A = s[h].lineColor || v, f.strokeStyle = A, f.setLineDash && (s[h].lineDashType ? (c = s[h].lineDashType, f.setLineDash(J(c, g.lineThickness))) : (c = g.lineDashType, f.setLineDash(T))));
                                    ...
                                    0 !== s[h].markerSize && (0 < s[h].markerSize || 0 < g.markerSize) && (n = g.getMarkerProperties(h, r, u, f), D.push(n), aa = O(aa), w && D.push({ x: r, y: u, ctx: l, type: n.type, size: n.size, color: aa, borderColor: aa, borderThickness: n.borderThickness }));
            ...
            function d() {
                ...
                if (0 < c.length) {
                    ...
                    a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum &&
                        0 <= a.axisY.viewportMaximum ? n = r : 0 > a.axisY.viewportMaximum ? n = f.y1 : 0 < a.axisY.viewportMinimum && (n = r);
                    u = { x: c[0].x, y: c[0].y };
                ...
                for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                    ...
                    if (0 < p.length) {
                        ...
                        for (s = !1; q < p.length; q++)
                            if (g = p[q].x.getTime ? p[q].x.getTime() : p[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !s)))
                                if ("number" !== typeof p[q].y) 0 < q && !s && (m.connectNullData ? b.setLineDash && (0 < y.length && (m.options.nullDataLineDashType ||
                                    !p[q - 1].lineDashType)) && (y[y.length - 1].newLineDashArray = A, C = m.nullDataLineDashType) : (d(), y = [])), s = !0;
                                else {
                                    ...
                                    y[y.length] = { x: g, y: s };
                                    q < p.length - 1 && (G !== (p[q].lineColor || z) || C !== (p[q].lineDashType || m.lineDashType)) && (G = p[q].lineColor || z, y[y.length - 1].newStrokeStyle = G, b.setLineDash && (p[q].lineDashType ? (C =
                                        p[q].lineDashType, y[y.length - 1].newLineDashArray = J(C, m.lineThickness)) : (C = m.lineDashType, y[y.length - 1].newLineDashArray = B)));
                                    if (0 !== p[q].markerSize && (0 < p[q].markerSize || 0 < m.markerSize)) {
                                        var T = m.getMarkerProperties(q, g, s, b);
                                        l.push(T);
                                        M = O(M);
                                        w && l.push({ x: g, y: s, ctx: e, type: T.type, size: T.size, color: M, borderColor: M, borderThickness: T.borderThickness })
        ...
        n.prototype.renderStepArea = function(a) {
            ...
            function b() {
                G && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? z = x : 0 > a.axisY.viewportMaximum ? z = t.y1 : 0 < a.axisY.viewportMinimum && (z = x), f.lineTo(n, z), f.lineTo(G.x, z), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha =
                    1, w && (l.lineTo(n, z), l.lineTo(G.x, z), l.closePath(), l.fill()), f.beginPath(), f.moveTo(n, u), l.beginPath(), l.moveTo(n, u), G = { x: n, y: u })
            }
            var e = a.targetCanvasCtx || this.plotArea.ctx,
                f = w ? this._preRenderCtx : e;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    if (0 < s.length) {
                        ...
                        var M = "solid";
                        if (f.setLineDash) {
                            var T = J(g.nullDataLineDashType, g.lineThickness),
                                M = g.lineDashType,
                                E = J(M, g.lineThickness);
                            f.setLineDash(E)
                        }
                        for (; r < s.length; r++)
                            if (y = s[r].x.getTime ? s[r].x.getTime() : s[r].x, !(y < a.axisX.dataInfo.viewPortMin || y > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                                var aa = u;
                                "number" !== typeof s[r].y ? (g.connectNullData || (c || d) || b(), c = !0) : (n = a.axisX.convertValueToPixel(y), u = a.axisY.convertValueToPixel(s[r].y), d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || M === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = n,
                                        c = u, n = m.x, u = m.y, b(), f.moveTo(m.x, m.y), n = d, u = c, G = m, M = g.nullDataLineDashType, f.setLineDash(T)), f.lineTo(n, aa), f.lineTo(n, u), w && (l.lineTo(n, aa), l.lineTo(n, u))) : (f.beginPath(), f.moveTo(n, u), w && (l.beginPath(), l.moveTo(n, u)), G = { x: n, y: u }), c = d = !1) : (f.lineTo(n, aa), w && l.lineTo(n, aa), f.lineTo(n, u), w && l.lineTo(n, u), 0 == r % 250 && b()), m = { x: n, y: u }, r < s.length - 1 && (A !== (s[r].lineColor || v) || M !== (s[r].lineDashType || g.lineDashType)) && (b(), A = s[r].lineColor || v, f.strokeStyle = A, f.setLineDash && (s[r].lineDashType ? (M = s[r].lineDashType,
                                        f.setLineDash(J(M, g.lineThickness))) : (M = g.lineDashType, f.setLineDash(E)))), y = g.dataPointIds[r], this._eventManager.objectMap[y] = { id: y, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: r, x1: n, y1: u }, 0 !== s[r].markerSize && (0 < s[r].markerSize || 0 < g.markerSize) && (aa = g.getMarkerProperties(r, n, u, f), h.push(aa), y = O(y), w && h.push({ x: n, y: u, ctx: l, type: aa.type, size: aa.size, color: y, borderColor: y, borderThickness: aa.borderThickness })), (s[r].indexLabel || g.indexLabel || s[r].indexLabelFormatter || g.indexLabelFormatter) &&
                                    this._indexLabels.push({ chartType: "stepArea", dataPoint: s[r], dataSeries: g, point: { x: n, y: u }, direction: 0 > s[r].y === a.axisY.reversed ? 1 : -1, color: C }))
                            }
                        b();
                        $.drawMarkers(h)
                    }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var e = [], z = 0; z < a.dataSeriesIndexes.length; z++) {
                    var G =
                        ...
                        v = C.dataPoints;
                    C.dataPointIndexes = [];
                    for (q = 0; q < v.length; q++) G = v[q].x.getTime ? v[q].x.getTime() : v[q].x, C.dataPointIndexes[G] = q, e[G] || (m.push(G), e[G] = !0);
                    m.sort(Ra)
                }
                for (z = 0; z < a.dataSeriesIndexes.length; z++) {
                    ...
                    if (0 < m.length) {
                        ...
                        x = "solid";
                        if (b.setLineDash) {
                            var T = J(C.nullDataLineDashType, C.lineThickness);
                            x = C.lineDashType;
                            var E = J(x, C.lineThickness);
                            b.setLineDash(E)
                        }
                        for (var aa = !0, q = 0; q < m.length; q++) {
                            var f = m[q],
                                ha = null,
                                ha = 0 <= C.dataPointIndexes[f] ? v[C.dataPointIndexes[f]] : { x: f, y: null };
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !aa)))
                                if ("number" !== typeof ha.y) C.connectNullData || (aa || y) || d(), aa = !0;
                                else {
                                    ...
                                    } else s = a.axisY.convertValueToPixel(ha.y), s -= ma;
                                    k.push({ x: g, y: r - ma });
                                    h[f] = r - s;
                                    y || aa ? (!y && C.connectNullData ? (b.setLineDash && (C.options.nullDataLineDashType || x === C.lineDashType && C.lineDashType !== C.nullDataLineDashType) && (y = k.pop(), x = k[k.length - 1], d(), b.moveTo(u.x, u.y), k.push(x), k.push(y), x = C.nullDataLineDashType,
                                        b.setLineDash(T)), b.lineTo(g, s), w && n.lineTo(g, s)) : (b.beginPath(), b.moveTo(g, s), w && (n.beginPath(), n.moveTo(g, s))), aa = y = !1) : (b.lineTo(g, s), w && n.lineTo(g, s), 0 == q % 250 && (d(), b.moveTo(g, s), w && n.moveTo(g, s), k.push({ x: g, y: r - ma })));
                                    u = { x: g, y: s };
                                    q < v.length - 1 && (M !== (v[q].lineColor || A) || x !== (v[q].lineDashType || C.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, s), k.push({ x: g, y: r - ma }), M = v[q].lineColor || A, b.strokeStyle = M, b.setLineDash && (v[q].lineDashType ? (x = v[q].lineDashType, b.setLineDash(J(x, C.lineThickness))) : (x =
                                        C.lineDashType, b.setLineDash(E))));
                                    if (0 <= C.dataPointIndexes[f]) {
                                        var B = C.dataPointIds[C.dataPointIndexes[f]];
                                        this._eventManager.objectMap[B] = { id: B, objectType: "dataPoint", dataSeriesIndex: G, dataPointIndex: C.dataPointIndexes[f], x1: g, y1: s }
                                    }
                                    0 <= C.dataPointIndexes[f] && 0 !== ha.markerSize && (0 < ha.markerSize || 0 < C.markerSize) && (ma = C.getMarkerProperties(C.dataPointIndexes[f], g, s, b), l.push(ma), f = O(B), w && l.push({ x: g, y: s, ctx: n, type: ma.type, size: ma.size, color: f, borderColor: f, borderThickness: ma.borderThickness }));
                                    (ha.indexLabel ||
                                        C.indexLabel || ha.indexLabelFormatter || C.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedArea", dataPoint: ha, dataSeries: C, point: { x: g, y: s }, direction: 0 > v[q].y === a.axisY.reversed ? 1 : -1, color: e })
                                }
                        }
                        d();
                        b.moveTo(g, s);
                ...
                w && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas,
                    0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(t.x1, t.y1, t.width, t.height), n.restore());
                b.restore();
                return { source: c, dest: this.plotArea.ctx, animationCallback: N.xClipAnimation, easingFunction: N.easing.linear, animationBase: 0 }
            }
        };
        n.prototype.renderStackedArea100 = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    ...
                    p = [],
                    q = 0,
                    g, s, r, n, u, y = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                ...
                b.clip();
                w && (x.beginPath(), x.rect(l.x1, l.y1, l.width,
                    l.height), x.clip());
                for (var e = [], z = 0; z < a.dataSeriesIndexes.length; z++) {
                    ...
                    if (0 < m.length) {
                        ...
                        for (var aa = !0, q = 0; q < m.length; q++) {
                            var f = m[q],
                                ...
                                ha = 0 <= C.dataPointIndexes[f] ? v[C.dataPointIndexes[f]] : { x: f, y: null };
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !aa)))
                                if ("number" !== typeof ha.y) C.connectNullData ||
                                    (aa || n) || d(), aa = !0;
                                else {
                                    var ma;
                                    ma = 0 !== a.dataPointYSums[f] ? 100 * (ha.y / a.dataPointYSums[f]) : 0;
                                    g = a.axisX.convertValueToPixel(f);
                                    var B = h[f] ? h[f] : 0;
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                                        p[f] = ma + (p[f] ? p[f] : 0);
                                        if (0 >= p[f] && a.axisY.logarithmic) continue;
                                        s = a.axisY.convertValueToPixel(p[f])
                                    } else s = a.axisY.convertValueToPixel(ma), s -= B;
                                    k.push({ x: g, y: y - B });
                                    h[f] = y - s;
                                    n || aa ? (!n && C.connectNullData ? (b.setLineDash && (C.options.nullDataLineDashType || u === C.lineDashType &&
                                        C.lineDashType !== C.nullDataLineDashType) && (n = k.pop(), u = k[k.length - 1], d(), b.moveTo(r.x, r.y), k.push(u), k.push(n), u = C.nullDataLineDashType, b.setLineDash(T)), b.lineTo(g, s), w && x.lineTo(g, s)) : (b.beginPath(), b.moveTo(g, s), w && (x.beginPath(), x.moveTo(g, s))), aa = n = !1) : (b.lineTo(g, s), w && x.lineTo(g, s), 0 == q % 250 && (d(), b.moveTo(g, s), w && x.moveTo(g, s), k.push({ x: g, y: y - B })));
                                    r = { x: g, y: s };
                                    q < v.length - 1 && (M !== (v[q].lineColor || A) || u !== (v[q].lineDashType || C.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, s), k.push({
                                        x: g,
                                        y: y -
                                            B
                                    }), M = v[q].lineColor || A, b.strokeStyle = M, b.setLineDash && (v[q].lineDashType ? (u = v[q].lineDashType, b.setLineDash(J(u, C.lineThickness))) : (u = C.lineDashType, b.setLineDash(E))));
                                    if (0 <= C.dataPointIndexes[f]) {
                                        var F = C.dataPointIds[C.dataPointIndexes[f]];
                                        this._eventManager.objectMap[F] = { id: F, objectType: "dataPoint", dataSeriesIndex: G, dataPointIndex: C.dataPointIndexes[f], x1: g, y1: s }
                                    }
                                    0 <= C.dataPointIndexes[f] && 0 !== ha.markerSize && (0 < ha.markerSize || 0 < C.markerSize) && (B = C.getMarkerProperties(q, g, s, b), t.push(B), f = O(F),
                                        w && t.push({ x: g, y: s, ctx: x, type: B.type, size: B.size, color: f, borderColor: f, borderThickness: B.borderThickness }));
                                    (ha.indexLabel || C.indexLabel || ha.indexLabelFormatter || C.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedArea100", dataPoint: ha, dataSeries: C, point: { x: g, y: s }, direction: 0 > v[q].y === a.axisY.reversed ? 1 : -1, color: e })
                                }
                        }
                        d();
                        b.moveTo(g, s);
        ...
        n.prototype.renderBubble = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var s = 25 * Math.PI, r = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, s), k = 0; k < a.dataSeriesIndexes.length; k++)
                    if (m = a.dataSeriesIndexes[k], p = this.data[m], q = p.dataPoints, 0 < q.length)
                        for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)
                            if (f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, !(f < a.axisX.dataInfo.viewPortMin ||
                                ...
                                var g = q[e].z,
                                    n = 2 * Math.max(Math.sqrt((t === h ? r / 2 : s + (r - s) / (t - h) * (g - h)) / Math.PI) << 0, 1),
                                ...
                                this._eventManager.objectMap[u] = { id: u, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: e, x1: f, y1: l, size: n };
                                n = O(u);
                                w && $.drawMarker(f, l, this._eventManager.ghostCtx, g.type, g.size, n, n, g.borderThickness);
                        ...
                        for (var p = 0, q = 0, e = 0; e < m.length; e++)
                            if (f = m[e].getTime ? f = m[e].x.getTime() : f = m[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[e].y) {
                                ...
                                Math.sqrt((p - f) * (p - f) + (q - l) * (q - l)) < Math.min(g.size, 5) && m.length > Math.min(this.plotArea.width,
                                    this.plotArea.height) || (p = k.dataPointIds[e], this._eventManager.objectMap[p] = { id: p, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: e, x1: f, y1: l }, p = O(p), w && $.drawMarker(g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, p, p, g.borderThickness), (m[e].indexLabel || k.indexLabel || m[e].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "scatter", dataPoint: m[e], dataSeries: k, point: { x: f, y: l }, direction: 1, bounds: { x1: f - g.size / 2, y1: l - g.size / 2, x2: f + g.size / 2, y2: l + g.size / 2 }, color: null }),
                                    p = f, q = l)
                            }
                    }
                }
        ...
        n.prototype.renderCandlestick = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var ca = a.dataSeriesIndexes[n],
                        u = this.data[ca],
                        y = u.dataPoints;
                    if (0 < y.length)
                        for (var x = 5 < s && u.bevelEnabled ? !0 : !1, t = 0; t < y.length; t++)
                            if (y[t].getTime ? g = y[t].x.getTime() : g = y[t].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(y[t].y) && y[t].y.length && "number" === typeof y[t].y[0] &&
                                ...
                                var z = h - s / 2 << 0,
                                    ...
                                    v = 0 === C % 2 ? 0 : 0.5,
                                    A = u.dataPointIds[t];
                                this._eventManager.objectMap[A] = { id: A, objectType: "dataPoint", dataSeriesIndex: ca, dataPointIndex: t, x1: z, y1: k, x2: G, y2: m, x3: h, y3: p, x4: h, y4: q, borderThickness: C, color: e };
                                c.strokeStyle = e;
                                c.beginPath();
                                c.lineWidth = C;
                                b.lineWidth = Math.max(C, 4);
                                "candlestick" === u.type ? (c.moveTo(h - v, m), c.lineTo(h - v, Math.min(k, q)), c.stroke(), c.moveTo(h - v, Math.max(k, q)), c.lineTo(h - v, p), c.stroke(), ba(c, z, Math.min(k, q), G, Math.max(k, q), y[t].y[0] <= y[t].y[3] ? u.risingColor : f, C, e, x, x, !1, !1, u.fillOpacity), w && (e = O(A), b.strokeStyle = e, b.moveTo(h - v, m), b.lineTo(h - v, Math.min(k,
                                    q)), b.stroke(), b.moveTo(h - v, Math.max(k, q)), b.lineTo(h - v, p), b.stroke(), ba(b, z, Math.min(k, q), G, Math.max(k, q), e, 0, null, !1, !1, !1, !1))) : "ohlc" === u.type && (c.moveTo(h - v, m), c.lineTo(h - v, p), c.stroke(), c.beginPath(), c.moveTo(h, k), c.lineTo(z, k), c.stroke(), c.beginPath(), c.moveTo(h, q), c.lineTo(G, q), c.stroke(), w && (e = O(A), b.strokeStyle = e, b.moveTo(h - v, m), b.lineTo(h - v, p), b.stroke(), b.beginPath(), b.moveTo(h, k), b.lineTo(z, k), b.stroke(), b.beginPath(), b.moveTo(h, q), b.lineTo(G, q), b.stroke()));
                                (y[t].indexLabel || u.indexLabel ||
                                    y[t].indexLabelFormatter || u.indexLabelFormatter) && this._indexLabels.push({ chartType: u.type, dataPoint: y[t], dataSeries: u, point: { x: z + (G - z) / 2, y: a.axisY.reversed ? p : m }, direction: 1, bounds: { x1: z, y1: Math.min(m, p), x2: G, y2: Math.max(m, p) }, color: e })
                            }
                }
        ...
        n.prototype.renderBoxAndWhisker = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = !1, n = !!a.axisY.reversed, ca = 0; ca < a.dataSeriesIndexes.length; ca++) {
                    var u = a.dataSeriesIndexes[ca],
                        y = this.data[u],
                        x = y.dataPoints;
                    if (0 < x.length)
                        for (var z = 5 < s && y.bevelEnabled ? !0 : !1, l = 0; l < x.length; l++)
                            if (x[l].getTime ? g = x[l].x.getTime() : g = x[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(x[l].y) && x[l].y.length && "number" === typeof x[l].y[0] && "number" === typeof x[l].y[1] && "number" === typeof x[l].y[2] && "number" === typeof x[l].y[3] && "number" === typeof x[l].y[4] && 5 === x[l].y.length) {
                                ...
                                var v = t - s / 2 << 0,
                                    ...
                                    B = 0 === A % 2 ? 0 : 0.5,
                                    M = x[l].whiskerColor ? x[l].whiskerColor : x[l].color ? y.whiskerColor ? y.whiskerColor : x[l].color : y.whiskerColor ? y.whiskerColor : e,
                                    T = "number" === typeof x[l].whiskerThickness ? x[l].whiskerThickness : "number" === typeof y.options.whiskerThickness ? y.whiskerThickness : A,
                                    E = x[l].whiskerDashType ? x[l].whiskerDashType : y.whiskerDashType,
                                    aa = r(x[l].whiskerLength) ? r(y.options.whiskerLength) ? s : y.whiskerLength : x[l].whiskerLength,
                                    aa = "number" === typeof aa ? 0 >= aa ? 0 : aa >= s ? s : aa : "string" === typeof aa ? parseInt(aa) * s / 100 > s ? s : parseInt(aa) * s / 100 : s,
                                    ha = 1 === Math.round(T) % 2 ? 0.5 : 0,
                                    ma = x[l].stemColor ? x[l].stemColor : x[l].color ? y.stemColor ? y.stemColor : x[l].color : y.stemColor ? y.stemColor : e,
                                    Ba = "number" === typeof x[l].stemThickness ? x[l].stemThickness : "number" === typeof y.options.stemThickness ? y.stemThickness : A,
                                    F = 1 === Math.round(Ba) % 2 ? 0.5 : 0,
                                    I = x[l].stemDashType ? x[l].stemDashType :
                                    y.stemDashType,
                                    K = x[l].lineColor ? x[l].lineColor : x[l].color ? y.lineColor ? y.lineColor : x[l].color : y.lineColor ? y.lineColor : e,
                                    P = "number" === typeof x[l].lineThickness ? x[l].lineThickness : "number" === typeof y.options.lineThickness ? y.lineThickness : A,
                                    R = x[l].lineDashType ? x[l].lineDashType : y.lineDashType,
                                    L = 1 === Math.round(P) % 2 ? 0.5 : 0,
                                    U = y.upperBoxColor,
                                    S = y.lowerBoxColor,
                                    qa = r(y.options.fillOpacity) ? 1 : y.fillOpacity,
                                    Q = y.dataPointIds[l];
                                ...
                                c.save();
                                0 < Ba && (c.beginPath(), c.strokeStyle = ma, c.lineWidth = Ba, c.setLineDash && c.setLineDash(J(I, Ba)), c.moveTo(t - F, k), c.lineTo(t - F, h), c.stroke(), c.moveTo(t - F, p), c.lineTo(t - F, m), c.stroke());
                                c.restore();
                                b.lineWidth = Math.max(A, 4);
                                c.beginPath();
                                ba(c, v, Math.min(q, k), C, Math.max(k, q), S, 0, e, n ? z : !1, n ? !1 : z, !1, !1, qa);
                                c.beginPath();
                                ba(c, v, Math.min(m, q), C, Math.max(q, m), U, 0, e, n ? !1 : z, n ? z : !1, !1, !1, qa);
                                c.beginPath();
                                c.lineWidth = A;
                                c.strokeStyle = e;
                                c.rect(v - B, Math.min(k, m) - B, C - v + 2 * B, Math.max(k, m) - Math.min(k, m) + 2 * B);
                                c.stroke();
                                c.save();
                                0 < P && (c.beginPath(), c.globalAlpha = 1, c.setLineDash && c.setLineDash(J(R, P)), c.strokeStyle = K, c.lineWidth = P, c.moveTo(v, q - L), c.lineTo(C, q - L), c.stroke());
                                c.restore();
                                c.save();
                                0 < T && (c.beginPath(), c.setLineDash && c.setLineDash(J(E, T)), c.strokeStyle = M, c.lineWidth = T, c.moveTo(t - aa / 2 << 0, p - ha), c.lineTo(t + aa / 2 << 0, p - ha),
                                    c.stroke(), c.moveTo(t - aa / 2 << 0, h + ha), c.lineTo(t + aa / 2 << 0, h + ha), c.stroke());
                                c.restore();
                                w && (e = O(Q), b.strokeStyle = e, b.lineWidth = Ba, 0 < Ba && (b.moveTo(t - B - F, k), b.lineTo(t - B - F, Math.max(h, p)), b.stroke(), b.moveTo(t - B - F, Math.min(h, p)), b.lineTo(t - B - F, m), b.stroke()), ba(b, v, Math.max(k, m), C, Math.min(k, m), e, 0, null, !1, !1, !1, !1), 0 < T && (b.beginPath(), b.lineWidth = T, b.moveTo(t + aa / 2, p - ha), b.lineTo(t - aa / 2, p - ha), b.stroke(), b.moveTo(t + aa / 2, h + ha), b.lineTo(t - aa / 2, h + ha), b.stroke()));
                                (x[l].indexLabel || y.indexLabel || x[l].indexLabelFormatter ||
                                    y.indexLabelFormatter) && this._indexLabels.push({ chartType: y.type, dataPoint: x[l], dataSeries: y, point: { x: v + (C - v) / 2, y: a.axisY.reversed ? h : p }, direction: 1, bounds: { x1: v, y1: Math.min(h, p), x2: C, y2: Math.max(h, p) }, color: e })
                            }
                }
                w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
                        ...
                        for (var s =
                            ...
                            if (g[f].getTime ? h = g[f].x.getTime() : h = g[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !r(g[f].y) && g[f].y.length && "number" === typeof g[f].y[0] && "number" === typeof g[f].y[1]) {
                                ...
                                var n = a.axisX.reversed ? b + a.plotType.totalDataSeries * k / 2 - (a.previousDataSeriesCount + m) * k << 0 : b - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount +
                                        m) * k << 0,
                                    ca = a.axisX.reversed ? n - k << 0 : n + k << 0,
                                ...
                                u = q.dataPointIds[f];
                                this._eventManager.objectMap[u] = { id: u, objectType: "dataPoint", dataSeriesIndex: p, dataPointIndex: f, x1: n, y1: l, x2: ca, y2: t };
                                ba(c, a.axisX.reversed ? ca : n, l, a.axisX.reversed ? n : ca, t, b, 0, b, s, s, !1, !1, q.fillOpacity);
                                b = O(u);
                                w && ba(this._eventManager.ghostCtx, a.axisX.reversed ? ca : n, l, a.axisX.reversed ? n : ca, t, b, 0, null, !1, !1, !1, !1);
                                if (g[f].indexLabel || q.indexLabel || g[f].indexLabelFormatter ||
                                    q.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeColumn", dataPoint: g[f], dataSeries: q, indexKeyword: 0, point: { x: n + (ca - n) / 2, y: g[f].y[1] >= g[f].y[0] ? t : l }, direction: g[f].y[1] >= g[f].y[0] ? -1 : 1, bounds: { x1: n, y1: Math.min(l, t), x2: ca, y2: Math.max(l, t) }, color: b }), this._indexLabels.push({ chartType: "rangeColumn", dataPoint: g[f], dataSeries: q, indexKeyword: 1, point: { x: n + (ca - n) / 2, y: g[f].y[1] >= g[f].y[0] ? l : t }, direction: g[f].y[1] >= g[f].y[0] ? 1 : -1, bounds: { x1: n, y1: Math.min(l, t), x2: ca, y2: Math.max(l, t) }, color: b })
                            }
                }
                w &&
        ...
        n.prototype.renderError = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null,
                    ...
                    l = this.plotArea,
                    t = 0,
                    h, k, m, p, q, g, s, n = a.axisX.dataInfo.minDiff;
                ...
                for (var ca = 0, u = 0; u < this.data.length; u++) !this.data[u].type.match(/(bar|column)/ig) || !this.data[u].visible || this.data[u].type.match(/(stacked)/ig) && ca || ca++;
                for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
                    ...
                    t = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (C ? ca : 1))) << 0 : 0.3 * this.width;
                    f &&
                        (t = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (C ? ca : 1))) << 0 : 0.03 * this.width);
                    u = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * ((b ? l.height : l.width) * (a.axisX.logarithmic ? Math.log(n) / Math.log(a.axisX.range) : Math.abs(n) / Math.abs(a.axisX.range)) / (C ? ca : 1)) << 0;
                    ...
                    if (0 < v.length)
                        for (var E = z._colorSet, t = 0; t < v.length; t++) {
                            var e = z.lineColor = z.options.color ? z.options.color : E[0],
                                M = {
                                    ...
                                    length: r(v[t].whiskerLength) ?
                                        r(z.options.whiskerLength) ? u : z.options.whiskerLength : v[t].whiskerLength,
                                    trimLength: r(v[t].whiskerLength) ? r(z.options.whiskerLength) ? 50 : 0 : 0
                                };
                            M.length = "number" === typeof M.length ? 0 >= M.length ? 0 : M.length >= u ? u : M.length : "string" === typeof M.length ? parseInt(M.length) * u / 100 > u ? u : parseInt(M.length) * u / 100 > u : u;
                            ...
                            if (!(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax) && !r(v[t].y) && v[t].y.length && "number" === typeof v[t].y[0] && "number" === typeof v[t].y[1]) {
                                var ga = a.axisX.convertValueToPixel(s);
                                b ? k = ga : h = ga;
                                ga = a.axisY.convertValueToPixel(v[t].y[0]);
                                b ? m = ga : q = ga;
                                ga = a.axisY.convertValueToPixel(v[t].y[1]);
                                b ? p = ga : g = ga;
                                b ? (q = a.axisX.reversed ? k + (C ? ca : 1) * u / 2 - (C ? A - 1 : 0) * u << 0 : k - (C ? ca : 1) * u / 2 + (C ? A - 1 : 0) * u << 0, g = a.axisX.reversed ? q - u << 0 : q + u << 0) : (m = a.axisX.reversed ? h + (C ? ca : 1) * u / 2 - (C ? A - 1 : 0) * u << 0 : h - (C ? ca : 1) * u / 2 + (C ? A - 1 : 0) * u << 0, p = a.axisX.reversed ? m - u << 0 : m + u << 0);
                                !b && q > g && (ga = q, q = g, g = ga);
                                b && m > p && (ga = m, m = p, p = ga);
                                ga = z.dataPointIds[t];
                                ...
                                B(c, Math.min(m, p), Math.min(q, g), Math.max(p, m), Math.max(g, q), e, M, T, b);
                                w && B(this._eventManager.ghostCtx, m, q, p, g, e, M, T, b);
                                if (v[t].indexLabel || z.indexLabel || v[t].indexLabelFormatter || z.indexLabelFormatter) this._indexLabels.push({
                                    chartType: "error",
                                    dataPoint: v[t],
                                    dataSeries: z,
                                    indexKeyword: 0,
                                    point: { x: b ? v[t].y[1] >= v[t].y[0] ? m : p : m + (p - m) / 2, y: b ? q + (g - q) / 2 : v[t].y[1] >= v[t].y[0] ? g : q },
                                    ...
                                    color: e,
                                    axisSwapped: b
                                }), this._indexLabels.push({ chartType: "error", dataPoint: v[t], dataSeries: z, indexKeyword: 1, point: { x: b ? v[t].y[1] >= v[t].y[0] ? p : m : m + (p - m) / 2, y: b ? q + (g - q) / 2 : v[t].y[1] >= v[t].y[0] ? q : g }, direction: v[t].y[1] >= v[t].y[0] ? 1 : -1, bounds: { x1: b ? Math.min(m, p) : m, y1: b ? q : Math.min(q, g), x2: b ? Math.max(m, p) : p, y2: b ? g : Math.max(q, g) }, color: e, axisSwapped: b })
                            }
                        }
                }
                w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas,
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    if (0 < s.length) {
                        ...
                        c.strokeStyle = "#4572A7 ";
                        for (f = 0; f < s.length; f++)
                            if (s[f].getTime ? k = s[f].x.getTime() : k = s[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !r(s[f].y) && s[f].y.length && "number" === typeof s[f].y[0] &&
                                ...
                                l > t && (b = l, l = t, t = b);
                                b = s[f].color ? s[f].color : g._colorSet[f % g._colorSet.length];
                                ba(c, l, a.axisX.reversed ? v : h, t, a.axisX.reversed ? h : v, b, 0, null, n, !1, !1, !1, g.fillOpacity);
                                b =
                                    g.dataPointIds[f];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: l, y1: h, x2: t, y2: v };
                                b = O(b);
                                w && ba(this._eventManager.ghostCtx, l, a.axisX.reversed ? v : h, t, a.axisX.reversed ? h : v, b, 0, null, !1, !1, !1, !1);
                                if (s[f].indexLabel || g.indexLabel || s[f].indexLabelFormatter || g.indexLabelFormatter) this._indexLabels.push({
                                    ...
                                    color: b
                                }), this._indexLabels.push({ chartType: "rangeBar", dataPoint: s[f], dataSeries: g, indexKeyword: 1, point: { x: s[f].y[1] >= s[f].y[0] ? t : l, y: h + (v - h) / 2 }, direction: s[f].y[1] >= s[f].y[0] ? 1 : -1, bounds: { x1: Math.min(l, t), y1: h, x2: Math.max(l, t), y2: v }, color: b })
                            }
                    }
                }
                ...
                for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    if (0 < p.length) {
                        ...
                        for (var M = !0; g < p.length; g++)
                            if (u = p[g].x.getTime ? p[g].x.getTime() : p[g].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !M)))
                                if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                                    ...
                                    q || M ? (m.connectNullData && !q ? (b.setLineDash && (m.options.nullDataLineDashType || C === m.lineDashType && m.lineDashType !== m.nullDataLineDashType) && (h[h.length - 1].newLineDashArray = E, C = m.nullDataLineDashType, b.setLineDash(B)), b.lineTo(s, r), w && e.lineTo(s, r), h.push({ x: s, y1: r, y2: n })) : (b.beginPath(), b.moveTo(s, r), y = { x: s, y: r }, h = [], h.push({ x: s, y1: r, y2: n }), w && (e.beginPath(), e.moveTo(s, r))), M = q = !1) : (b.lineTo(s, r), h.push({ x: s, y1: r, y2: n }), w && e.lineTo(s, r), 0 == g % 250 && d());
                                    u = m.dataPointIds[g];
                                    this._eventManager.objectMap[u] = { id: u, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: g, x1: s, y1: r, y2: n };
                                    g < p.length - 1 && (A !== (p[g].lineColor || v) || C !== (p[g].lineDashType || m.lineDashType)) && (d(), A = p[g].lineColor || v, h[h.length - 1].newStrokeStyle = A, b.strokeStyle = A, b.setLineDash && (p[g].lineDashType ? (C = p[g].lineDashType, h[h.length - 1].newLineDashArray = J(C, m.lineThickness), b.setLineDash(h[h.length - 1].newLineDashArray)) : (C = m.lineDashType, h[h.length - 1].newLineDashArray = E, b.setLineDash(E))));
                                    if (0 !== p[g].markerSize && (0 < p[g].markerSize ||
                                            0 < m.markerSize)) {
                                        var T = m.getMarkerProperties(g, s, n, b);
                                        f.push(T);
                                        var ga = O(u);
                                        w && f.push({ x: s, y: n, ctx: e, type: T.type, size: T.size, color: ga, borderColor: ga, borderThickness: T.borderThickness });
                                        T = m.getMarkerProperties(g, s, r, b);
                                        f.push(T);
                                        ga = O(u);
                                        w && f.push({ x: s, y: r, ctx: e, type: T.type, size: T.size, color: ga, borderColor: ga, borderThickness: T.borderThickness })
                                    }
                                    if (p[g].indexLabel || m.indexLabel || p[g].indexLabelFormatter || m.indexLabelFormatter) this._indexLabels.push({
                                        ...
                                        color: x
                                    }), this._indexLabels.push({ chartType: "rangeArea", dataPoint: p[g], dataSeries: m, indexKeyword: 1, point: { x: s, y: n }, direction: p[g].y[0] > p[g].y[1] === a.axisY.reversed ? 1 : -1, color: x })
                                } else M || q || d(), M = !0;
                        d();
                        $.drawMarkers(f)
                    }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                    var r = a.dataSeriesIndexes[h],
                        ...
                        m = k.dataPoints,
                        f = k.id;
                    this._eventManager.objectMap[f] = { objectType: "dataSeries", dataSeriesIndex: r };
                    f = O(f);
                    e.fillStyle = f;
                    var f = [],
                        p = 0,
                        ...
                        for (g = !1; p < m.length; p++)
                            if (q = m[p].x.getTime ? m[p].x.getTime() : m[p].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !g)))
                                if (null !== m[p].y && m[p].y.length && "number" === typeof m[p].y[0] && "number" === typeof m[p].y[1]) {
                                    ...
                                    s = a.axisY.convertValueToPixel(m[p].y[1]);
                                    ...
                                    if (0 !== m[p].markerSize && (0 < m[p].markerSize || 0 < k.markerSize)) {
                                        ...
                                        I = k.getMarkerProperties(p, q, s, b);
                                        f.push(I);
                                        M = O(B);
                                        w && f.push({ x: q, y: s, ctx: e, type: I.type, size: I.size, color: M, borderColor: M, borderThickness: I.borderThickness })
                                    }
                                    if (m[p].indexLabel || k.indexLabel || m[p].indexLabelFormatter || k.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: m[p], dataSeries: k, indexKeyword: 0, point: { x: q, y: g }, direction: m[p].y[0] <= m[p].y[1] ? -1 : 1, color: u }), this._indexLabels.push({
                                    ...
                                    g = !1
                                } else 0 < p && !g && (k.connectNullData ? b.setLineDash && (0 < n.length && (k.options.nullDataLineDashType || !m[p - 1].lineDashType)) && (n[n.length - 1].newLineDashArray = C, z = k.nullDataLineDashType) : (d(A, y), n = [], ca = [])), g = !0;
                        d(A, y);
                        $.drawMarkers(f)
                    }
                }
        ...
        n.prototype.renderWaterfall = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = this._eventManager.ghostCtx,
                    ...
                    f = this.plotArea,
                    l = 0,
                    h, r, k, m, p = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                ...
                for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    ...
                    if (0 < v.length)
                        for (var x = 5 < q && n.bevelEnabled ? !0 : !1, z = !1, A = null, C = null, l = 0; l < v.length; l++)
                            if (v[l].getTime ? m = v[l].x.getTime() : m = v[l].x, "number" !== typeof v[l].y) {
                                ...
                                r = 0 === n.dataPointEOs[l].cumulativeSum ? p : a.axisY.convertValueToPixel(n.dataPointEOs[l].cumulativeSum);
                                ...
                                e = n.dataPointIds[l];
                                this._eventManager.objectMap[e] = { id: e, objectType: "dataPoint", dataSeriesIndex: s, dataPointIndex: l, x1: h, y1: r, x2: E, y2: k };
                                var M = v[l].color ? v[l].color : 0 < v[l].y ? n.risingColor : n.fallingColor;
                                ba(c, a.axisX.reversed ? E : h, a.axisY.reversed ? k : r, a.axisX.reversed ? h : E, a.axisY.reversed ? r : k, M, 0, M, x, x, !1, !1, n.fillOpacity);
                                e = O(e);
                                w && ba(this._eventManager.ghostCtx, a.axisX.reversed ? E : h, r, a.axisX.reversed ? h : E, k, e, 0, null, !1, !1, !1, !1);
                                var T, M = h;
                                T = "undefined" !== typeof v[l].isIntermediateSum && !0 === v[l].isIntermediateSum || "undefined" !== typeof v[l].isCumulativeSum && !0 === v[l].isCumulativeSum ? 0 < v[l].y ? r : k : 0 < v[l].y ? k : r;
                                0 < l && A && (!z || n.connectNullData) &&
                                    (z && c.setLineDash && c.setLineDash(J(B, u)), c.beginPath(), c.moveTo(A, C - y), c.lineTo(M, T - y), 0 < u && c.stroke(), w && (b.beginPath(), b.moveTo(A, C - y), b.lineTo(M, T - y), 0 < u && b.stroke()));
                                z = !1;
                                A = E;
                                C = 0 < v[l].y ? r : k;
                                M = v[l].lineDashType ? v[l].lineDashType : n.options.lineDashType ? n.options.lineDashType : "shortDash";
                                ...
                                this._indexLabels.push({ chartType: "waterfall", dataPoint: v[l], dataSeries: n, point: { x: h + (E - h) / 2, y: 0 <= v[l].y ? r : k }, direction: 0 > v[l].y === a.axisY.reversed ? 1 : -1, bounds: { x1: h, y1: Math.min(r, k), x2: E, y2: Math.max(r, k) }, color: e })
                            }
                }
        ...
        var W = function(a, d, c, b, e, f, l, h, r) {
            if (!(0 > c)) {
                ...
                a.globalAlpha = h;
                "pie" ===
                e ? (a.beginPath(), a.moveTo(d.x, d.y), a.arc(d.x, d.y, c, f, l, !1), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth = 2, a.closePath(), a.fill()) : "doughnut" === e && (a.beginPath(), a.arc(d.x, d.y, c, f, l, !1), 0 <= r && a.arc(d.x, d.y, r * c, l, f, !0), a.closePath(), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth = 2, a.fill());
                a.globalAlpha = 1;
                a.restore()
            }
        };
        n.prototype.renderPie = function(a) {
                ...
                if (k && m) {
                    for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < m.length; e++) {
                        ...
                        h.indexLabelFontColor =
                            f.indexLabelFontColor ? f.indexLabelFontColor : k.indexLabelFontColor;
                        ...
                        h.indexLabelBackgroundColor = f.indexLabelBackgroundColor ? f.indexLabelBackgroundColor :
                            k.options.indexLabelBackgroundColor ? k.options.indexLabelBackgroundColor : k.indexLabelBackgroundColor;
                        ...
                        h.startAngle =
                            (h.startAngle + 2 * Math.PI) % (2 * Math.PI);
                    ...
                    l = f = 0;
                    p = !1;
                    for (e = 0; e < m.length; e++) h = g[(c + e) % m.length], 1 < a && (h.midAngle > Math.PI / 2 - u && h.midAngle < Math.PI / 2 + u) && (f <= a / 2 && !p ? (h.hemisphere =
                        "right", f++) : (h.hemisphere = "left", p = !0));
                    p = !1;
            ...
            function c(a) {
                ...
                for (b = 0; b < m.length; b++) {
                    ...
                    if (d > c) {
                        var e = 0.07 * C * Math.cos(g[b].midAngle),
                            ...
                            l = !1;
                        if (m[b].exploded) { if (1E-9 < Math.abs(g[b].center.x - (x.x + e)) || 1E-9 < Math.abs(g[b].center.y - (x.y + f))) g[b].center.x = x.x + e * a, g[b].center.y = x.y + f * a, l = !0 } else if (0 < Math.abs(g[b].center.x - x.x) || 0 < Math.abs(g[b].center.y - x.y)) g[b].center.x = x.x + e * (1 - a), g[b].center.y = x.y + f * (1 - a), l = !0;
                        l && (e = {}, e.dataSeries = k, e.dataPoint = k.dataPoints[b], e.index = b, n.toolTip.highlightObjects([e]));
                        W(n.plotArea.ctx, g[b].center, g[b].radius, m[b].color ? m[b].color : k._colorSet[b % k._colorSet.length], k.type, c, d, k.fillOpacity, g[b].percentInnerRadius)
                    }
                }
                a =
                    n.plotArea.ctx;
                ...
                a.lineJoin = "round";
                for (b = b = 0; b < m.length; b++) c = g[b], c.indexLabelText && (c.indexLabelTextBlock.y -= c.indexLabelTextBlock.height / 2, d = 0, d = "left" === c.hemisphere ? "inside" !== k.indexLabelPlacement ? -(c.indexLabelTextBlock.width + p) : -c.indexLabelTextBlock.width / 2 : "inside" !== k.indexLabelPlacement ? p : -c.indexLabelTextBlock.width / 2, c.indexLabelTextBlock.x += d, c.indexLabelTextBlock.render(!0), c.indexLabelTextBlock.x -= d, c.indexLabelTextBlock.y +=
                    c.indexLabelTextBlock.height / 2, "inside" !== c.indexLabelPlacement && 0 < c.indexLabelLineThickness && (d = c.center.x + C * Math.cos(c.midAngle), e = c.center.y + C * Math.sin(c.midAngle), a.strokeStyle = c.indexLabelLineColor, a.lineWidth = c.indexLabelLineThickness, a.setLineDash && a.setLineDash(J(c.indexLabelLineDashType, c.indexLabelLineThickness)), a.beginPath(), a.moveTo(d, e), a.lineTo(c.indexLabelTextBlock.x, c.indexLabelTextBlock.y), a.lineTo(c.indexLabelTextBlock.x + ("left" === c.hemisphere ? -p : p), c.indexLabelTextBlock.y), a.stroke()),
                    a.lineJoin = "miter");
                a.save()
            }
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < m.length) {
                    ...
                    var q = 0,
                        t = 0,
                        t = q = q = 0;
                    0 > c ? p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 > k && p.indexLabelTextBlock.y - p.indexLabelTextBlock.height /
                        2 + c < k && (c = -(k - (p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 + c))) : p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2 < k && p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2 + c > h && (c = p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2 + c - h);
                    ...
                    q = Math.sqrt(Math.pow(k - t, 2) + Math.pow(c -
                        q, 2));
                    t = Math.acos(C / w);
                    ...
                    for (h = 1; h < m.length; h++)
                        if (k = (a - h + g.length) % g.length, g[k].hemisphere !== g[a].hemisphere) { k = null; break } else if (g[k].indexLabelText && g[k].hemisphere === g[a].hemisphere && k !== a && (0 > b(g[k], g[a]) || ("right" === g[a].hemisphere ? g[k].indexLabelTextBlock.y <= g[a].indexLabelTextBlock.y : g[k].indexLabelTextBlock.y >= g[a].indexLabelTextBlock.y))) break;
                    else k = null;
                    t = k;
                    q = e(a);
                    h = k = 0;
                    0 > c ? (h = "right" === p.hemisphere ? t : q, l = c, null !==
                        h && (t = -c, c = p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 - (g[h].indexLabelTextBlock.y + g[h].indexLabelTextBlock.height / 2), c - t < s && (k = -t, h = f(h, k, d + 1), +h.toFixed(y) > +k.toFixed(y) && (l = c > s ? -(c - s) : -(t - (h - k)))))) : 0 < c && (h = "right" === p.hemisphere ? q : t, l = c, null !== h && (t = c, c = g[h].indexLabelTextBlock.y - g[h].indexLabelTextBlock.height / 2 - (p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2), c - t < s && (k = t, h = f(h, k, d + 1), +h.toFixed(y) < +k.toFixed(y) && (l = c > s ? c - s : t - (k - h)))));
                    l && (d = p.indexLabelTextBlock.y + l, c = 0, c =
                        "right" === p.hemisphere ? x.x + Math.sqrt(Math.pow(w, 2) - Math.pow(d - x.y, 2)) : x.x - Math.sqrt(Math.pow(w, 2) - Math.pow(d - x.y, 2)), p.midAngle > Math.PI / 2 - u && p.midAngle < Math.PI / 2 + u ? (k = (a - 1 + g.length) % g.length, k = g[k], a = g[(a + 1 + g.length) % g.length], "left" === p.hemisphere && "right" === k.hemisphere && c > k.indexLabelTextBlock.x ? c = k.indexLabelTextBlock.x - 15 : "right" === p.hemisphere && ("left" === a.hemisphere && c < a.indexLabelTextBlock.x) && (c = a.indexLabelTextBlock.x + 15)) : p.midAngle > 3 * Math.PI / 2 - u && p.midAngle < 3 * Math.PI / 2 + u && (k = (a - 1 + g.length) %
                        ...
                        for (var t, r, a = 0; a < m.length; a++) {
                            ...
                            if (null !== u) {
                                ...
                                var z = 0,
                                    ...
                                    s;
                                if (0 > z) {
                                    for (var A = r = 0, G = 0; G < m.length; G++) G !== a && g[G].hemisphere === h.hemisphere && (g[G].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? r++ : A++);
                                    r = z / (r + A || 1) * A;
                                    var A = -1 * (z - r),
                                        J = G = 0;
                                    "right" === h.hemisphere ? (G = f(a, r), A = -1 * (z - G), J = f(u, A), +J.toFixed(y) < +A.toFixed(y) && +G.toFixed(y) <= +r.toFixed(y) && f(a, -(A - J))) : (G = f(u, r), A = -1 * (z - G), J = f(a, A), +J.toFixed(y) < +A.toFixed(y) && +G.toFixed(y) <= +r.toFixed(y) && f(u, -(A - J)))
                                }
                            }
                        }
                    } else
                        for (a = 0; a < m.length; a++) h = g[a], w = "pie" === k.type ? 0.7 * C : 0.85 * C, u = x.x + w * Math.cos(h.midAngle),
                            r = x.y + w * Math.sin(h.midAngle), h.indexLabelTextBlock.x = u, h.indexLabelTextBlock.y = r;
                    for (a = 0; a < m.length; a++)
                            ...
                            if (f = !1, t = g[k], t.indexLabelText) {
                                ...
                                if (null !== l) {
                                    ...
                                    if (q = 0 > z) {
                                        ...
                                        q = t.indexLabelTextBlock.x +
                                            t.indexLabelTextBlock.width < h.indexLabelTextBlock.x - p || q > u + p || n > D + p || r < s - p ? !1 : !0
                                    }
                                    q ? (0 > a && (a = k), l !== a && (c = l, d += -z), 0 === k % Math.max(m.length / 10, 3) && (f = !0)) : f = !0;
                                    f && (0 < d && 0 <= a && 0 <= c) && (L(d, a, c), c = a = -1, d = 0)
                                }
                            }
                        0 < d && L(d, a, c)
                    })()
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var k = this.data[a.dataSeriesIndexes[0]],
                    ...
                    z = 0;
                a = !1;
                for (var A = 0; A < m.length; A++) z += Math.abs(m[A].y), !a && ("undefined" !== typeof m[A].indexLabel &&
                    null !== m[A].indexLabel && 0 < m[A].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof m[A].label && null !== m[A].label && 0 < m[A].label.toString().length) && (a = !0);
                if (0 !== z) {
                    ...
                    var B = "undefined" !== typeof k.innerRadius && null !== k.innerRadius ? Ta(k.innerRadius, C) : 0.7 * C;
                    k.radius =
                        C;
                    "doughnut" === k.type && (k.innerRadius = B);
                    var E = Math.min(B / C, (C - 1) / C);
                    this.pieDoughnutClickHandler = function(a) {
                        n.isAnimating || !r(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, 1 < this.dataPoints.length && n._animator.animate(0, 500, function(a) {
                            c(a);
                            h();
                    ...
                    this._animator.animate(0, this.animatedRender ? this.animationDuration :
                        ...
                        function(a) {
                            ...
                            for (var b = g[0].startAngle + 2 * Math.PI * a, c = 0; c < m.length; c++) {
                                ...
                                e > d && W(n.plotArea.ctx, g[c].center, g[c].radius, l, k.type, d, e, k.fillOpacity, g[c].percentInnerRadius);
                                if (f) break
                            }
                            h();
                            n.dispatchEvent("dataAnimationIterationEnd", { chart: n });
        ...
        var oa = function(a, d, c, b) {
            ...
            0 >= Math.round(d.y4 - d.y1) || (a.save(), a.globalAlpha = c, a.beginPath(), a.moveTo(Math.round(d.x1), Math.round(d.y1)), a.lineTo(Math.round(d.x2), Math.round(d.y2)), a.lineTo(Math.round(d.x3),
        ...
        n.prototype.renderFunnel = function(a) {
            function d() {
                ...
                if (0 === a) return -1;
                for (c = b[0] = 0; c < y.length; c++) b.push(Math.abs(y[c].y) *
                    E / a);
                return b
            }
            ...
            function c() {
                ...
                if (0 === g) return -1;
                for (var l = d[0] = 0, h = 0, m, p, b = b - a, l = !1, k = 0; k < y.length; k++) a = Math.abs(y[k].y) * f / g, l ? m = 0 == Number(c.toFixed(3)) ? 0 : a / c : (p = ba * ba * b * b - 4 * Math.abs(ba) * a, 0 > p ? (p = c, l = (b + p) * (e - h) / 2, a -= l, m = e - h, h += e - h, m += 0 == p ? 0 : a / p, h += a / p, l = !0) :
                    (m = (Math.abs(ba) * b - Math.sqrt(p)) / 2, p = b - 2 * m / Math.abs(ba), h += m, h > e && (h -= m, p = c, l = (b + p) * (e - h) / 2, a -= l, m = e - h, h += e - h, m += a / p, h += a / p, l = !0), b = p)), d.push(m);
                return d
            }

            function b() {
                if (u && y) {
                    for (var a, b, c, d, e, f, k, l, h, m, p, q, t, n, s, D = [], x = [], v = { percent: null, total: null }, z = null, C = 0; C < y.length; C++) s = Q[C], s = "undefined" !== typeof s.x5 ? (s.y2 + s.y4) / 2 : (s.y2 + s.y3) / 2, s = g(s).x2 + 1, D[C] = K - s - S;
                    s = 0.5 * S;
                    for (var C = 0, B = y.length - 1; C < y.length || 0 <= B; C++, B--) {
                        b = u.reversed ? y[B] : y[C];
                        a = b.color ? b.color : u.reversed ? u._colorSet[(y.length - 1 - C) %
                            u._colorSet.length] : u._colorSet[C % u._colorSet.length];
                        ...
                        A._eventManager.objectMap[t] = {
                            ...
                            dataPointIndex: C,
                            dataSeriesIndex: 0,
                            funnelSection: Q[u.reversed ? y.length - 1 - C : C]
                        };
                        "inside" === u.indexLabelPlacement && (D[C] = C !== da ? u.reversed ? Q[C].x2 - Q[C].x1 : Q[C].x3 - Q[C].x4 : Q[C].x3 - Q[C].x6, 20 > D[C] && (D[C] = C !== da ? u.reversed ? Q[C].x3 - Q[C].x4 : Q[C].x2 - Q[C].x1 : Q[C].x2 - Q[C].x1, D[C] /= 2));
                        t = b.indexLabelMaxWidth ? b.indexLabelMaxWidth : u.options.indexLabelMaxWidth ? u.indexLabelMaxWidth : D[C];
                        if (t > D[C] || 0 > t) t = D[C];
                        x[C] = "inside" === u.indexLabelPlacement ? Q[C].height : !1;
                        ...
                        b = b.indexLabelFormatter ? b.indexLabelFormatter(z) : b.indexLabel ? A.replaceKeywordsWithValue(b.indexLabel, b, u, C) : u.indexLabelFormatter ? u.indexLabelFormatter(z) : u.indexLabel ? A.replaceKeywordsWithValue(u.indexLabel, b, u, C) : b.label ? b.label : "";
                        0 >= m && (m = 0);
                        ...
                        c = new ka(U, {
                            ...
                            maxWidth: t,
                            maxHeight: !1 ===
                                x[C] ? q ? 4.28571429 * f : 1.5 * f : x[C],
                            text: b,
                            padding: ea
                        });
                        c.measureText();
                        H.push({ textBlock: c, id: u.reversed ? B : C, isDirty: !1, lineColor: a, lineThickness: m, lineDashType: p, height: c.height < c.maxHeight ? c.height : c.maxHeight, width: c.width < c.maxWidth ? c.width : c.maxWidth })
                    }
                }
            }
            ...
            function e() {
                ...
                e = !1;
                c = 0;
                for (var g, k = K - Z - S / 2, k = u.options.indexLabelMaxWidth ? u.indexLabelMaxWidth > k ? k : u.indexLabelMaxWidth : k, l = H.length - 1; 0 <= l; l--) {
                    g = y[H[l].id];
                    c = H[l];
                    d = c.textBlock;
                    b = (a = q(l) < Q.length ? H[q(l)] : null) ? a.textBlock : null;
                    c = c.height;
                    a && d.y + c + ea > b.y && (e = !0);
                ...
                if (e)
                    for (l = H.length - 1; 0 <= l; l--) a = Q[l], H[l].textBlock.maxWidth = f[f.length - (l + 1)], H[l].textBlock.measureText(), H[l].textBlock.x = K - k, c = H[l].textBlock.height < H[l].textBlock.maxHeight ? H[l].textBlock.height : H[l].textBlock.maxHeight, e = H[l].textBlock.width < H[l].textBlock.maxWidth ? H[l].textBlock.width : H[l].textBlock.maxWidth, H[l].height = c, H[l].width = e, c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, H[l].textBlock.y =
                        c - H[l].height / 2, u.reversed ? (H[l].textBlock.y + H[l].height > V + z && (H[l].textBlock.y = V + z - H[l].height), H[l].textBlock.y < qa - z && (H[l].textBlock.y = qa - z)) : (H[l].textBlock.y < V - z && (H[l].textBlock.y = V - z), H[l].textBlock.y + H[l].height > qa + z && (H[l].textBlock.y = qa + z - H[l].height))
            }

            function f() {
                var a, b, c, d;
                if ("inside" !== u.indexLabelPlacement)
                    for (var e = 0; e < Q.length; e++) 0 == H[e].textBlock.text.length ? H[e].isDirty = !0 : (a = Q[e], c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, b = u.reversed ? "undefined" !== typeof a.x5 ? c >
                        Ca ? g(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < Ca ? g(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1, H[e].textBlock.x = b + S, H[e].textBlock.y = c - H[e].height / 2, u.reversed ? (H[e].textBlock.y + H[e].height > V + z && (H[e].textBlock.y = V + z - H[e].height), H[e].textBlock.y < qa - z && (H[e].textBlock.y = qa - z)) : (H[e].textBlock.y < V - z && (H[e].textBlock.y = V - z), H[e].textBlock.y + H[e].height > qa + z && (H[e].textBlock.y = qa + z - H[e].height)));
                else
                    for (e = 0; e < Q.length; e++) 0 == H[e].textBlock.text.length ? H[e].isDirty = !0 : (a = Q[e],
                        b = a.height, c = H[e].height, d = H[e].width, b >= c ? (b = e != da ? (a.x4 + a.x3) / 2 - d / 2 : (a.x5 + a.x4) / 2 - d / 2, c = e != da ? (a.y1 + a.y3) / 2 - c / 2 : (a.y1 + a.y4) / 2 - c / 2, H[e].textBlock.x = b, H[e].textBlock.y = c) : H[e].isDirty = !0)
            }
            ...
            function l() {
                function a(b, c) {
                    ...
                    d = h(b, e);
                    if (d >= c) return f.y += c, c;
                    if (b == Q.length - 1) return 0 < d && (f.y += d), d;
                    d += a(e, c - d);
                    0 < d && (f.y +=
                        d);
                    return d
                ...
                function b() {
                    ...
                    f = (R - P + 2 * z) / m;
                    k = m;
                    for (var l, h = 1; h < k; h++) { e = h * f; for (var t = H.length - 1; 0 <= t; t--) !H[t].isDirty && (H[t].textBlock.y < e && H[t].textBlock.y + H[t].height > e) && (l = q(t), !(l >= H.length - 1) && H[t].textBlock.y + H[t].height + ea > H[l].textBlock.y && (H[t].textBlock.y = H[t].textBlock.y + H[t].height - e > e - H[t].textBlock.y ? e + 1 : e - H[t].height - 1)) }
                    for (l = Q.length - 1; 0 < l; l--)
                        if (!H[l].isDirty) {
                            ...
                            if (H[l].textBlock.y < H[e].textBlock.y + H[e].height) {
                                ...
                                f = l;
                                for (k =
                                    0; H[f].textBlock.y < H[e].textBlock.y + H[e].height + ea;) {
                ...
                function c(a, b, d) {
                    var e = [],
                        f = 0,
                        g = 0;
                    for (a = Math.abs(a); d <= b; d++) e.push(Q[d]);
                ...
                for (var d, e, f, g, k, l, m = 1, n = 0; n < 2 * m; n++) {
                    for (var s = H.length - 1; 0 <= s && !(0 <= p(s) && p(s), f = H[s], g = f.textBlock, l = (k = q(s) < Q.length ? H[q(s)] : null) ? k.textBlock : null, d = +f.height.toFixed(6), e = +g.y.toFixed(6), !f.isDirty && (k && e + d + ea > +l.y.toFixed(6)) && (d = g.y + d + ea - l.y, e = a(s, -d), e < d && (0 < e && (d -= e), e = a(q(s), d), e != d))); s--);
                    b()
                }
            }

            function h(a, b) { return (b < Q.length ? H[b].textBlock.y : u.reversed ? V + z : qa + z) - (0 > a ? u.reversed ? qa - z : V - z : H[a].textBlock.y + H[a].height + ea) }
            ...
            function n(a,
                ...
                if (0 === W.length) l = ia;
                    ...
                    e = z * (1 != W.length || 0 != W[0] && W[0] != Q.length - 1 ? 2 : 1) / k();
                    for (var q = 0; q < Q.length; q++) {
                        ...
                        l.push(ia[q] + d);
                        if (0 <= W.indexOf(q) || q < Q.length && 0 <= W.indexOf(q + 1)) d += e
                    }
                }
                g = function() { for (var a = [], b = 0; b < Q.length; b++) a.push(l[b] - Q[b].y1); return a }();
                var t = {
                    startTime: (new Date).getTime(),
                    duration: c || 500,
                    easingFunction: function(a, b, c, d) { return N.easing.easeOutQuart(a, b, c, d) },
                    changeSection: function(a) { for (var b, c, d = 0; d < Q.length; d++) b = g[d], c = Q[d], b *= a, "undefined" === typeof p[d] && (p[d] = 0), 0 > p && (p *= -1), c.y1 += b - p[d], c.y2 += b - p[d], c.y3 += b - p[d], c.y4 += b - p[d], c.y5 && (c.y5 += b - p[d], c.y6 += b - p[d]), p[d] = b }
                };
                a._animator.animate(0, c, function(c) {
                    ...
                    for (e = 0; e < Q.length; e++) oa(d, Q[e], u.fillOpacity);
                    v(d);
                    M && ("inside" !== u.indexLabelPlacement ? m(d) : f(), s(d));
                    1 <= c && (ja = !1)
                }, null, N.easing.easeOutQuart)
            }

            function k() { for (var a = 0, b = 0; b < Q.length - 1; b++)(0 <= W.indexOf(b) || 0 <= W.indexOf(b + 1)) && a++; return a }

            function m(a) {
                for (var b, c, d, e, f = 0; f < Q.length; f++) e = 1 === H[f].lineThickness % 2 ? 0.5 : 0, c = ((Q[f].y2 + Q[f].y4) /
                    2 << 0) + e, b = g(c).x2 - 1, d = H[f].textBlock.x, e = (H[f].textBlock.y + H[f].height / 2 << 0) + e, H[f].isDirty || 0 == H[f].lineThickness || (a.strokeStyle = H[f].lineColor, a.lineWidth = H[f].lineThickness, a.setLineDash && a.setLineDash(J(H[f].lineDashType, H[f].lineThickness)), a.beginPath(), a.moveTo(b, c), a.lineTo(d, e), a.stroke())
            }

            function p(a) { for (a -= 1; - 1 <= a && -1 != a && H[a].isDirty; a--); return a }

            function q(a) { for (a += 1; a <= Q.length && a != Q.length && H[a].isDirty; a++); return a }
            ...
            function s(a) { for (var b = 0; b < Q.length; b++) H[b].isDirty || (a && (H[b].textBlock.ctx = a), H[b].textBlock.render(!0)) }
            ...
            function v(a) {
                ...
                if (A.subtitles)
                    for (var b =
                            0; b < A.subtitles.length; b++) { var c = A.subtitles[b]; if (c.dockInsidePlotArea || "center" === c.horizontalAlign && "center" === c.verticalAlign) A.subtitles.ctx = a, c.render() }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (var u = this.data[a.dataSeriesIndexes[0]], y = u.dataPoints, x = this.plotArea, z = 0.025 * x.width, B = 0.01 * x.width,
                        C = 0, E = x.height - 2 * z, I = Math.min(x.width - 2 * B, 2.8 * x.height), M = !1, T = 0; T < y.length; T++)
                    if (!M && ("undefined" !== typeof y[T].indexLabel && null !== y[T].indexLabel && 0 < y[T].indexLabel.toString().length) && (M = !0), !M && ("undefined" !== typeof y[T].label && null !== y[T].label && 0 < y[T].label.toString().length) && (M = !0), !M && "function" === typeof u.indexLabelFormatter || "function" === typeof y[T].indexLabelFormatter) M = !0;
                M = M || "undefined" !== typeof u.indexLabel && null !== u.indexLabel && 0 < u.indexLabel.toString().length;
                "inside" !== u.indexLabelPlacement &&
                    M || (B = (x.width - 0.75 * I) / 2);
                var T = x.x1 + B,
                    K = x.x2 - B,
                    P = x.y1 + z,
                    R = x.y2 - z,
                    U = a.targetCanvasCtx || this.plotArea.ctx || this.ctx;
                if (0 != u.length && (u.dataPoints && u.visible) && 0 !== y.length) {
                    var O, F;
                    a = 75 * I / 100;
                    var S = 30 * (K - a) / 100;
                    "funnel" === u.type ? (O = r(u.options.neckHeight) ? 0.35 * E : u.neckHeight, F = r(u.options.neckWidth) ? 0.25 * a : u.neckWidth, "string" === typeof O && O.match(/%$/) ? (O = parseInt(O), O = O * E / 100) : O = parseInt(O), "string" === typeof F && F.match(/%$/) ? (F = parseInt(F), F = F * a / 100) : F = parseInt(F), O > E ? O = E : 0 >= O && (O = 0), F > a ? F = a - 0.5 :
                        0 >= F && (F = 0)) : "pyramid" === u.type && (F = O = 0, u.reversed = u.reversed ? !1 : !0);
                    var B = T + a / 2,
                        X = T,
                        Z = T + a,
                        V = u.reversed ? R : P,
                    ...
                    var B = [],
                        ...
                        da, ba = (Ca - V) / (L - X),
                        fa = -ba,
                        T = "area" === (u.valueRepresents ? u.valueRepresents : "height") ? c() : d();
                    if (-1 !== T) {
                        if (u.reversed)
                            for (I.push(Y), F = T.length - 1; 0 < F; F--) Y += T[F], I.push(Y);
                        else
                            for (F = 0; F < T.length; F++) Y += T[F], I.push(Y);
                        if (u.reversed)
                            for (F = 0; F < T.length; F++) I[F] < Ca ? (a.push(L), B.push($), da = F) : (a.push((I[F] - V + ba * X) /
                                ba), B.push((I[F] - V + fa * Z) / fa));
                        else
                            for (F = 0; F < T.length; F++) I[F] < Ca ? (a.push((I[F] - V + ba * X) / ba), B.push((I[F] - V + fa * Z) / fa), da = F) : (a.push(L), B.push($));
                        for (F = 0; F < T.length - 1; F++) Y = u.reversed ? y[y.length - 1 - F].color ? y[y.length - 1 - F].color : u._colorSet[(y.length - 1 - F) % u._colorSet.length] : y[F].color ? y[F].color : u._colorSet[F % u._colorSet.length], F === da ? Q.push({ x1: a[F], y1: I[F], x2: B[F], y2: I[F], x3: $, y3: Ca, x4: B[F + 1], y4: I[F + 1], x5: a[F + 1], y5: I[F + 1], x6: L, y6: Ca, id: F, height: I[F + 1] - I[F], color: Y }) : Q.push({
                            x1: a[F],
                            y1: I[F],
                            x2: B[F],
                            y2: I[F],
                        ...
                        a = a = 0;
                        Ea(W);
                        for (F = 0; F < y.length; F++) y[F].exploded && (T = !0, u.reversed ? W.push(y.length - 1 - F) : W.push(F));
                        U.clearRect(x.x1, x.y1, x.width, x.height);
                        U.fillStyle = A.backgroundColor;
                        U.fillRect(x.x1, x.y1, x.width, x.height);
                        if (M && u.visible && (b(), f(), e(), "inside" !== u.indexLabelPlacement)) {
                            l();
                            for (F = 0; F < y.length; F++) H[F].isDirty || (a = H[F].textBlock.x + H[F].width, a = (K - a) / 2, 0 == F && (C = a), C > a && (C = a));
                            for (F =
                                0; F < Q.length; F++) Q[F].x1 += C, Q[F].x2 += C, Q[F].x3 += C, Q[F].x4 += C, Q[F].x5 && (Q[F].x5 += C, Q[F].x6 += C), H[F].textBlock.x += C
                        }
                        for (F = 0; F < Q.length; F++) C = Q[F], oa(U, C, u.fillOpacity), ia.push(C.y1);
                        v(U);
                        M && u.visible && ("inside" === u.indexLabelPlacement || A.animationEnabled || m(U), A.animationEnabled || s());
                        if (!M)
                            for (F = 0; F < y.length; F++) C = u.dataPointIds[F], a = { id: C, objectType: "dataPoint", dataPointIndex: F, dataSeriesIndex: 0, funnelSection: Q[u.reversed ? y.length - 1 - F : F] }, A._eventManager.objectMap[C] = a;
                        !A.animationEnabled && T ? n(A, -1, 0) : A.animationEnabled && !A.animatedRender && n(A, -1, 0);
                        this.funnelPyramidClickHandler = function(a) {
                            var b = -1;
                            if (!ja && !A.isAnimating && (r(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) && (b = u.reversed ? y.length - 1 - a.dataPointIndex : a.dataPointIndex, 0 <= b)) {
                                a = b;
        ...
        n.prototype.requestAnimFrame = function() { return window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(a) { window.setTimeout(a, 1E3 / 60) } }();
        ...
        n.prototype.exportChart = function(a) {
            ...
            if (b && d && c) {
                ...
                if ("undefined" !== typeof Blob && new Blob) {
                    ...
                    try { window.navigator.msSaveBlob(d, c), e = !0 } catch (k) { f.dataset.downloadurl = [a, f.download, f.href].join(":"), f.href = window.URL.createObjectURL(d) }
                }
                if (!e) try {
                ...
                } catch (m) { d = window.open(), d.document.write("<img src='" + b + "'></img><div>Please right click on the image and save it to your device</div>"), d.document.close() }
            }
        };
        n.prototype.print = function() {
            ...
            setTimeout(function() {
                b.focus();
                b.print();
                setTimeout(function() { c._canvasJSContainer.removeChild(d) },
                    1E3)
            }, 500)
        };
            ...
            function(a, d, c, b, e) {
                ...
                if ((0 <= c.type.indexOf("stacked") || "pie" === c.type || "doughnut" === c.type || "funnel" === c.type || "pyramid" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
                    ...
                    do {
                        ...
                        a = a.replace("#percent", fa(l, n, f._cultureInfo));
                        a = a.replace("#total", fa(h, c.yValueFormatString ? c.yValueFormatString : "#,##0.########", f._cultureInfo))
                ...
                return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
                    ...
                    return "x" === a ? (c.axisX && "dateTime" === c.axisX.valueType || "dateTime" === c.xValueType || d.x && d.x.getTime) && !c.axisX.logarithmic ?
                        Aa(g, d.xValueFormatString ? d.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : c.xValueFormatString = f.axisX && f.axisX.autoValueFormatString ? f.axisX.autoValueFormatString : "DD MMM YY", f._cultureInfo) : fa(g, d.xValueFormatString ? d.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : c.xValueFormatString = "#,##0.########", f._cultureInfo) : "y" === a ? fa(g, d.yValueFormatString ? d.yValueFormatString : c.yValueFormatString ? c.yValueFormatString : c.yValueFormatString = "#,##0.########", f._cultureInfo) :
                        "z" === a ? fa(g, d.zValueFormatString ? d.zValueFormatString : c.zValueFormatString ? c.zValueFormatString : c.zValueFormatString = "#,##0.########", f._cultureInfo) : g
                })
            };
        na(R, X);
            ...
            for (var m = 0; m < this.dataSeries.length; m++) {
                ...
                if (p.dataPoints && p.dataPoints.length)
                    if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type && "pyramid" !== p.type) {
                        var q = p.legendMarkerType = p.legendMarkerType ? p.legendMarkerType : "line" !== p.type && "stepLine" !== p.type && "spline" !== p.type && "scatter" !== p.type && "bubble" !== p.type || !p.markerType ? "error" === p.type && p._linkedSeries ? p._linkedSeries.legendMarkerType ? p._linkedSeries.legendMarkerType : U.getDefaultLegendMarker(p._linkedSeries.type) :
                            U.getDefaultLegendMarker(p.type) : p.markerType,
                        ...
                        for (var y = 0; y < p.dataPoints.length; y++) {
                            var x =
                                p.dataPoints[y],
                                q = x.legendMarkerType ? x.legendMarkerType : p.legendMarkerType ? p.legendMarkerType : U.getDefaultLegendMarker(p.type),
                                g = x.legendText ? x.legendText : p.legendText ? p.legendText : this.itemTextFormatter ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: p, dataPoint: x }) : x.name ? x.name : "DataPoint: " + (y + 1),
                ...
                for (m = 0; m < n.length; m++) {
                    ...
                    if (!(0 >= l || "undefined" === typeof l || 0 >= v || "undefined" === typeof v)) {
                        if ("horizontal" === this.orientation) {
                            q.textBlock = new ka(this.ctx, { x: 0, y: 0, maxWidth: v, maxHeight: this.itemWrap ? l : this.lineHeight, angle: 0, text: q.text, horizontalAlign: "left", fontSize: this.fontSize, fontFamily: this.fontFamily, fontWeight: this.fontWeight, fontColor: this.fontColor, fontStyle: this.fontStyle, textBaseline: "middle" });
                            ...
                            fontStyle: this.fontStyle,
                            textBaseline: "middle"
                        }), q.textBlock.measureText(), null !== this.itemWidth && (q.textBlock.width = this.itemWidth - (w + h + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))), this.height < l - this.lineHeight ? (p = { items: [], width: 0 }, k.push(p)) : (p = k[y], y = (y + 1) % k.length), this.height += q.textBlock.height;
        ...
        R.prototype.render = function() {
            ...
            for (var h = 0, n = 0; n < l.length; n++) {
                for (var k = l[n], m = 0, p = 0; p < k.items.length; p++) {
                    ...
                    this.ctx.clip();
                    if ("line" === q.chartType || "stepLine" === q.chartType || "spline" === q.chartType) this.ctx.strokeStyle = q.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(g - 0.1 * this.lineHeight, s + this.lineHeight / 2), this.ctx.lineTo(g + 0.85 * this.lineHeight, s + this.lineHeight / 2), this.ctx.stroke(), r -= 0.1 * this.lineHeight;
                    ...
                    $.drawMarker(g + f / 2, s + this.lineHeight / 2, this.ctx, q.markerType, "error" ===
                        q.chartType || "line" === q.chartType || "spline" === q.chartType ? q.markerSize / 2 : q.markerSize, q.markerColor, q.markerBorderColor, q.markerBorderThickness);
                    q.textBlock.x = g + c + f;
        ...
        na(U, X);
        U.prototype.getDefaultAxisPlacement =
            function() {
                var a = this.type;
        ...
        U.getDefaultLegendMarker = function(a) {
            if ("column" === a || "stackedColumn" === a || "stackedLine" === a || "bar" === a || "stackedBar" === a || "stackedBar100" === a || "bubble" === a || "scatter" === a || "stackedColumn100" === a || "stackedLine100" === a || "stepArea" === a || "candlestick" === a || "ohlc" === a || "rangeColumn" === a || "rangeBar" === a || "rangeArea" === a || "rangeSplineArea" === a || "boxAndWhisker" ===
                a || "waterfall" === a) return "square";
        ...
        U.prototype.getDataPointAtX = function(a, d) {
        ...
        U.prototype.getDataPointAtXY = function(a, d, c) {
            if (!this.dataPoints || 0 === this.dataPoints.length || a < this.chart.plotArea.x1 ||
                a > this.chart.plotArea.x2 || d < this.chart.plotArea.y1 || d > this.chart.plotArea.y2) return null;
            c = c || !1;
            var b = [],
                e = 0,
                f = 0,
            ...
            if ("none" !== this.chart.plotInfo.axisPlacement)
                if (p = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({ x: a, y: d }), this.axisX.logarithmic) var q = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x),
                    p = 1 < q ? Math.min(Math.max((this.dataPoints.length - 1) / q * Math.log(p / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) :
                    0;
        ...
        U.prototype.getMarkerProperties = function(a, d, c, b) {
            var e = this.dataPoints,
                ...
                l = e[a].markerBorderColor ? e[a].markerBorderColor :
            ...
            return { x: d, y: c, ctx: b, type: n, size: a, color: f, borderColor: l, borderThickness: h }
        };
        na(A, X);
        A.prototype.createExtraLabelsForLog = function(a) {
            ...
            if (!(5 < a)) {
                ...
                if (Math.log(this.range) /
                    Math.log(d / this.viewportMinimum) < this.noTicks - 1) {
        ...
        A.prototype.createLabels = function() {
            ...
            if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                ...
                if (this.logarithmic && !this.equidistantInterval)
                    for (this.logLabelValues || (this.logLabelValues = [], this.createExtraLabelsForLog()),
                        b = 0, g = q; b < this.logLabelValues.length; b++)
                        if (c = this.logLabelValues[b], c < this.viewportMinimum) b++;
                            ...
                            m = c;
                            a || (a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: m, label: this.labels[m] ? this.labels[m] : null }) : "axisX" === this.type && this.labels[m] ? this.labels[m] : fa(m, this.valueFormatString, this.chart._cultureInfo), a = new ka(this.ctx, {
                                x: 0,
                                y: 0,
                                maxWidth: f,
                                maxHeight: l,
                ...
                g = q;
                for (c = this.intervalStartPosition; c <= e; c = parseFloat(1E-12 > this.interval ?
                        this.logarithmic && this.equidistantInterval ? c * Math.pow(this.logarithmBase, this.interval) : c + this.interval : (this.logarithmic && this.equidistantInterval ? c * Math.pow(this.logarithmBase, this.interval) : c + this.interval).toFixed(12))) {
                    for (; g < p.length && c > p[g].endValue; g++);
                    a = g < p.length && c >= p[g].startValue && c <= p[g].endValue;
                    m = c;
                    a || (a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: m, label: this.labels[m] ? this.labels[m] : null }) : "axisX" === this.type && this.labels[m] ? this.labels[m] :
                        fa(m, this.valueFormatString, this.chart._cultureInfo), a = new ka(this.ctx, { x: 0, y: 0, maxWidth: f, maxHeight: l, angle: this.labelAngle, text: this.prefix + a + this.suffix, textAlign: this.labelTextAlign, backgroundColor: this.labelBackgroundColor, borderColor: this.labelBorderColor, borderThickness: this.labelBorderThickness, cornerRadius: this.labelCornerRadius, fontSize: this.labelFontSize, fontFamily: this.labelFontFamily, fontWeight: this.labelFontWeight, fontColor: this.labelFontColor, fontStyle: this.labelFontStyle, textBaseline: "middle" }),
                        this._labels.push({ position: m, textBlock: a, effectiveHeight: null }))
                }
            } else
                for (this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval), e = Xa(new Date(this.viewportMaximum), this.interval, this.intervalType), g = q, c = this.intervalStartPosition; c < e; Xa(c, b, this.intervalType)) {
                    ...
                    }) : "axisX" === this.type && this.labels[m] ? this.labels[m] : Aa(m, this.valueFormatString, this.chart._cultureInfo), a = new ka(this.ctx, {
                        x: 0,
                        y: 0,
                        maxWidth: f,
                        backgroundColor: this.labelBackgroundColor,
            ...
            if ("bottom" === this._position || "top" === this._position) h = this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ? this.lineCoordinates.width * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position)) /
                Math.log(this.range) : this.lineCoordinates.width / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range)) * I[this.intervalType + "Duration"] * this.interval, f = "undefined" === typeof this.options.labelMaxWidth ? 0.5 * this.chart.width >> 0 : this.options.labelMaxWidth, this.chart.panEnabled || (l = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize);
            else if ("left" === this._position || "right" === this._position) h =
                this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ? this.lineCoordinates.height * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position)) / Math.log(this.range) : this.lineCoordinates.height / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range)) * I[this.intervalType + "Duration"] * this.interval, this.chart.panEnabled || (f = "undefined" ===
                    typeof this.options.labelMaxWidth ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth), l = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize;
            ...
            if (this.labelAutoFit || this.options.labelAutoFit)
                if (r(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -=
                        180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position)
                    if (f = 0.9 * h >> 0, q = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
                        ...
                        for (c = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                if (r(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                    if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? l : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b),
                                        ...
                                        if (r(this.options.labelWrap))
                                            if (!r(this.options.labelMaxWidth)) this.options.labelMaxWidth < f ? (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = b) : (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = l);
                                            else if (!r(d))
                                            if (b = s.width + d.width >> 0, g = this.labelFontSize, q < f) b - 2 * f > p && (p = b - 2 * f, b >= 2 * f && b < 2.2 * f ? (this.sessionVariables.labelMaxWidth =
                                                ...
                                                r(this.options.labelFontSize) ? g : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = m) : b > 5 * f && (this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = f, this.sessionVariables.labelFontSize = g, this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelAngle = this.labelAngle));
                                            else if (v === c && (0 === v && q + this._labels[v + 1].textBlock.measureText().width - 2 * f > p || v === this._labels.length - 1 && q + this._labels[v -
                        ...
                        for (b = 0; b < this._labels.length; b++) a = this._labels[b].textBlock, a.maxWidth = this.labelMaxWidth = this.sessionVariables.labelMaxWidth, a.fontSize = this.sessionVariables.labelFontSize,
                            a.angle = this.labelAngle = this.sessionVariables.labelAngle, a.wrap = this.labelWrap = this.sessionVariables.labelWrap, a.maxHeight = this.sessionVariables.labelMaxHeight, a.measureText()
                    } else
                        for (c = 0; c < this._labels.length; c++) a = this._labels[c].textBlock, a.maxWidth = this.labelMaxWidth = r(this.options.labelMaxWidth) ? r(this.sessionVariables.labelMaxWidth) ? this.sessionVariables.labelMaxWidth = f : this.sessionVariables.labelMaxWidth : this.options.labelMaxWidth, a.fontSize = this.labelFontSize = r(this.options.labelFontSize) ?
                            ...
                            this.options.labelWrap, a.maxHeight = r(this.sessionVariables.labelMaxHeight) ? this.sessionVariables.labelMaxHeight = l : this.sessionVariables.labelMaxHeight, a.measureText();
                ...
                if (f = r(this.options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth, l = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize, !this.chart.panEnabled && 1 <= this._labels.length) {
                    ...
                    for (c = 0; c < this._labels.length; c++)
                        if (!this._labels[c].breaksLabelType) {
                            ...
                            Math.cos(Math.PI / 180 * Math.abs(this.labelAngle));
                            Math.sin(Math.PI / 180 * Math.abs(this.labelAngle));
                            r(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle ? r(this.options.labelWrap) ? r(this.options.labelWrap) && (r(this.options.labelMaxWidth) ? r(d) || (h = s.height + d.height >> 0, h - 2 * l > q && (q = h - 2 * l, h >= 2 * l &&
                                    h < 2.4 * l ? (r(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize), a.measureText()), this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize) : h >= 2.4 * l && h < 2.8 * l ? (this.sessionVariables.labelMaxHeight = b, this.sessionVariables.labelFontSize = this.labelFontSize, this.sessionVariables.labelWrap = !0) : h >= 2.8 * l && h < 3.2 * l ? (this.sessionVariables.labelMaxHeight = l, this.sessionVariables.labelWrap = !0, r(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize), a.measureText()), this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize, this.sessionVariables.labelAngle = r(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle) : h >= 3.2 * l && h < 3.6 * l ? (this.sessionVariables.labelMaxHeight = b, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelFontSize = this.labelFontSize) : h > 3.6 *
                    ...
                    for (c = 0; c < this._labels.length; c++) a = this._labels[c].textBlock, a.maxWidth = this.labelMaxWidth = r(this.options.labelMaxWidth) ? r(this.sessionVariables.labelMaxWidth) ? this.sessionVariables.labelMaxWidth =
                        ...
                        r(this.sessionVariables.labelWrap) ? this.sessionVariables.labelWrap = this.labelWrap : this.sessionVariables.labelWrap : this.options.labelWrap, a.maxHeight = r(this.sessionVariables.labelMaxHeight) ? this.sessionVariables.labelMaxHeight = l : this.sessionVariables.labelMaxHeight, a.measureText();
            for (c = 0; c < this.stripLines.length; c++) {
                ...
                if ("outside" === f.labelPlacement) {
                    ...
                    if ("bottom" === this._position || "top" === this._position) r(f.options.labelWrap) && !r(this.sessionVariables.stripLineLabelMaxHeight) ?
                        A = this.sessionVariables.stripLineLabelMaxHeight : this.sessionVariables.stripLineLabelMaxHeight = A = f.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize;
                ...
                a = new ka(this.ctx, {
                    ...
                    fontWeight: "outside" ===
                        f.labelPlacement ? f.options.labelFontWeight ? f.labelFontWeight : this.labelFontWeight : f.labelFontWeight,
        ...
        A.prototype.createLabelsAndCalculateWidth = function() {
            ...
            if ("left" === this._position || "right" === this._position) {
                ...
                for (d = 0; d < this._stripLineLabels.length; d++) "outside" ===
            ...
            return (this.title ? this._titleTextBlock.measureText().height +
                2 : 0) + a + ("inside" === this.tickPlacement ? 0 < this._index ? this.tickLength : 0 : this.tickLength) + c
        };
            ...
            if ("bottom" === this._position || "top" === this._position) {
                ...
                if ("inside" != this.labelPlacement || "inside" === this.labelPlacement && 0 < this._index)
                    for (c = 0; c < this._labels.length; c++) {
                        ...
                        var e = d.measureText(),
                            f = 0,
                            f = 0 === this.labelAngle ? e.height :
                            e.width * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) + (e.height - d.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle));
                        a < f && (a = f);
                ...
                for (c = 0; c < this._stripLineLabels.length; c++) "outside" === this._stripLineLabels[c].stripLine.labelPlacement && (this._stripLineLabels[c].stripLine.value >= this.viewportMinimum && this._stripLineLabels[c].stripLine.value <= this.viewportMaximum) && (d = this._stripLineLabels[c].textBlock, e = d.measureText(), f = 0 === this.labelAngle ? e.height : e.width *
                    Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) + (e.height - d.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)), a < f && (a = f), this._stripLineLabels[c].effectiveHeight = f)
            }
        ...
        A.setLayout = function(a, d, c, b, e, f) {
            ...
            for (g = 0; g < q.length; g++)
                if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length)
                    for (var s = q[g].scaleBreaks._appliedBreaks, w = 0; w < s.length && !(s[w].startValue > q[g].viewportMaximum); w++) s[w].endValue < q[g].viewportMinimum || (r(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex =
                        w), s[w].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = w));
            for (var v = w = 0, u = 0, y = 0, x = 0, z = 0, A = 0, C, B, E = h = 0, I, J, K, s = I = J = K = !1, g = 0; g < q.length; g++) q[g] && q[g].title && (q[g]._titleTextBlock = new ka(q[g].ctx, {
                text: q[g].title,
                horizontalAlign: "center",
            ...
            if ("normal" === e) {
                for (var y = [], x = [], z = [], A = [], N = [], P = [], O = [], R = []; 4 > w;) {
                    var F = 0,
                        ...
                        $ = 0;
                    if (c && 0 < c.length)
                        for (z = [], g = Q = 0; g < c.length; g++) z.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), Q += z[g], L += c[g] && !m.isNavigator ? c[g].margin : 0;
                    else z.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
                    O.push(z);
                    if (b && 0 <
                        b.length)
                        for (A = [], g = $ = 0; g < b.length; g++) A.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)), $ += A[g], Z += b[g] ? b[g].margin : 0;
                    else A.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0));
                    R.push(A);
                    l = Math.round(f.x1 + Q + L);
                    ...
                    if (d && 0 < d.length)
                        for (x = [], g = Y = 0; g < d.length; g++) d[g] && (d[g].lineCoordinates = {}), d[g].lineCoordinates.width = Math.abs(n - l), d[g].title && (d[g]._titleTextBlock.maxWidth = 0 < d[g].titleMaxWidth && d[g].titleMaxWidth < d[g].lineCoordinates.width ? d[g].titleMaxWidth : d[g].lineCoordinates.width),
                            x.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateHeight() : 0)), Y += x[g], X += d[g] && !m.isNavigator ? d[g].margin : 0;
                    else x.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateHeight() : 0));
                    P.push(x);
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++) a[g] && (a[g].lineCoordinates.x1 = l, n = Math.round(f.x2 - $ - Z > m.width - p ? m.width - p : f.x2 - $ - Z), a[g]._labels && 1 < a[g]._labels.length && (h = k = 0, k = a[g]._labels[1], h = "dateTime" === a[g].valueType ? a[g]._labels[a[g]._labels.length - 2] : a[g]._labels[a[g]._labels.length - 1], v = k.textBlock.width * Math.cos(Math.PI /
                                180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), u = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle))), !a[g] || (!a[g].labelAutoFit || r(C) || r(B) || m.isNavigator || m.stockChart) || (h = 0, 0 < a[g].labelAngle ? B + u > n && (h += 0 < a[g].labelAngle ? B + u - n - $ : 0) : 0 > a[g].labelAngle ? C - v < l && C - v < a[g].viewportMinimum && (E = l - (L + a[g].tickLength + z +
                                C - v + a[g].labelFontSize / 2)) : 0 === a[g].labelAngle && (B + u > n && (h = B + u / 2 - n - $), C - v < l && C - v < a[g].viewportMinimum && (E = l - L - a[g].tickLength - z - C + v / 2)), a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 < a[g].labelAngle && 0 < h ? n -= h : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 > a[g].labelAngle && 0 < E ? l += E : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 === a[g].labelAngle && (0 < E && (l += E), 0 < h && (n -= h))), m.panEnabled ? W = r(m.sessionVariables.axisX.height) ?
                            m.sessionVariables.axisX.height = W : m.sessionVariables.axisX.height : m.sessionVariables.axisX.height = W, h = Math.round(f.y2 - W - e + F), k = Math.round(f.y2), a[g].lineCoordinates.x2 = n, a[g].lineCoordinates.width = n - l, a[g].lineCoordinates.y1 = h, a[g].lineCoordinates.y2 = h + a[g].lineThickness / 2, "inside" === a[g].labelPlacement && 0 < g && (a[g].lineCoordinates.y1 = a[g].lineCoordinates.y1 + y[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height : 0) - a[g].tickLength - a[g].margin - 5, a[g].lineCoordinates.y2 = a[g].lineCoordinates.y1 + a[g].lineThickness /
                                2), "inside" === a[g].tickPlacement && 0 < g && (a[g].lineCoordinates.y1 += a[g].tickLength, a[g].lineCoordinates.y2 = a[g].lineCoordinates.y1 + a[g].lineThickness / 2), a[g].bounds = { x1: l, y1: h, x2: n, y2: k - (W + e - y[g] - F), width: n - l }, a[g].bounds.height = a[g].bounds.y2 - a[g].bounds.y1), F += y[g] + a[g].margin;
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++) d[g].lineCoordinates.x1 = Math.round(f.x1 + Q + L), d[g].lineCoordinates.x2 = Math.round(f.x2 - $ - Z > m.width - p ? m.width - p : f.x2 - $ - Z), d[g].lineCoordinates.width = Math.abs(n - l), d[g]._labels && 1 < d[g]._labels.length &&
                            ...
                            m.sessionVariables.axisX2.height = Y : m.sessionVariables.axisX2.height : m.sessionVariables.axisX2.height = Y, h = Math.round(f.y1), k = d[g].lineCoordinates.y1 = h + Y + X - U, d[g].lineCoordinates.y2 = h, "inside" === d[g].labelPlacement && 0 < g && (d[g].lineCoordinates.y1 -= x[g] - d[g].tickLength - (d[g]._titleTextBlock ? d[g]._titleTextBlock.height : 0)), "inside" === d[g].tickPlacement && 0 < g && (d[g].lineCoordinates.y1 -= d[g].tickLength), d[g].bounds = { x1: l, y1: h + (Y + X - x[g] - U), x2: n, y2: k, width: n - l }, d[g].bounds.height = d[g].bounds.y2 - d[g].bounds.y1,
                            U += x[g] + d[g].margin;
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++) L = m.isNavigator ? 0 : 10, c[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), L = c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[c[g]._labels.length - 1].textBlock.height / 2 : p, h = Math.round(f.y1 + Y + X < Math.max(L, p) ? Math.max(L, p) : f.y1 + Y + X), n = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), L = 0 < a.length ? 0 : c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[0].textBlock.height / 2 : p, k = Math.round(f.y2 - W - e - L), c[g].lineCoordinates = { x1: l - S, y1: h, x2: n - S, y2: k, height: Math.abs(k - h) }, "inside" === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.x1 = c[g].lineCoordinates.x1 - (z[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0)) + c[g].tickLength, c[g].lineCoordinates.x2 = c[g].lineCoordinates.x1 + c[g].lineThickness / 2), "inside" === c[g].tickPlacement && 0 < g && (c[g].lineCoordinates.x1 -= c[g].tickLength, c[g].lineCoordinates.x2 = c[g].lineCoordinates.x1 + c[g].lineThickness / 2), c[g].bounds = { x1: l - (z[g] + S), y1: h, x2: n - S, y2: k, height: k - h }, c[g].bounds.width =
                            c[g].bounds.x2 - c[g].bounds.x1, c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.height ? c[g].titleMaxWidth : c[g].lineCoordinates.height), S += z[g] + c[g].margin);
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++) b[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), n = Math.round(l), L = b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[b[g]._labels.length - 1].textBlock.height / 2 : 0, h = Math.round(f.y1 + Y + X < Math.max(L, p) ? Math.max(L, p) : f.y1 + Y + X), L = 0 < a.length ?
                            0 : b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[0].textBlock.height / 2 : 0, k = Math.round(f.y2 - (W + e + L)), b[g].lineCoordinates = { x1: l + V, y1: h, x2: l + V, y2: k, height: Math.abs(k - h) }, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.x1 = b[g].lineCoordinates.x1 + (A[g] - (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)) - b[g].tickLength - 2, b[g].lineCoordinates.x2 = b[g].lineCoordinates.x1 + b[g].lineThickness / 2), "inside" === b[g].tickPlacement && 0 < g && (b[g].lineCoordinates.x1 += b[g].tickLength, b[g].lineCoordinates.x2 =
                                b[g].lineCoordinates.x1 + b[g].lineThickness / 2), b[g].bounds = { x1: l + V, y1: h, x2: n + (A[g] + V), y2: k, height: k - h }, b[g].bounds.width = b[g].bounds.x2 - b[g].bounds.x1, b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.height ? b[g].titleMaxWidth : b[g].lineCoordinates.height), V += A[g] + b[g].margin);
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++) a[g] && (a[g].calculateValueToPixelConversionParameters(), a[g].calculateBreaksSizeInValues(), a[g]._labels && 1 < a[g]._labels.length && (C =
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++) d[g].calculateValueToPixelConversionParameters(), d[g].calculateBreaksSizeInValues(), d[g]._labels && 1 < d[g]._labels.length && (C = (d[g].logarithmic ? Math.log(d[g]._labels[1].position / d[g].viewportMinimum) / d[g].conversionParameters.lnLogarithmBase : d[g]._labels[1].position - d[g].viewportMinimum) * Math.abs(d[g].conversionParameters.pixelPerUnit) + d[g].lineCoordinates.x1, l = d[g]._labels[d[g]._labels.length -
                            ("dateTime" === d[g].valueType ? 2 : 1)].position, l = d[g].getApparentDifference(d[g].viewportMinimum, l), B = d[g].logarithmic ? (1 < l ? Math.log(l) / d[g].conversionParameters.lnLogarithmBase * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1 : (0 < l ? l * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1);
                    for (g = 0; g < q.length; g++) "axisY" === q[g].type && (q[g].calculateValueToPixelConversionParameters(), q[g].calculateBreaksSizeInValues());
                    if (0 < w) {
                        if (a && 0 < a.length)
                            for (g = 0; g < a.length; g++) s =
                                N[w - 1][g] === N[w][g] ? !0 : !1;
                        else s = !0;
                        if (d && 0 < d.length)
                            for (g = 0; g < d.length; g++) I = P[w - 1][g] === P[w][g] ? !0 : !1;
                        else I = !0;
                        if (c && 0 < c.length)
                            for (g = 0; g < c.length; g++) J = O[w - 1][g] === O[w][g] ? !0 : !1;
                        else J = !0;
                        if (b && 0 < b.length)
                            for (g = 0; g < b.length; g++) K = R[w - 1][g] === R[w][g] ? !0 : !1;
                        else K = !0
                    }
                    if (s && I && J && K) break;
                    w++
                ...
                N = [];
                for (P = []; 4 > w;) {
                    W = V = S = Z = L = X = e = R = O = F = Y = 0;
                    if (a && 0 < a.length)
                        for (E = [], g = V = 0; g < a.length; g++) E.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)), V += E[g], e += a[g] && !m.isNavigator ? a[g].margin : 0;
                    else E.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() :
                        0));
                    N.push(E);
                    if (d && 0 < d.length)
                        for (v = [], g = W = 0; g < d.length; g++) v.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateWidth() : 0)), W += v[g], X += d[g] ? d[g].margin : 0;
                    else v.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() : 0));
                    P.push(v);
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++) c[g].lineCoordinates = {}, l = Math.round(f.x1 + V + e), n = Math.round(f.x2 - W - X > m.width - 10 ? m.width - 10 : f.x2 - W - X), c[g].labelAutoFit && !r(y) && (0 < !a.length && (l = 0 > c[g].labelAngle ? Math.max(l, y) : 0 === c[g].labelAngle ? Math.max(l, y / 2) : l), 0 < !d.length && (n =
                            0 < c[g].labelAngle ? n - x / 2 : 0 === c[g].labelAngle ? n - x / 2 : n)), c[g].lineCoordinates.x1 = l, c[g].lineCoordinates.x2 = n, c[g].lineCoordinates.width = Math.abs(n - l), c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width);
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++) b[g].lineCoordinates = {}, l = Math.round(f.x1 + V + e), n = Math.round(f.x2 - W - X > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - W - X), b[g] && b[g].labelAutoFit && !r(z) && (0 < !a.length &&
                    ...
                    else p.push(Math.ceil(c[0] ?
                        c[0].createLabelsAndCalculateHeight() : 0));
                    B.push(p);
                    if (b && 0 < b.length)
                        for (C = [], g = 0; g < b.length; g++) C.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)), Z += b[g].margin;
                    else C.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() : 0));
                    u.push(C);
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++) 0 < c[g]._labels.length && (k = c[g]._labels[0], h = c[g]._labels[c[g]._labels.length - 1], y = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI /
                            180 * Math.abs(k.textBlock.angle)), x = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)));
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++) b[g] && 0 < b[g]._labels.length && (k = b[g]._labels[0], h = b[g]._labels[b[g]._labels.length - 1], z = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), A = h.textBlock.width *
                    ...
                    if (m.panEnabled)
                        for (g = 0; g < c.length; g++) p[g] = r(m.sessionVariables.axisY.height) ? m.sessionVariables.axisY.height = p[g] : m.sessionVariables.axisY.height;
                    else
                        for (g = 0; g < c.length; g++) m.sessionVariables.axisY.height = p[g];
                    if (c && 0 < c.length)
                        for (g = c.length - 1; 0 <= g; g--) h = Math.round(f.y2), k = Math.round(f.y2 > c[g].chart.height ? c[g].chart.height : f.y2), c[g].lineCoordinates.y1 =
                            h - (p[g] + c[g].margin + Y), c[g].lineCoordinates.y2 = h - (p[g] + c[g].margin + Y), "inside" === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.y1 = c[g].lineCoordinates.y1 + p[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0) - c[g].tickLength - 5, c[g].lineCoordinates.y2 = c[g].lineCoordinates.y1 + c[g].lineThickness / 2), "inside" === c[g].tickPlacement && 0 < g && (c[g].lineCoordinates.y1 += c[g].tickLength, c[g].lineCoordinates.y2 = c[g].lineCoordinates.y1 + c[g].lineThickness / 2), c[g].bounds = {
                                x1: l,
                    ...
                    if (b && 0 < b.length)
                        for (g = b.length - 1; 0 <= g; g--) b[g] && (h = Math.round(f.y1), k = Math.round(f.y1 + (C[g] + b[g].margin + F)), b[g].lineCoordinates.y1 = k, b[g].lineCoordinates.y2 = k, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = k - C[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0) + b[g].tickLength,
                    ...
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++) {
                            ...
                            k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - S > m.height - Math.max(L, 10) ? m.height - Math.max(L, 10) : f.y2 - S) : f.y2 > m.height - Math.max(L, 10) ? m.height - Math.max(L, 10) : f.y2;
                            if (c && 0 < c.length)
                                for (L = 0; L <
                                    c.length; L++) c[L] && c[L].labelAutoFit && (n = 0 > c[L].labelAngle ? Math.max(n, y) : 0 === c[L].labelAngle ? Math.max(n, y / 2) : n, l = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? n - V : l);
                            if (b && 0 < b.length)
                                for (L = 0; L < b.length; L++) b[L] && b[L].labelAutoFit && (n = b[L].lineCoordinates.x1, l = n - V);
                            a[g].lineCoordinates = { x1: n - O, y1: h, x2: n - O, y2: k, height: Math.abs(k - h) };
                            "inside" === a[g].labelPlacement && 0 < g && (a[g].lineCoordinates.x1 = a[g].lineCoordinates.x1 - (E[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height : 0)) + a[g].tickLength, a[g].lineCoordinates.x2 =
                            ...
                            a[g].bounds = { x1: n - (E[g] + O), y1: h, x2: n - O, y2: k, height: k - h };
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++) {
                            ...
                            l = Math.round(f.x1 - e);
                            h = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y2 : f.y1 < Math.max(L, 10) ? Math.max(L, 10) : f.y1) : f.y1 < Math.max(L, 10) ? Math.max(L, 10) : f.y1;
                            n = Math.round(f.x2 - W - X);
                            k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - S > m.height - Math.max(L, 10) ? m.height - Math.max(L, 10) : f.y2 - S) : f.y2 > m.height - Math.max(L, 10) ?
                                m.height - Math.max(L, 10) : f.y2;
                            if (c && 0 < c.length)
                                for (L = 0; L < c.length; L++) c[L] && c[L].labelAutoFit && (n = 0 > c[L].labelAngle ? Math.max(n, y) : 0 === c[L].labelAngle ? Math.max(n, y / 2) : n, l = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? n - W : l);
                            if (b && 0 < b.length)
                                for (L = 0; L < b.length; L++) b[L] && b[L].labelAutoFit && (n = b[L].lineCoordinates.x2, l = n - W);
                            d[g].lineCoordinates = { x1: n + R, y1: h, x2: n + R, y2: k, height: Math.abs(k - h) };
                            "inside" === d[g].labelPlacement && 0 < g && (d[g].lineCoordinates.x1 = d[g].lineCoordinates.x1 + (v[g] - (d[g]._titleTextBlock ? d[g]._titleTextBlock.height :
                                0) - 2) - d[g].tickLength, d[g].lineCoordinates.x2 = d[g].lineCoordinates.x1 + d[g].lineThickness / 2);
                            ...
                            d[g].title && (d[g]._titleTextBlock.maxWidth = 0 < d[g].titleMaxWidth && d[g].titleMaxWidth < d[g].lineCoordinates.height ? d[g].titleMaxWidth :
                    ...
                    if (0 < w) {
                        if (a && 0 < a.length)
                            for (g = 0; g < a.length; g++) s = N[w - 1][g] === N[w][g] ? !0 : !1;
                        else s = !0;
                        if (d && 0 < d.length)
                            for (g = 0; g < d.length; g++) I = P[w - 1][g] === P[w][g] ? !0 : !1;
                        else I = !0;
        ...
        A.prototype.calculateStripLinesThicknessInValues = function() {
            for (var a = 0; a < this.stripLines.length; a++)
                if (null !==
                    this.stripLines[a].startValue && null !== this.stripLines[a].endValue) {
                    ...
                    this.stripLines[a].value = this.logarithmic ? this.stripLines[a].value * Math.sqrt(Math.log(Math.max(this.stripLines[a].startValue, this.stripLines[a].endValue) / Math.min(this.stripLines[a].startValue, this.stripLines[a].endValue)) / Math.log(d)) : this.stripLines[a].value +
        ...
        A.prototype.calculateBreaksSizeInValues = function() {
            for (var a = "left" === this._position || "right" === this._position ? this.lineCoordinates.height || this.chart.height : this.lineCoordinates.width || this.chart.width, d = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [], c = this.conversionParameters.pixelPerUnit || a / (this.logarithmic ? this.conversionParameters.maximum /
        ...
        A.prototype.renderLabelsTicksAndTitle = function() {
            ...
            f =
                0;
            if ("inside" === this.labelPlacement) this.chart.addEventListener("dataAnimationIterationEnd", function() { for (k = 0; k < a._labels.length; k++) p = a._labels[k], p.position < a.viewportMinimum || (p.position > a.viewportMaximum || d && 0 !== f++ % 2 && a.labelAutoFit) || (a.ctx.save(), a.ctx.beginPath(), p.textBlock.render(!0), a.ctx.restore()) }, this);
            else
        ...
        A.prototype.renderCrosshair = function(a, d) { isFinite(this.minimum) && isFinite(this.maximum) && (this.crosshair.render(a, d), this.crosshair.dispatchEvent("updated", { chart: this.chart, crosshair: this.crosshair.options, axis: this, value: this.crosshair.value }, this)) };
        A.prototype.showCrosshair = function(a) {
            r(a) || (a < this.viewportMinimum || a > this.viewportMaximum) || ("top" === this._position ||
                "bottom" === this._position ? this.crosshair.render(this.convertValueToPixel(a), null, a) : this.crosshair.render(null, this.convertValueToPixel(a), a))
        };
        A.prototype.renderGrid = function() {
            if (this.gridThickness && 0 < this.gridThickness) {
                ...
                if ("bottom" === this._position || "top" === this._position)
                    for (b = 0; b < this._labels.length; b++) this._labels[b].position <
                        this.viewportMinimum || (this._labels[b].position > this.viewportMaximum || this._labels[b].breaksLabelType) || (a.beginPath(), d = this.getPixelCoordinatesOnAxis(this._labels[b].position), d = 1 === a.lineWidth % 2 ? (d.x << 0) + 0.5 : d.x << 0, a.moveTo(d, c.y1 << 0), a.lineTo(d, c.y2 << 0), a.stroke());
                else if ("left" === this._position || "right" === this._position)
                    for (var b = 0; b < this._labels.length; b++) this._labels[b].position < this.viewportMinimum || (this._labels[b].position > this.viewportMaximum || this._labels[b].breaksLabelType) || (a.beginPath(),
                        d = this.getPixelCoordinatesOnAxis(this._labels[b].position), d = 1 === a.lineWidth % 2 ? (d.y << 0) + 0.5 : d.y << 0, a.moveTo(c.x1 << 0, d), a.lineTo(c.x2 << 0, d), a.stroke());
                a.restore()
            }
        };
        A.prototype.renderAxisLine = function() {
            ...
            if ("bottom" === this._position || "top" === this._position) {
                if (this.lineThickness) {
                    this.reversed ? (e = this.lineCoordinates.x2, f = this.lineCoordinates.x1) :
                    ...
                    if (this.scaleBreaks && !r(this.scaleBreaks.firstBreakIndex))
                        if (r(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + b;
                            ...
                            for (var h =
                                    this.scaleBreaks.firstBreakIndex; h <= this.scaleBreaks.lastBreakIndex; h++) d.moveTo(e, l), d.lineTo(this.scaleBreaks._appliedBreaks[h].startPixel + c, l), e = this.scaleBreaks._appliedBreaks[h].endPixel + b;
                ...
                if (this.scaleBreaks && !r(this.scaleBreaks.firstBreakIndex))
                    if (r(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + c;
                        ...
                        for (h = this.scaleBreaks.firstBreakIndex; h <= this.scaleBreaks.lastBreakIndex; h++) d.moveTo(l, e), d.lineTo(l, this.scaleBreaks._appliedBreaks[h].startPixel + b),
                        ...
                        if (!(e[c].endValue < this.conversionParameters.minimum))
                            if (d)
                                if (e[c].startValue < this.conversionParameters.minimum) {
                                    if (1 < e[c].size && this.conversionParameters.minimum * Math.pow(e[c].endValue / e[c].startValue, Math.log(b) / Math.log(e[c].size)) < e[c].endValue) { a = Math.pow(e[c].endValue / e[c].startValue, Math.log(b) / Math.log(e[c].size)); break } else a *= e[c].endValue / this.conversionParameters.minimum /
                                        Math.pow(e[c].size, Math.log(e[c].endValue / this.conversionParameters.minimum) / Math.log(e[c].endValue / e[c].startValue)), b /= Math.pow(e[c].size, Math.log(e[c].endValue / this.conversionParameters.minimum) / Math.log(e[c].endValue / e[c].startValue));
                                    d = !1
                                } else if (b > e[c].startValue / this.conversionParameters.minimum) {
                            b /= e[c].startValue / this.conversionParameters.minimum;
                            if (b < e[c].size) { a *= Math.pow(e[c].endValue / e[c].startValue, 1 === e[c].size ? 1 : Math.log(b) / Math.log(e[c].size)) / b; break } else a *= e[c].endValue / e[c].startValue /
                                e[c].size;
                            b /= e[c].size;
                            d = !1
                        } else break;
                ...
                if (c <= this.conversionParameters.reference === ("left" === this._position || "right" === this._position) !== this.reversed)
                    for (c = 0; c < e.length; c++) {
                        if (!(e[c].endValue < this.conversionParameters.minimum))
                            if (d)
                                if (e[c].startValue < this.conversionParameters.minimum) {
                                    if (e[c].size && this.conversionParameters.minimum + b * (e[c].endValue - e[c].startValue) / e[c].size < e[c].endValue) {
                                        a = 0 >= e[c].size ? 0 : b * (e[c].endValue -
                                            e[c].startValue) / e[c].size;
                                        break
                            ...
                            b -= e[c].startValue - this.conversionParameters.minimum;
                            if (b < e[c].size) { a += (e[c].endValue - e[c].startValue) * (0 === e[c].size ? 1 : b / e[c].size) - b; break } else a += e[c].endValue -
                                e[c].startValue - e[c].size;
                            b -= e[c].size;
                            d = !1
                        } else break;
        ...
        A.prototype.getApparentDifference = function(a,
            d, c, b) {
            ...
            if (this.logarithmic) {
                ...
                for (var f = 0; f < e.length && !(d < e[f].startValue); f++) a > e[f].endValue || (a <= e[f].startValue && d >= e[f].endValue ? c = c / e[f].endValue * e[f].startValue * e[f].size : a >= e[f].startValue && d >= e[f].endValue ? c = c / e[f].endValue * a * Math.pow(e[f].size, Math.log(e[f].endValue / a) / Math.log(e[f].endValue / e[f].startValue)) : a <= e[f].startValue && d <= e[f].endValue ? c = c / d * e[f].startValue * Math.pow(e[f].size, Math.log(d / e[f].startValue) / Math.log(e[f].endValue /
                    e[f].startValue)) : !b && (a > e[f].startValue && d < e[f].endValue) && (c = a * Math.pow(e[f].size, Math.log(d / a) / Math.log(e[f].endValue / e[f].startValue))))
            } else
                for (c = r(c) ? Math.abs(d - a) : c, f = 0; f < e.length && !(d < e[f].startValue); f++) a > e[f].endValue || (a <= e[f].startValue && d >= e[f].endValue ? c = c - e[f].endValue + e[f].startValue + e[f].size : a > e[f].startValue && d >= e[f].endValue ? c = c - e[f].endValue + a + e[f].size * (e[f].endValue - a) / (e[f].endValue - e[f].startValue) : a <= e[f].startValue && d < e[f].endValue ? c = c - d + e[f].startValue + e[f].size * (d - e[f].startValue) /
                    (e[f].endValue - e[f].startValue) : !b && (a > e[f].startValue && d < e[f].endValue) && (c = a + e[f].size * (d - a) / (e[f].endValue - e[f].startValue)));
            return c
        };
        ...
        A.prototype.calculateValueToPixelConversionParameters = function(a) {
            ...
            if (this.logarithmic)
                ...
                for (e = 0; e < a.length && !(this.viewportMaximum < a[e].startValue); e++) this.viewportMinimum > a[e].endValue || (this.viewportMinimum >= a[e].startValue && this.viewportMaximum <= a[e].endValue ? c = 0 : this.viewportMinimum <= a[e].startValue && this.viewportMaximum >= a[e].endValue ? (b = b - a[e].endValue + a[e].startValue, c = 0 < a[e].spacing.toString().indexOf("%") ? c * (1 - parseFloat(a[e].spacing) / 100) : c - Math.min(a[e].spacing, 0.1 * c)) : this.viewportMinimum > a[e].startValue && this.viewportMaximum >= a[e].endValue ? (b = b - a[e].endValue + this.viewportMinimum,
            ...
            if ("left" ===
                this._position || "right" === this._position) this.logarithmic ? (d.lnLogarithmBase = Math.log(this.logarithmBase), d.pixelPerUnit = (this.reversed ? 1 : -1) * c * d.lnLogarithmBase / Math.log(Math.abs(b))) : d.pixelPerUnit = (this.reversed ? 1 : -1) * c / Math.abs(b), d.reference = this.reversed ? this.lineCoordinates.y1 : this.lineCoordinates.y2;
            ...
            if (this.logarithmic) this.calculateLogarithmicAxisParameters();
                ...
                if ("axisX" === this.type && c) {
                    ...
                    this.intervalType || (b / 1 <= a ? (this.interval = 1, this.intervalType = "millisecond") : b / 2 <= a ? (this.interval = 2, this.intervalType = "millisecond") : b / 5 <= a ? (this.interval = 5, this.intervalType = "millisecond") : b / 10 <= a ? (this.interval = 10, this.intervalType = "millisecond") : b / 20 <= a ? (this.interval = 20, this.intervalType = "millisecond") : b / 50 <= a ? (this.interval = 50, this.intervalType = "millisecond") : b / 100 <= a ? (this.interval = 100, this.intervalType = "millisecond") : b / 200 <= a ? (this.interval =
                            200, this.intervalType = "millisecond") : b / 250 <= a ? (this.interval = 250, this.intervalType = "millisecond") : b / 300 <= a ? (this.interval = 300, this.intervalType = "millisecond") : b / 400 <= a ? (this.interval = 400, this.intervalType = "millisecond") : b / 500 <= a ? (this.interval = 500, this.intervalType = "millisecond") : b / (1 * I.secondDuration) <= a ? (this.interval = 1, this.intervalType = "second") : b / (2 * I.secondDuration) <= a ? (this.interval = 2, this.intervalType = "second") : b / (5 * I.secondDuration) <= a ? (this.interval = 5, this.intervalType = "second") : b / (10 * I.secondDuration) <=
                        a ? (this.interval = 10, this.intervalType = "second") : b / (15 * I.secondDuration) <= a ? (this.interval = 15, this.intervalType = "second") : b / (20 * I.secondDuration) <= a ? (this.interval = 20, this.intervalType = "second") : b / (30 * I.secondDuration) <= a ? (this.interval = 30, this.intervalType = "second") : b / (1 * I.minuteDuration) <= a ? (this.interval = 1, this.intervalType = "minute") : b / (2 * I.minuteDuration) <= a ? (this.interval = 2, this.intervalType = "minute") : b / (5 * I.minuteDuration) <= a ? (this.interval = 5, this.intervalType = "minute") : b / (10 * I.minuteDuration) <=
                        a ? (this.interval = 10, this.intervalType = "minute") : b / (15 * I.minuteDuration) <= a ? (this.interval = 15, this.intervalType = "minute") : b / (20 * I.minuteDuration) <= a ? (this.interval = 20, this.intervalType = "minute") : b / (30 * I.minuteDuration) <= a ? (this.interval = 30, this.intervalType = "minute") : b / (1 * I.hourDuration) <= a ? (this.interval = 1, this.intervalType = "hour") : b / (2 * I.hourDuration) <= a ? (this.interval = 2, this.intervalType = "hour") : b / (3 * I.hourDuration) <= a ? (this.interval = 3, this.intervalType = "hour") : b / (6 * I.hourDuration) <= a ? (this.interval =
                            6, this.intervalType = "hour") : b / (1 * I.dayDuration) <= a ? (this.interval = 1, this.intervalType = "day") : b / (2 * I.dayDuration) <= a ? (this.interval = 2, this.intervalType = "day") : b / (4 * I.dayDuration) <= a ? (this.interval = 4, this.intervalType = "day") : b / (1 * I.weekDuration) <= a ? (this.interval = 1, this.intervalType = "week") : b / (2 * I.weekDuration) <= a ? (this.interval = 2, this.intervalType = "week") : b / (3 * I.weekDuration) <= a ? (this.interval = 3, this.intervalType = "week") : b / (1 * I.monthDuration) <= a ? (this.interval = 1, this.intervalType = "month") : b / (2 * I.monthDuration) <=
                        a ? (this.interval = 2, this.intervalType = "month") : b / (3 * I.monthDuration) <= a ? (this.interval = 3, this.intervalType = "month") : b / (6 * I.monthDuration) <= a ? (this.interval = 6, this.intervalType = "month") : (this.interval = b / (1 * I.yearDuration) <= a ? 1 : b / (2 * I.yearDuration) <= a ? 2 : b / (4 * I.yearDuration) <= a ? 4 : Math.floor(A.getNiceNumber(b / (a - 1), !0) / I.yearDuration), this.intervalType = "year"));
        ...
        A.prototype.calculateLogarithmicAxisParameters =
            function() {
                ...
                if (this.scaleBreaks)
                    for (h = 0; h < this.scaleBreaks._appliedBreaks.length; h++)
                        if ((!r(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[h].startValue || !r(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[h].startValue || !r(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[h].startValue) && (!r(this.sessionVariables.newViewportMaximum) &&
                                this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[h].endValue || !r(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[h].endValue || !r(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[h].endValue)) { this.scaleBreaks._appliedBreaks.splice(h, 1); break }
                ...
                var n = (isNaN(this.viewportMaximum) || null === this.viewportMaximum ? e : this.viewportMaximum) - (isNaN(this.viewportMinimum) ||
                    null === this.viewportMinimum ? b : this.viewportMinimum);
                this.intervalType = "number";
                h = Math.pow(this.logarithmBase, A.getNiceNumber(Math.abs(Math.log(h) / d), !1));
                this.options && 0 < this.options.interval ? this.interval = this.options.interval : (this.interval = A.getNiceExponent(Math.log(h) / d / (a - 1), !0), c = A.getNiceNumber(n / (a - 1), !0));
                ...
                1 === this.viewportMaximum && 1 === this.viewportMinimum && (1 === this.options.viewportMinimum ? this.viewportMaximum *= this.logarithmBase - 1 / this.logarithmBase : 1 === this.options.viewportMaximum && (this.viewportMinimum /= this.logarithmBase - 1 / this.logarithmBase), this.options && "undefined" === typeof this.options.interval &&
                    (this.interval = A.getNiceExponent(Math.ceil(Math.log(h) / d) / (a - 1)), c = A.getNiceNumber((this.viewportMaximum - this.viewportMinimum) / (a - 1), !0)));
        ...
        da.prototype.render = function(a) {
            if (0 !==
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    if (b = 1 === p % 2 ? (b.x << 0) + 0.5 : b.x << 0, h = 1 === p % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, n = this.chart.plotArea.y2 +
                            p / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, n = this.chart.plotArea.y1 - p / 2 + 0.5 << 0, a *= -1), this.bounds = { x1: b - p / 2, y1: e, x2: h + p / 2, y2: n }, this.ctx.moveTo(b, e), "straight" === this.type || "top" === this.scaleBreaks.parent._position && 0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(b, n), this.ctx.lineTo(h, n), this.ctx.lineTo(h, e);
                    else if ("wavy" === this.type) {
                    r = b;
                    k = e;
                    f = 0.5;
                    m = (n - k) / a / 3;
                    for (var q = 0; q < m; q++) this.ctx.bezierCurveTo(r + f * a, k + a, r + f * a, k + 2 * a, r, k + 3 * a), k += 3 * a, f *= -1;
                    this.ctx.bezierCurveTo(r + f * a,
                        k + a, r + f * a, k + 2 * a, r, k + 3 * a);
                    r = h;
                    f *= -1;
                    this.ctx.lineTo(r, k);
                    for (q = 0; q < m; q++) this.ctx.bezierCurveTo(r + f * a, k - a, r + f * a, k - 2 * a, r, k - 3 * a), k -= 3 * a, f *= -1
                } else {
                    if ("zigzag" === this.type) {
                        f = -1;
                        k = e + a;
                        r = b + a;
                        m = (n - k) / a / 2;
                        for (q = 0; q < m; q++) this.ctx.lineTo(r, k), r += 2 * f * a, k += 2 * a, f *= -1;
                        this.ctx.lineTo(r, k);
                        r += h - b;
                        for (q = 0; q < m + 1; q++) this.ctx.lineTo(r, k), r += 2 * f * a, k -= 2 * a, f *= -1;
                    ...
                    if (e = 1 === p % 2 ? (e.y << 0) + 0.5 : e.y <<
                        0, n = 1 === p % 2 ? (b.y << 0) + 0.5 : b.y << 0, "left" === this.scaleBreaks.parent._position ? (b = this.chart.plotArea.x1, h = this.chart.plotArea.x2 + p / 2 + 0.5 << 0) : (b = this.chart.plotArea.x2, h = this.chart.plotArea.x1 - p / 2 + 0.5 << 0, a *= -1), this.bounds = { x1: b, y1: e - p / 2, x2: h, y2: n + p / 2 }, this.ctx.moveTo(b, e), "straight" === this.type || "left" === this.scaleBreaks.parent._position && 0 >= a || "right" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(h, e), this.ctx.lineTo(h, n), this.ctx.lineTo(b, n);
                    else if ("wavy" === this.type) {
                    r = b;
                    k = e;
                    f = 0.5;
                    m =
                        (h - r) / a / 3;
                    for (q = 0; q < m; q++) this.ctx.bezierCurveTo(r + a, k + f * a, r + 2 * a, k + f * a, r + 3 * a, k), r += 3 * a, f *= -1;
                    ...
                    r = b + a;
                    m = (h - r) / a / 2;
                    for (q = 0; q < m; q++) this.ctx.lineTo(r, k), k += 2 * f * a, r += 2 * a, f *= -1;
                    this.ctx.lineTo(r, k);
                    k += n - e;
                    for (q = 0; q < m + 1; q++) this.ctx.lineTo(r, k), k += 2 * f * a, r -= 2 * a, f *= -1;
        ...
        P.prototype.render = function() {
            ...
            if (0 < d) {
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position) e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, h = this.chart.plotArea.y1, n = this.chart.plotArea.y2, this.bounds = { x1: e - d / 2, y1: h, x2: f + d / 2, y2: n };
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if ("rangeBar" === m[0].dataSeries.type || "error" === m[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[B].dataPoint.y[0])), u = 0, s = 0; s < m.length; s++)
                            if (m[s].dataPoint.y && m[s].dataPoint.y.length)
                                for (var y = 0; y < m[s].dataPoint.y.length; y++) u = Math.abs(a - this.parent.convertValueToPixel(m[s].dataPoint.y[y])), u < v && (v = u, B = s);
                            else u =
                                Math.abs(a - this.parent.convertValueToPixel(m[s].dataPoint.y)), u < v && (v = u, B = s);
                    else if ("stackedBar" === m[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), x = u = 0, s = B = 0; s < m.length; s++)
                            if (m[s].dataPoint.y && m[s].dataPoint.y.length)
                                for (y = 0; y < m[s].dataPoint.y.length; y++) u = Math.abs(a - this.parent.convertValueToPixel(m[s].dataPoint.y[y])), u < v && (v = u, B = s);
                            else x += m[s].dataPoint.y, u = Math.abs(a - this.parent.convertValueToPixel(x)), u < v && (v = u, B = s);
                    else if ("stackedBar100" === m[0].dataSeries.type)
                        for (var v =
                                Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), z = x = u = 0, s = 0; s < m.length; s++)
                            if (m[s].dataPoint.y && m[s].dataPoint.y.length)
                                for (y = 0; y < m[s].dataPoint.y.length; y++) u = Math.abs(a - this.parent.convertValueToPixel(m[s].dataPoint.y[y])), u < v && (v = u, B = s);
                            else x += m[s].dataPoint.y, z = m[s].dataPoint.x.getTime ? m[s].dataPoint.x.getTime() : m[s].dataPoint.x, z = 100 * (x / m[s].dataSeries.plotUnit.dataPointYSums[z]), u = Math.abs(a - this.parent.convertValueToPixel(z)), u < v && (v = u, B = s);
                    else
                        for (v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)),
                            s = B = u = 0; s < m.length; s++)
                            if (m[s].dataPoint.y && m[s].dataPoint.y.length)
                                for (y = 0; y < m[s].dataPoint.y.length; y++) u = Math.abs(a - this.parent.convertValueToPixel(m[s].dataPoint.y[y])), u < v && (v = u, B = s);
                            else u = Math.abs(a - this.parent.convertValueToPixel(m[s].dataPoint.y)), u < v && (v = u, B = s);
                    y = m[B];
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[B].type || "error" === this.parent.dataSeries[B].type) {
                            ...
                            k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.y[b] }) : r(this.options.label) ? fa(r(c) ? y.dataPoint.y[b] : c, this.valueFormatString, this.chart._cultureInfo) :
                                this.label
                        } else if ("stackedBar" === this.parent.dataSeries[B].type) {
                            v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y));
                            x = u = 0;
                            for (s = B; 0 <= s; s--) x += m[s].dataPoint.y, u = Math.abs(a - this.parent.convertValueToPixel(x)), u < v && (v = u, b = s);
                            ...
                            k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.y }) : r(this.options.label) ?
                                fa(r(c) ? y.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo) : this.label
                        } else if ("stackedBar100" === this.parent.dataSeries[B].type) {
                            v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y));
                            z = x = u = 0;
                            for (s = B; 0 <= s; s--) x += m[s].dataPoint.y, z = m[s].dataPoint.x.getTime ? m[s].dataPoint.x.getTime() : m[s].dataPoint.x, z = 100 * (x / m[s].dataSeries.plotUnit.dataPointYSums[z]), u = Math.abs(a - this.parent.convertValueToPixel(z)), u < v && (v = u, b = s);
                            n = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(z) << 0) + 0.5 :
                                this.parent.convertValueToPixel(z) << 0;
                            this.value = z;
                            k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: z }) : r(this.options.label) ? fa(r(c) ? z : c, this.valueFormatString, this.chart._cultureInfo) : this.label
                            ...
                            value: y.dataPoint.y
                        }) : r(this.options.label) ? fa(r(c) ? y.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo) : this.label;
                        b = e = n;
                        ...
                        if (this.parent.labels)
                            for (m = Math.ceil(this.parent.interval), s = 0; s < this.parent.viewportMaximum; s +=
                                m)
                    ...
                    for (B = 0; B < this.parent.dataSeries.length; B++)(v =
                        this.parent.dataSeries[B].getDataPointAtX(s, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[B], null !== v.dataPoint.y && v.dataSeries.visible && m.push(v));
                    if (0 === m.length) return;
                    m.sort(function(a, b) { return a.distance - b.distance });
                    y = m[0];
                    ...
                    if (this.parent.labels)
                        for (m = Math.ceil(this.parent.interval),
                            s = 0; s < this.parent.viewportMaximum; s += m)
                            if (this.parent.labels[s]) z = !0;
                            else { z = !1; break }
                    if (z) {
                        if ("axisX" === this.parent.type)
                        ...
                        this.parent.logarithmic ? this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.x }) : r(this.options.label) ? fa(y.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.x }) : r(this.options.label) ? Aa(y.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label;
                    this.value = y.dataPoint.x;
                    k.x = b - k.measureText().width / 2;
                    ...
                    for (B = 0; B < this.parent.dataSeries.length; B++)(v = this.parent.dataSeries[B].getDataPointAtX(s, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[B], null !== v.dataPoint.y && v.dataSeries.visible && m.push(v));
                    if (0 === m.length) return;
                    m.sort(function(a, b) { return a.distance - b.distance });
                    B = 0;
                    if ("rangeColumn" === m[0].dataSeries.type || "rangeArea" === m[0].dataSeries.type || "error" === m[0].dataSeries.type || "rangeSplineArea" === m[0].dataSeries.type || "candlestick" === m[0].dataSeries.type || "ohlc" === m[0].dataSeries.type ||
                        ...
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y[0])), s = u = 0; s < m.length; s++)
                            if (m[s].dataPoint.y && m[s].dataPoint.y.length)
                                for (y = 0; y < m[s].dataPoint.y.length; y++) u = Math.abs(d - this.parent.convertValueToPixel(m[s].dataPoint.y[y])), u < v && (v = u, B = s);
                            else u = Math.abs(d - this.parent.convertValueToPixel(m[s].dataPoint.y)), u < v && (v = u, B = s);
                        ...
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)),
                            s = x = u = 0; s < m.length; s++)
                            if (m[s].dataPoint.y && m[s].dataPoint.y.length)
                                for (y = 0; y < m[s].dataPoint.y.length; y++) u = Math.abs(d - this.parent.convertValueToPixel(m[s].dataPoint.y[y])), u < v && (v = u, B = s);
                            else x += m[s].dataPoint.y, u = Math.abs(d - this.parent.convertValueToPixel(x)), u < v && (v = u, B = s);
                    else if ("stackedColumn100" === m[0].dataSeries.type || "stackedArea100" === m[0].dataSeries.type)
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), s = z = x = u = 0; s < m.length; s++)
                            if (m[s].dataPoint.y && m[s].dataPoint.y.length)
                                for (y =
                                    0; y < m[s].dataPoint.y.length; y++) u = Math.abs(d - this.parent.convertValueToPixel(m[s].dataPoint.y[y])), u < v && (v = u, B = s);
                            else x += m[s].dataPoint.y, z = m[s].dataPoint.x.getTime ? m[s].dataPoint.x.getTime() : m[s].dataPoint.x, z = 100 * (x / m[s].dataSeries.plotUnit.dataPointYSums[z]), u = Math.abs(d - this.parent.convertValueToPixel(z)), u < v && (v = u, B = s);
                    else
                        for (v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), s = u = 0; s < m.length; s++)
                            if (m[s].dataPoint.y && m[s].dataPoint.y.length)
                                for (y = 0; y < m[s].dataPoint.y.length; y++) u =
                                    Math.abs(d - this.parent.convertValueToPixel(m[s].dataPoint.y[y])), u < v && (v = u, B = s);
                            else u = Math.abs(d - this.parent.convertValueToPixel(m[s].dataPoint.y)), u < v && (v = u, B = s);
                    y = m[B];
                    b = 0;
                    if ("rangeColumn" === this.parent.dataSeries[B].type || "rangeArea" === this.parent.dataSeries[B].type || "error" === this.parent.dataSeries[B].type || "rangeSplineArea" === this.parent.dataSeries[B].type || "candlestick" === this.parent.dataSeries[B].type || "ohlc" === this.parent.dataSeries[B].type || "boxAndWhisker" === this.parent.dataSeries[B].type) {
                        ...
                        k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.y[b] }) : r(this.options.label) ? fa(r(c) ? y.dataPoint.y[b] : c, this.valueFormatString,
                        ...
                        x = u = 0;
                        for (s = B; 0 <= s; s--) x += m[s].dataPoint.y, u = Math.abs(d - this.parent.convertValueToPixel(x)), u < v && (v = u, b = s);
                        ...
                        v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y));
                        x = u = 0;
                        for (s = B; 0 <= s; s--) x += m[s].dataPoint.y, z = m[s].dataPoint.x.getTime ? m[s].dataPoint.x.getTime() : m[s].dataPoint.x, z = 100 * (x / m[s].dataSeries.plotUnit.dataPointYSums[z]),
                        ...
                        0) + 0.5 : this.parent.convertValueToPixel(y.dataSeries.dataPointEOs[y.index].cumulativeSum) << 0, k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataSeries.dataPointEOs[y.index].cumulativeSum }) : r(this.options.label) ? fa(r(c) ? y.dataSeries.dataPointEOs[y.index].cumulativeSum : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = y.dataSeries.dataPointEOs[y.index].cumulativeSum) : (w = 1 === q.lineWidth % 2 ? (r(a) ? d : this.parent.convertValueToPixel(y.dataPoint.y) <<
                        0) + 0.5 : r(a) ? d : this.parent.convertValueToPixel(y.dataPoint.y) << 0, k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: r(c) ? y.dataPoint.y : c }) : r(this.options.label) ? fa(r(c) ? y.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = y.dataPoint.y);
                    f = h = w;
                    b = this.chart.plotArea.x1;
                    e = this.chart.plotArea.x2;
                    this.bounds = { x1: b, y1: f - p / 2, x2: e, y2: h + p / 2 };
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position) b = e = n = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0, f = this.chart.plotArea.y1, h = this.chart.plotArea.y2, this.bounds = { x1: b - p / 2, y1: f, x2: e + p / 2, y2: h };
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    if ("left" ===
                        ...
                        } else k.text = "dateTime" !== this.parent.valueType || this.parent.logarithmic ? this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: r(c) ? this.parent.convertPixelToValue(d) : c }) : r(this.options.label) ? fa(r(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo) : this.label : this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: r(c) ? this.parent.convertPixelToValue(d) : c
                        }) : r(this.options.label) ? Aa(r(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo) : this.label;
                        ...
                        if ("bottom" === this.parent._position || "top" === this.parent._position) k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: r(c) ? this.parent.convertPixelToValue(a) : c }) : r(this.options.label) ? fa(r(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label, k.x = b - k.measureText().width /
                    ...
                    if (z) {
                        ...
                        this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: r(c) ? 0 < this.parent.dataSeries.length ? this.parent.convertPixelToValue(a) : "" : c }) : r(this.options.label) ? fa(r(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label : this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: r(c) ? this.parent.convertPixelToValue(a) : c }) : r(this.options.label) ? Aa(r(c) ?
                    ...
                    this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: r(c) ? this.parent.convertPixelToValue(d) : c }) : r(this.options.label) ? fa(r(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo) : this.label, k.y = d + k.fontSize / 2 - k.measureText().height / 2 + 2, k.y - k.fontSize / 2 < this.chart.bounds.y1 ? k.y = this.chart.bounds.y1 + k.fontSize / 2 + 2 : k.y + k.measureText().height - k.fontSize / 2 > this.chart.bounds.y2 && (k.y = this.chart.bounds.y2 - k.measureText().height +
        ...
        Y.prototype.renderLabel = function() { r(this._textBlock) || (r(this._textBlock.text) || !("number" === typeof this._textBlock.text.valueOf() || 0 < this._textBlock.text.length) || this._hidden) || this._textBlock.render(!0) };
        na(Z, X);
                ...
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    ...
                    if (this.chart.axisX)
                        for (var v = 0; v < this.chart.axisX.length; v++) {
                            for (var h = "xySwapped" === this.chart.plotInfo.axisPlacement ? this.chart.axisX[v].convertPixelToValue({ y: d }) : this.chart.axisX[v].convertPixelToValue({ x: a }), k = null, b = 0; b < this.chart.axisX[v].dataSeries.length; b++)(k = this.chart.axisX[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[v].dataSeries[b], null !== k.dataPoint.y && k.dataSeries.visible && n.push(k));
                            k = null
                        }
                    if (this.chart.axisX2)
                        for (v = 0; v < this.chart.axisX2.length; v++) {
                            ...
                            k = null;
                            for (b = 0; b < this.chart.axisX2[v].dataSeries.length; b++)(k = this.chart.axisX2[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[v].dataSeries[b], null !== k.dataPoint.y && k.dataSeries.visible && n.push(k));
                            k = null
                        }
                    if (0 === n.length) return;
                    n.sort(function(a, b) { return a.distance - b.distance });
                    c = n[0];
                    for (b = 0; b < n.length; b++) n[b].dataPoint.x.valueOf() ===
                        c.dataPoint.x.valueOf() && f.push(n[b]);
                    n = null
                } else {
            ...
            for (c = 0; c < a.length; c++) {
                ...
                if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                    ...
                    !1 === f.highlightEnabled || !0 !== b.highlightEnabled && !0 !== f.highlightEnabled || ("line" === b.type || "stepLine" === b.type ||
                        ...
                        "rangeColumn" === b.type || "waterfall" === b.type ? ba(d, e.x1, e.y1, e.x2, e.y2, "white", 0, null, !1, !1, !1, !1, 0.3) : "pie" === b.type || "doughnut" === b.type ? W(d, e.center, e.radius, "white", b.type, e.startAngle, e.endAngle, 0.3, e.percentInnerRadius) : "funnel" === b.type || "pyramid" === b.type ? oa(d, e.funnelSection, 0.3, "white") : "candlestick" === b.type ? (d.globalAlpha = 1, d.strokeStyle = e.color, d.lineWidth = 2 * e.borderThickness, b = 0 === d.lineWidth % 2 ? 0 : 0.5, d.beginPath(), d.moveTo(e.x3 - b, Math.min(e.y2, e.y3)), d.lineTo(e.x3 - b, Math.min(e.y1, e.y4)),
                            d.stroke(), d.beginPath(), d.moveTo(e.x3 - b, Math.max(e.y1, e.y4)), d.lineTo(e.x3 - b, Math.max(e.y2, e.y3)), d.stroke(), ba(d, e.x1, Math.min(e.y1, e.y4), e.x2, Math.max(e.y1, e.y4), "transparent", 2 * e.borderThickness, e.color, !1, !1, !1, !1), d.globalAlpha = 1) : "ohlc" === b.type ? (d.globalAlpha = 1, d.strokeStyle = e.color, d.lineWidth = 2 * e.borderThickness, b = 0 === d.lineWidth % 2 ? 0 : 0.5, d.beginPath(), d.moveTo(e.x3 - b, e.y2), d.lineTo(e.x3 - b, e.y3), d.stroke(), d.beginPath(), d.moveTo(e.x3, e.y1), d.lineTo(e.x1, e.y1), d.stroke(), d.beginPath(), d.moveTo(e.x3,
                            e.y4), d.lineTo(e.x2, e.y4), d.stroke(), d.globalAlpha = 1) : "boxAndWhisker" === b.type ? (d.save(), d.globalAlpha = 1, d.strokeStyle = e.stemColor, d.lineWidth = 2 * e.stemThickness, 0 < e.stemThickness && (d.beginPath(), d.moveTo(e.x3, e.y2 + e.borderThickness / 2), d.lineTo(e.x3, e.y1 + e.whiskerThickness / 2), d.stroke(), d.beginPath(), d.moveTo(e.x3, e.y4 - e.whiskerThickness / 2), d.lineTo(e.x3, e.y3 - e.borderThickness / 2), d.stroke()), d.beginPath(), ba(d, e.x1 - e.borderThickness / 2, Math.max(e.y2 + e.borderThickness / 2, e.y3 + e.borderThickness / 2), e.x2 +
        ...
        Z.prototype.show = function(a, d, c) { this._updateToolTip(a, d, "undefined" === typeof c ? !1 : c) };
            ...
            if (0 < f.length) {
                for (h = 0; h < f.length; h++)
                    if (b = f[h], (this.shared || 0 <= b.dataSeries.type.indexOf("100")) && b.dataPoint.x >= b.dataSeries.axisX.viewportMinimum &&
                        b.dataPoint.x <= b.dataSeries.axisX.viewportMaximum) { e = !1; break } else if (b.dataPoint.x < b.dataSeries.axisX.viewportMinimum || b.dataPoint.x > b.dataSeries.axisX.viewportMaximum || b.dataPoint.y < b.dataSeries.axisY.viewportMinimum || b.dataPoint.y > b.dataSeries.axisY.viewportMaximum) e = !0;
                else { e = !1; break }
        ...
        ja.prototype.animate = function(a,
            d, c, b, e) {
            var f = this;
        ...
        var N = {
                yScaleAnimation: function(a, d) {
                    if (0 !== a) {
                        var c = d.dest,
                            b = d.source.canvas,
                            e = d.animationBase;
                        c.drawImage(b, 0, 0, b.width, b.height, 0, e - e * a, c.canvas.width / ia, a * c.canvas.height /
                            ia)
                    }
                },
                ...
                fadeInAnimation: function(a, d) {
                    if (0 !== a) {
                        ...
                        c.save();
                        c.globalAlpha = a;
                        c.drawImage(b, 0, 0, b.width, b.height, 0, 0, c.canvas.width / ia, c.canvas.height /
                            ia);
                        c.restore()
                    }
                },
